...
| Updated | 2026-08-23 (W-GT10 backfill: Acuerdo 1520 reform of 1421 arts. 4/5 + Acuerdo 1556 exoneración, LB-028/029; W-GT9 backfill: IGSS Acuerdo 1124 IVS rates, LB-027; W-GT8: program-reglamento set 104_-108_, LB-026) |
...
and the IVS Acuerdo 1124 acquired the same day (LB-027): its art.-40 pair
(3.67% patronal / 1.83% laboral / 5.50% payroll total) is now
statute-anchored as row defaults, while the SEM/accidentes operative rates
remain configurable-external on the 410 art.-85 chain — LB-026), the
employer-share
...
by AG 180-2018 — LB-025) at the collection-reglamento layer — but **rate,
base and tope values live in the JD PROGRAM reglamentos** (Acuerdo 1421
...
by the unprinted extension chain Acuerdos 475→1243 — **the IVS rates are
now STATUTE-ANCHORED in corpus** (Acuerdo 1124 art. 40 = `109_` Rev-2021 +
`115_` intermediate print, byte-consistent: patronal 3.67% / laboral 1.83%
on salaries; Estado-como-tal 25% of BENEFITS, never a payroll line —
LB-027; the FR-155 configurable-row architecture STAYS, seeded with these
anchored defaults) — and the remaining operative-rate targets are the
SEM/accidentes rates: that 475→1243 chain + a successor instrument (1002
art. 46 prints the 1994 accidentes originals 4%/2%/1½% untagged — LB-027).
**W-GT10 supersession scoping (2026-08-23): the 1421 anchor is now
layer-dated** — JD Acuerdo 1520 (4-ago-2022, approved by AG 239-2022; `116_`)
REFORMED 1421 arts. 4/5 and ADDED art. 9 ¶3 (LB-028; EVID-1306..1317): the
2018 art. 5 one-sentence floor ("no podrán calcular… sobre salarios
inferiores al mínimo establecidos por Acuerdo Gubernativo", EVID-868 vintage)
was REPLACED by the monto-base architecture (SMM jornada-diurna × factors
243.3333/30.4167/1.00; the contribución-mínima PERCENTAGES still delegated to
"la normativa institucional vigente" — GOQ-04 residue untouched), effective
29-sep-2022; and the CURRENT standing recargo-exoneración window = JD
Acuerdo 1556 (28-ene-2025, approved by AG 17-2026; `117_`) — six months
≈25-mar-2026 → ≈25-sep-2026 computed, post-window state open (LB-029;
EVID-1318..1328).
The 12.67% patronal / 4.83%
...
| LB-027 | IGSS Acuerdo 1124 = `109_` (Rev-2021 consolidation) + `115_` (intermediate print), the IVS program reglamento — art. 40 VERBATIM, the cuota-rate article (GOQ-04 IVS half closer): "Acuerdo Número 1124" / "Dictar el siguiente: REGLAMENTO SOBRE PROTECCION RELATIVA A INVALIDEZ, VEJEZ Y SOBREVIVENCIA" / "ARTICULO 40. Las contribuciones de los patronos y de los trabajadores se computan sobre los salarios que perciban o deban percibir los afiliados en las proporciones siguientes:" / "a) Los patronos particulares y el Estado como patrono, el 3.67% del total de salarios de sus trabajadores afiliados." / "b) Los trabajadores afiliados, el 1.83% de sus salarios." / "c) La s [sic] contribuciones del Estado como tal, serán igual al 25% del total de los pagos efectivos por concepto de prestaciones otorgadas según este Reglamento." / "Se suprime la literal d). 23" / fn23: "23 * Se declaró inconstitucional la literal d), según resolución dentro del expediente número 732-2003 de la Corte de Constitucionalidad, publicada en el Diario Oficial el 9-1-2004, POR TANTO, resuelve: I) Con lugar la acción de inconstitucionalidad de la literal d) del artículo 40 del Reglamento sobre Protección Relativa a Invalidez, Vejez y Sobrevivencia, contenido en el Acuerdo 1124 de la Junta Directiva del Instituto Guatemalteco de Seguridad Social, aprobado en Acuerdo Gubernativo 93-2003; el cual deja de surtir efectos desde el día siguiente al de la publicación del presente fallo en el Diario Oficial." / dating: "Dado en el Salón de Sesiones de la Junta Directiva del Instituto Guatemalteco de Seguridad Social, a los trece días del mes de marzo del año dos mil tres." / "Publicado en el Diario Oficial el 19 de marzo del 2003, vigente el mismo día de su publicación, aprobado por Acuerdo Gubernativo 93-2003." / `115_` art. 40 c) (intermediate vintage, no OCR split): "c) Las contribuciones del Estado como tal, serán igual al 25% del total de los pagos efectivos por concepto de prestaciones otorgadas según este Reglamento.20" — literales a)-c) byte-consistent (modulo whitespace) across both vintages | GOQ-04's IVS-rate half RESOLVED: the payroll pair = patronal 3.67% + laboral 1.83% = 5.50% on salaries (both shares delivered wholesale by the patrono per the two-share FRs — FR-164); Estado-como-tal 25% = of BENEFITS paid, never a payroll line; rates print UNTAGGED in BOTH consolidation vintages (`109_` Rev-2021 + `115_` intermediate 2004-2021, byte-consistent art. 40), original dating 13-3-2003 / DO 19-3-2003 / AG 93-2003 presumptive only (evidence OQ — dated-row discipline: valid_from 2003-03-13 flagged-presumptive, never frozen harder); art. 40 stem fixes the base "sobre los salarios que perciban o deban percibir" — NO tope and NO floor in the article (the FR-166 negative stands; the art.-29 Q9,000 cap is the pension-CALCULATION Remuneración Base, never the contribution base); the d)-literal strike (CC expediente 732-2003, DO 9-1-2004) recorded as supersession note only. Program-family mapping (sibling acuerdos): 1118 (`110_`) = recaudación family head, NO rates (art. 1 delegates the monto to the program reglamentos — R34 confirmed; its only percentages are the recargos layer: 5% art. 12 + the 50%-rebaja art. 32); 1002 (`111_`) = the ACCIDENTES program reglamento, art. 46 = 4%/2%/1½% UNTAGGED 1994 originals under the 475→1243 extension chain — SEM/accidentes OPERATIVE rates still open (GOQ-04 residue); 468 (`112_`) = prestaciones en dinero (the salario-diario-base instrument 410's arts. 11/25 delegate to); 466 (`113_`) = asistencia médica; 1135 (`114_`) = IGSS-STAFF plan (art. 24: 9.0%/4.5% — staff-only, never general-regime). Family-identity row: `10_sso-provenance.md` LB-011 | `gt/sources/109_IGSS_Acuerdo1124_IVS_Rev2021.pdf` + `gt/sources/115_IGSS_Acuerdo1124_IVS_original2003.pdf` (family cites: `gt/sources/110_IGSS_Acuerdo1118_Recaudacion.pdf` · `gt/sources/111_IGSS_Acuerdo1002_Rev2018.pdf` · `gt/sources/112_IGSS_Acuerdo468_Rev2018.pdf` · `gt/sources/113_IGSS_Acuerdo466.pdf` · `gt/sources/114_IGSS_Acuerdo1135_Rev2017.pdf`) | `109_` p.16 art. 40 + fn23; pp.1 + 22-23 identity/dating (EVID-1215, EVID-1216, EVID-1186, EVID-1187); `115_` art. 40 (EVID-1302; identity/vintage EVID-1301, fiscal context EVID-1303); family: 1118 art. 1 (EVID-1228, EVID-1241), 1002 art. 46 (EVID-1252), 468 (EVID-1266, EVID-1274), 466 (EVID-1279, EVID-1280), 1135 arts. 1/24 (EVID-1290, EVID-1297) |
| LB-028 | IGSS JD Acuerdo 1520 (4-ago-2022) + its approval AG 239-2022 (16-sep-2022; DCA Nº 72 pp.7-9, 28-sep-2022) = `116_` (W-GT10), the REFORM OF ACUERDO 1421 — reformed art. 4: "Las cuotas se calcularán con base en el salario total del trabajador, que comprende el devengado durante las jornadas ordinarias, extraordinarias y bonificaciones, excepto aquellas cuyas leyes de creación las excluyan, siempre que el salario total no sea menor al monto base para el cálculo de la contribución mensual mínima a la Seguridad Social; caso contrario se deberá utilizar este último" / art. 4 ¶4-5 exclusions: "Se exceptúan los pagos que se hagan a la terminación del contrato o relación de trabajo en concepto de indemnización y compensación de vacaciones en dinero, así como el aguinaldo y aquellas bonificaciones cuya ley de creación así lo regulen." / "No está afecto a las contribuciones del Régimen de Seguridad Social, el salario que el patrono pague a sus trabajadores en concepto de complemento al subsidio por incapacidad temporal reconocido por el Instituto, por accidente o por enfermedad" / reformed art. 5: "el término “salario mínimo”, deberá entenderse como el monto base para el cálculo de la contribución mensual mínima a la Seguridad Social" / "el monto resultante de multiplicar el salario mínimo fijado por el Organismo Ejecutivo, en jornada diurna de trabajo según la actividad económica que corresponda calculado sobre un mínimo de ocho horas diarias, por el factor de expansión dado" / factors: "Hora 243.3333 Salario fijado por hora * 243.3333 / Día 30.4167 Salario fijado por día * 30.4167 / Mes 100 [table-collapse of 1.00; formula column prints "* 1" — sic] Salario fijado por mes * 1" / "Entiéndase como contribución mensual mínima el resultado de aplicar los porcentajes fijados por la normativa institucional vigente al monto base" / "El monto base… será aplicable única y exclusivamente en los casos en que el trabajador devengue un salario menor a dicha base. Quedando a cargo del patrono el pago del monto equivalente a la diferencia entre la contribución minima [sic] y la suma de las contribuciones laboral y patronal calculadas con base al salario devengado efectivamente por el trabajador." / distribution: "la distribución de los ingresos provenientes de los casos descritos en el párrafo anterior, a las cuentas de los programas Enfermedad Maternidad y Accidentes -EMA- e Invalidez. Vejez [sic] y Sobrevivencia -IVS-": "Enfermedad y Maternidad —[table artifact]0.258065 0.129032 / Accidentes 0.193548 0.064516 / Invalidez, Vejez y Sobrevivencia 0.236774 0.118065"; non-IVS variant "Enfermedad y Maternidad 0.40 0.20 / Accidentes 0.30 0.10" / art. 3 adds 1421 art. 9 ¶3 (Recaudación-data confidentiality) / vigencia: "entrará en vigencia el día siguiente de su publicación en el Diario Oficial" (AG 239-2022: "empezará a regir a partir del día de su publicación") | The 1421 collection reglamento LAYER-DATED: arts. 4/5 as they STAND = the 1520 reformed text (87_ prints the 2018 originals — art. 5 then ONE sentence: the raw-SMM floor; EVID-868 vintage). Art. 4: the cotizable itemization + exclusions carry over unchanged in substance, PLUS the inline floor clause. Art. 5: floor redefined as monto base = OE SMM (jornada diurna, ≥8h/día, by activity) × factor 243.3333/30.4167/1.00 — the base AMOUNT becomes formula-derivable from the GT-PAY-FR-073 SMM feed (never a printed constant), universal (contract/jornada/days/geography-independent), below-base-only, PATRONO-borne top-up; the contribución-mínima PERCENTAGES remain DELEGATED to "normativa institucional vigente" (GOQ-04 residue OPEN). The distribution table = the FIRST printed program-split in corpus — CORROBORATION-ONLY for GOQ-04 (arithmetic: IVS cell 0.354839 × 15.50% total = 3.67/1.83 exactly; implied EMA 4%/2% + Acc 3%/1% — an INFERENCE, never a rate source; also mechanically explains the folk 12.67 = 10.67 IGSS-patronal + IRTRA 1 + INTECAP 1; the rejected-prior verdicts STAND). Dating: 1520 emitted 4-ago-2022, Gerencia order 26-sep-2022, DCA 28-sep-2022 → 1520 vigente 29-sep-2022 (AG rige 28-sep-2022 — the printed one-day stagger); LB-022's Sep-2022 boundary now PRIMARY and precise | `gt/sources/116_IGSS_Acuerdo1520_AG239-2022_Reforma1421.pdf` | p.2 (DCA p.8) arts. 1-4 of the reform + tables; pp.1-2 AG 239-2022; p.3 Gerencia order (EVID-1306..1317; range EVID-1306..1317) |
| LB-029 | IGSS JD Acuerdo 1556 (28-ene-2025) + its approval AG 17-2026 (18-feb-2026; DCA Nº 13 20-feb-2026 + Nº 14 pp.6-7 23-feb-2026) = `117_` (W-GT10), the CURRENT standing recargo-EXONERACIÓN regime (lineage 1200 (2006) → 1504/1519 (2022 COVID pair, expired, unacquired) → 1556) — art. 1: "Exonerar el cien por ciento de los recargos sobre las cuotas de contribuciones al Régimen de Seguridad Social que se paguen o se incluyan en reconocimientos de deuda suscritos durante la vigencia del presente Acuerdo, siempre que correspondan a los períodos de contribución anteriores a la vigencia del mismo, aunque se haya promovido el procedimiento de cobro administrativo o cobro judicial correspondiente" + "así como las costas procesales e interés legal" / art. 2 preconditions: "a. Actualizar o ratificar los datos del registro patronal… b. Estar adherido al Sistema de Generación, Transmisión, Validación y Pago de la Planilla de Seguridad Social en forma electrónica. <. [printed "c."] Generar, transmitir y validar la Planilla… por los períodos a exonerar. d. Que, dentro de la vigencia de este Acuerdo, se paguen los montos totales o parciales adeudados" + "Se aceptarán pagos parciales siempre y cuando se hagan por el monto total de un documento de cobro… Sin embargo, se podrá suscribir el reconocimiento de deuda siempre que se incluya la totalidad de la deuda." / art. 3: "tendrá una vigencia de seis meses y su aprovechamiento no exime a los patronos de continuar con el pago de las contribuciones" / art. 4: firm judgments favorable to IGSS excluded / art. 5: contested cobros enter only "siempre que adjunte a la solicitud copia del desistimiento correspondiente" / art. 7-8: RD = all pending periods; breach "ocasionará la pérdida de los beneficios obtenidos"; RD "tendrán la calidad de título ejecutivo" / art. 9: "El Instituto procederá de oficio y, previo análisis, a la anulación de los documentos de cobro que contengan únicamente saldos por recargos por mora, recargos adicionales por gastos administrativos, intereses resarcitorios…" / art. 10: dación en pago of inmuebles (2-year completion + ONE ≤equal extension; RD ">60 meses" needs Gerencia authorization) / art. 12: "empezará a regir treinta días después de su publicación en el Diario Oficial" | The amnesty overlay on the recargo ledger: 100% of recargos + costas + interés legal (NEVER the cuotas capital) for PRE-window periods, on payment or RD subscription during a SIX-MONTH window; eligibility couples to the planilla-electrónica system (adherence + back-filed planillas for the exonerated periods + payment in window; partials per WHOLE documento de cobro); recargo-only residual cobros die EX OFFICIO; dación-en-pago path facultative. Dating: 1556 emitted 28-ene-2025; AG 17-2026 dated 18-feb-2026; two-issue DCA structure disclosed (AG in Nº 13 20-feb; 1556 text + Gerencia order in Nº 14 23-feb, receipt "(336716)-23-febrero") → rige ≈25-mar-2026 (30-day clock, computed) → window closes ≈25-sep-2026 (computed; day-precision open — OQ); POST-WINDOW state NOT in corpus (lineage shows re-issuance pattern — JD-library watcher, OQ). A dated-regime overlay (D15/D16), never a fifth reglementary waiver case (FR-182 keeps the four 08-SGF/2026 cases) | `gt/sources/117_IGSS_Acuerdo1556_AG17-2026_Exoneracion.pdf` | pp.1-3 (AG p.1-2; 1556 arts. 1-12 p.2; art. 12 dating + Gerencia order p.2-3) (EVID-1318..1328; range EVID-1318..1328) |
...
máximo and the afecto-a-IVS test load exclusively from JD PROGRAM
reglamento rows (GOQ-04, re-refined 2026-08-23: SEM set `104_`-`106_`
acquired RATELESS per LB-026 — and W-GT9 per LB-027: the IVS Acuerdo 1124
IS now in corpus, its art.-40 pair 3.67%/1.83% seeding the IVS rate rows
as statute-anchored defaults, while the SEM/accidentes operative rates
remain external on the 410 art.-85 chain 475→1243 + a successor
instrument); the COTIZABLE-COMPONENT LIST,
...
### 3.1 Law layer — D-295 architecture (IVS rates statute-anchored LB-027; SEM/accidentes external)
...
- **GT-PAY-FR-155:** EXTERNAL-PARAMETER MODEL (GOQ-04, this file owns it):
  ...
  provenance per D15/D16); W-GT9 (LB-027): the IVS cuota-rate rows now
  ship STATUTE-ANCHORED DEFAULT VALUES 3.67% patronal / 1.83% laboral with
  provenance Acuerdo 1124 art. 40 (valid_from 2003-03-13
  flagged-presumptive — evidence OQ, never frozen harder), while the
  SEM/accidentes rate rows and every other value row stay EMPTY flagged
  GOQ-04 pending acquisition (410 art.-85 chain 475→1243 + a successor
  instrument; 1118-family/1421 print no rates); the 12.67%/4.83% priors
  ...
  (LB-002; LB-003; LB-011; LB-027; EVID-302, EVID-303, EVID-311, EVID-1215,
  EVID-1216, EVID-1302; GOQ-04 → OQ-001)
...
### 3.2 Contribution mechanics — 08-SGF/2026 §V (IVS rates anchored; SEM/accidentes external)
...
- **GT-PAY-FR-165:** The system shall implement the minimum monthly
  ...
  top-up posting, not a worker deduction); the base is now STATUTE-ANCHORED
  as a FORMULA (1421 art. 5 as REFORMED by Acuerdo 1520, LB-028): monto
  base = OE salario mínimo (jornada diurna, ≥8 hours/day, by activity — the
  GT-PAY-FR-073 feed) × factor de expansión **243.3333 (hora) / 30.4167
  (día) / 1.00 (mes)**, carried as dated rows (periods before 29-sep-2022 =
  the 2018 art. 5 raw-SMM floor, EVID-868 vintage; from 29-sep-2022 = the
  factor formula, EVID-1310/1311) — while the PERCENTAGES applied to the
  base remain an external parameter row (GOQ-04, FR-155; "normativa
  institucional vigente" per the reformed art. 5 itself, EVID-1312): the
  minimum-contribution AMOUNT = base × delegated percentages, never a
  printed constant, and its kinship to the salario mínimo floor concept is
  consumed from `03_minimum-wage.md` GT-PAY-FR-073 (by id; the AG-vigente
  as-of resolution is owned there). (LB-012; LB-028; EVID-312, EVID-1310,
  EVID-1311, EVID-1312; cross-ref GT-PAY-FR-073)
...
- **GT-PAY-FR-169:** The cotizable-component surface shall be
  anchored at Acuerdo 1421 art. 4 **as REFORMED by Acuerdo 1520 (LB-028 —
  the itemization and exclusions stand in both the 2018 and 2022 texts,
  EVID-868 pre-reform / EVID-1308-1309 post-reform; the reform ADDS the
  inline floor clause "siempre que el salario total no sea menor al monto
  base… caso contrario se deberá utilizar este último" to art. 4 itself)**: the cuotas compute over the
...
- **GT-PAY-FR-182:** The recargo-waiver workflow shall implement the ONLY
  ...
  *arreglo directo* (window from relation resumption); (b) retroactive
  ...
  DISTINCT from these four REGLAMENTARY waiver cases, the LEGISLATIVE
  amnesty window (JD Acuerdo 1556 + AG 17-2026, LB-029) grants a standing
  100% recargo/costas/interés-legal exoneración for PRE-window periods on
  payment or RD subscription during its six-month window (≈25-mar-2026 →
  ≈25-sep-2026, computed; post-window state open, LB-029) with
  planilla-electrónica preconditions and whole-document partial payments —
  modeled as a DATED-REGIME OVERLAY on the recargo ledger (D15/D16), never
  as a fifth waiver case.
  (LB-021; LB-029; EVID-321, EVID-1320..1322)
- **GT-PAY-FR-183:** Materiality and historical-cutoff ledger: no collection
  ...
  boundary (29-sep-2022 — LB-022's Sep-2022 recital reading now PRIMARY and
  day-precise via LB-028/EVID-1316: 1520 rige the day after its DCA
  publication of 28-sep-2022) may use those periods' planilla format (dated
  format-boundary row); and planillas for debts earlier than March-1977 are
  not demandable (exigibility cutoff row).
  (LB-022; LB-028; EVID-322, EVID-1316)
...
reglamentos), RE-REFINED 2026-08-23 (LB-026: the SEM set `104_`-`106_`
acquired RATELESS) and its IVS-rate half RESOLVED the same day (LB-027:
the IVS Acuerdo 1124 IS in corpus — art.-40 pair 3.67/1.83
statute-anchored; the residue = the SEM/accidentes operative rates on the
410 art.-85 chain 475→1243 + a successor instrument); GOQ-74/75 stay
open; GOQs are
...
|----|----------|-----------|-------|--------|
| OQ-001 | GOQ-04 (owned, =OQ11, TARGET REFINED 2026-08-22): NONE of the corpus instruments prints the cuota percentages (12.67% patronal / 4.83% laboral priors unverifiable — rejected), the minimum monthly contribution-base amount, any tope máximo (no ceiling text anywhere — FR-166 negative) or the afecto-a-IVS test — Acuerdo 1421 is NOW IN CORPUS (`87_`/LB-025) and its art. 1 EXPRESSLY DELEGATES the montos to the reglamentos of the respective coverage programs (EVID-867): the acquisition target is thereby REFINED to the JD PROGRAM reglamentos (IM/IVS program sense of the 1118 family), NOT the recaudación line (art. 47's repeal of JD 1118/1200/1310 affects only the collection reglamentos; the cotizable-COMPONENT list, by contrast, is anchored at 1421 art. 4 — FR-169). **W-GT8 RE-REFINEMENT 2026-08-23 (`104_`-`108_` in corpus, LB-026; EVID-1132..1185): the SEM program-reglamento set (Acuerdo 410 consolidations `104_`/`106_` + reform Acuerdo 1154 `105_`) is IN CORPUS — RATELESS**: its only cuota text is art. 62's 1964 originals (4%/2%/1%; the 2011 print `106_` reads 3%/2%/1%), departamento-de-Guatemala-only per art. 85 and superseded by the unprinted footnote-21/23 extension chain (Acuerdos 475→616→621→849→1024→1095→1121→1243 — EVID-1151/1155/1167) — the rate target is thereby the IVS program reglamento **Acuerdo 1124 de Junta Directiva** (NAMED by the `107_` requisitos sheet: "(Artículo 22 y 23 del Acuerdo 1124 de Junta Directiva)") + that chain; the 12.67/4.83 priors remain rejected; the SEM set's benefit/qualification mechanics (art. 6's 3/6 + art.-26 maternidad credit; 84 Bis 4/6) are now primary. Until acquired: FR-155 ships EMPTY flagged rows (feeds file 09's estimated surfaces GT-TAX-FR-124/135); FR-165 floor = row only; FR-163 afecto test = config; FR-157 share-shift operative detail = config. **W-GT9 RESOLUTION 2026-08-23 (`109_`/`115_` in corpus, LB-027; EVID-1186..1216, 1301..1303): IVS-rate half RESOLVED (LB-027; 3.67/1.83/5.50 pair; Estado 25% = benefits, never a payroll line; rates UNTAGGED in both consolidation vintages — valid_from 2003-03-13 flagged-presumptive; art.-40 stem base, NO tope/floor)** — FR-155's IVS rows now seed the 3.67/1.83 anchored defaults; **residue = SEM/accidentes operative rates (410 art.-85 chain 475→1243 + a successor instrument; 1002 art. 46 prints 1994 originals untagged)**. **W-GT10 (2026-08-23): JD-library hunt verdict NEGATIVE (EVID-1329)** — full sweep of igssgt.org/acuerdos-y-resoluciones (~500 titles, 1989-2026 + program-reglamento uploads): NO Acuerdo 475, NO SEM/accidentes rate-setting instrument (the library's "1243" = the 2010 SEM EXTENSION to Santa Rosa/El Progreso/Petén — the W-GT9 acdo1243_2010ger rejection stands); the public "Consulta Cuotas IGSS" service = login-gated Portal del Afiliado (no rate table); remaining routes = owner-browser DCA-archive hunt + the "normativa institucional" that fixes the reformed-art.-5 percentages. 1520's art.-5 distribution proportions (EMA 0.258065/0.129032 · Acc 0.193548/0.064516 · IVS 0.236774/0.118065; ×15.50% total ⇒ EMA 4%/2% + Acc 3%/1% with IVS 3.67/1.83 exact — also mechanically explaining the folk "12.67" as 10.67 IGSS-patronal + IRTRA 1 + INTECAP 1) recorded as CORROBORATION-ONLY (LB-028; EVID-1313) — never a rate source; the rejected-prior verdicts STAND. | no | GT synthesis wave S-GT3 → acquisition queue (the 475→1243 art.-85 rate chain + a successor SEM/accidentes rate instrument — NOT 410 (SEM set acquired rateless, LB-026), NOT 1124 (acquired — IVS rates anchored, LB-027), NOT 1421, which prints no rates; W-GT10: NOT the JD library either — EVID-1329 negative; DCA-archive owner-browser route only) | open (IVS-rate half RESOLVED W-GT9 2026-08-23, LB-027; residue = SEM/accidentes operative rates; JD-library route exhausted W-GT10) |
