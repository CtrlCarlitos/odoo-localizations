...
| [07_igss-contributions.md](07_igss-contributions.md) | P4 | IGSS: 25/50/25 structure-only; IVS rates STATUTE-ANCHORED W-GT9 (1124 art. 40: 3.67/1.83 = 5.50 pair — LB-027); SEM/accidentes rates external (410 art.-85 chain JD-library-exhausted W-GT10 — DCA-archive route only; 1002 = accidentes originals untagged; 1520 proportions = corroboration-only); cotizable components anchored (1421 art. 4 as reformed by 1520 — LB-028); base floor FORMULA anchored W-GT10 (art. 5 as reformed: SMM × 243.3333/30.4167/1.00, percentages still delegated); planilla due day-20 + mora tasa rule + RD interest anchored (Acuerdo 1421 = 87_, index values external); two-share delivery; NO tope (negative); single receipt; mora/RD/nota-de-cargo; waivers + 1556 standing exoneración window (LB-029, ≈25-mar→25-sep-2026 dated-regime overlay); ±1% | GT-PAY-FR-153..184 | 32 | 29 | 16 | 4 |
...
| 07_igss-contributions.md | 29 | 16 |
