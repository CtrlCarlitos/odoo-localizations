...
- **GT-TAX-FR-188:** Emitters of facturas especiales (buyers invoicing on
  ...
  (IVA + ISR on the same document) is coordinated with Task 3
  (GT-TAX-FR-080..085 family) — this file owns only the ISR 5%.
...
| FR-188 | shared | — (config data §4 / CSV) | factura especial 5% rows (pre/post 2019) | Dual retention coordinated w/ Task 3 (GT-TAX-FR-080..085) |
