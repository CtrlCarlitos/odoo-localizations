...
D-10-2025)"; the post-2018 consolidated text is missing (GOQ-01 — still
open; the D-31-2024 delta instrument itself is now primary in corpus (85_,
read 2026-08-22, EVID-801..819) as is its D-10-2025 derogation counterpart
(74_), and the pacto-fiscal D-62-2001 delta (88_, EVID-834..839) anchors
the D-27-92 arts. 4.1 / 24 / 29 último ¶ / 31 / 32 / 36 lineage — but no
post-2018 consolidated IVA text exists in corpus). The IVA
...
- **GT-TAX-FR-038:** The statutory document skeleton shall be recorded as
  ...
  — EVID-813); FEL DTE obligations come exclusively from the GT-EINV
