...
| LB-021 | Chain-provenance additions (99_ + 100_ + 101_): (a) D-4-2012 (100_) inventario: Libro II (IVA) = 18 artículos operativos — reformas de los arts. 9, 18, 29, 32, 45, 46, 47, 48, 49, 50; 2 renombres de capítulo (11, 14); 6 adiciones (14 "A"; 52 "A"; 57 "A"-"D") — cada artículo reformado coincide exactamente con los sellos del texto consolidado; Libros I/III-VIII: retención definitiva ISR 5%/6% en facturas especiales, bancarización Q.30,000, CT/timbres/penal; vigencia: "entrara en vigencia ocho días después de su publicación en el Diario Oficial." (art. 77; ausente del OCR de 100_, recuperado de la cola de transitorios de 99_ — OQ-1) / (b) 101_ (gaceta LAT): "No. 2 Tomo CCXCJV [sic CCXCIV]" / "Guatemala, LUNES 5 de marzo 2012 DIARIO de CENTRO AMÉRICA NÚMER02 [sic NÚMERO 2]" / (c) 99_, Cap. VIII: "RÉGIMEN ESPECIAL DE CONTRIBUYENTE AGROPECUARIO* / *Adicionado por el Artículo 2 del Decreto Número 7-2019." — art. 54 "A": "…cuyo monto de venta anual de sus productos, no exceda los tres millones de Quetzales (Q.3,0 00,000.00) [sic Q.3,000,000.00]… pagarán mensualmente un tipo impositivo del cinco por ciento (5%) sobre las ventas brutas para criadores de ganado vacuno, equino, porcino y caprino. Para el caso de compradores, vendedores y engordadores es el cinco por ciento (5%) sobre las utilidades." / art. 54 "B": retención pago definitivo; enterar "dentro del plazo de diez (10) días del mes inmediato siguiente a aquel en que se efectúa el pago o acreditamiento." / Cap. IX: "RÉGIMEN ELECTRÓNICO DE PEQUEÑO CONTRIBUYENTE Y RÉGIMEN ESPECIAL DE CONTRIBUYENTE AGROPECUARIO* / *Adicionado por el Artículo 7 del Decreto Número 7-2019 del Congreso de la República." — art. 54 "E": "estarán afectos a un tipo impositivo reducido del cuatro por ciento (4%) en sustitución del cinco por ciento (5%) establecido en los artículos 47 y 54 "A"." / "…el décimo día hábil de cada mes calendario, debite automáticamente de dicha cuenta el monto equivalente a aplicar el tipo impositivo del cuatro por ciento (4%) sobre el total de ingresos reportados en el mes inmediato anterior…" / art. 54 "F": bancarización "como condición para mantenerse en el régimen." | Chain-provenance additions. (a) D-4-2012's own gazette inventory primary-confirms the 23_/99_ footnote chain (pequeño-chapter rewrite around Q150,000 + GFACE recognition + 52 "A"/57 "A"-"D" adiciones + the non-IVA half: Q.30,000 bancarización, ISR 5%/6% factura-especial retentions); vigencia = published 17-feb-2012 + 8 days → 25-feb-2012 (art. 77 recovered via 99_). (b) 101_ = the LAT's own DCA gazette: D-10-2012 published Monday 5-mar-2012, DCA No. 2 Tomo CCXCIV — the promulgation anchor alongside 26_ (consolidated through D-46-2022; 26_ prints emitted 16-feb/sanctioned 1-mar but no DCA date); art. 181's DCA+8d rule now computes base vigencia 13-mar-2012 (Libro I ISR deferred to 1-ene-2013 per FR-241). (c) **GOQ-146 RESOLVED**: D-27-92 caps. VIII/IX (99_) are NOT a 1992 tariff appendix — VIII = RECA (arts. 54 "A"-"D": Q3M ceiling; 5% brutas/utilidades; 10-day retention enter) and IX = the electrónico pair (arts. 54 "E"-"F": the 4%-in-lieu-of-5% tariff for 10th-hábil automatic-bank-debit payers + bancarización as permanence condition), both added by D-7-2019 and valid ONLY 2019 → 2025-08-09 (derogated by D-31-2024 art. 25 — 85_ EVID-819); NO recargos/intereses-% article exists in either chapter (general late-payment rates remain CT-side — 25_). Consequence: fiscal-reporting/04's electrónico 4%/5% tariff rows cite art. 54 "E" and MUST carry the 2025-08-09 sunset (GT-FIN-side row edit = controller's) | `gt/sources/99_IVA_27-92_Consolidado_2019.pdf` + `gt/sources/100_IVA_D4-2012_DCA.pdf` + `gt/sources/101_LAT_D10-2012_DCA.pdf` | 100_ pp. 2–13 inventarios (EVID-1064/1065); art. 77 recovery (EVID-1066, OQ-1); 99_ pp. 40–43 caps. VIII–IX (EVID-1047..1053); tag census (EVID-1032); 101_ p.1 masthead + p.2 header (txt-verified 2026-08-23; no evidence .md yet) |
...
master-index annotation is the controller's. GOQ-146 (owned
fiscal-reporting/04 §7, not rowed here) is likewise RESOLVED 2026-08-23
via 99_ (LB-021: caps. VIII/IX = RECA + electrónico pair; the 4%/5%
electrónico tariff = art. 54 "E", D-7-2019; both chapters derogated
2025-08-09 by D-31-2024 art. 25) — the fiscal-reporting/04 row edit and
master-index annotation = controller's.
...
| OQ-005 | GOQ-01 (kin, register lists TX1/TX2/TX3 freeze): "Post-2018 consolidated Ley IVA 27-92 text: Art. 29-'A' body, Ley 25 bis adder (electronic 100% refund), art. 54 B/BIS nomenclature, post-2012 exemption families (peaje/turismo/canasta), Q150,000 currency." Affects FR-238 (absent-articles), FR-249 (never-alone qualifier). **RESOLVED-COMPOSITE 2026-08-23: 99_ = D-27-92 consolidated through the 2019 wave now in corpus (`99_IVA_27-92_Consolidado_2019.pdf`; LB-021; horizon audit clean — max tags D-4-2019/D-7-2019, zero 2020+, EVID-1032; full anchors in [01_iva-core.md](01_iva-core.md) LB-022) — 29-"A" and 25 bis full text primary; art. 54 nomenclature = caps. VIII/IX arts. 54 "A"-"F"; art. 7 still 15 numerales (peaje/turismo/canasta never added 2012→2019); Q150,000 unchanged. Composite closure = 99_ (through 2019) + 85_ (D-31-2024) + 74_ (D-10-2025); single-print editions through D-10-2025 remain unacquired — every operative article is primary-sourced. FR-238's absent-articles list remains valid FOR 23_ (per-copy register rows unchanged, append-only per FR-261); FR-249's qualifier now composes 99_ into the chain; master-index annotation = controller's.** | no | GT synthesis wave S-GT2 (resolved in-corpus 2026-08-23; master-index annotation = controller's) | resolved (2026-08-23; composite) |
