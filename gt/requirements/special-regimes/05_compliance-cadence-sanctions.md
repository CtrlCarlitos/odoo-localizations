...
14-Sep-2022 — R72); fondo reglamento = **72_** (AG 296-94). **D-19-2016
remains the blocking acquisition** (GOQ-08): the art. 43 bis suspension
ladder and the art. 34 trailing-planilla paragraph are D-19-2016 additions
provenance-limited to their printed texts + tags — no transitional clause
is readable. Quotation source: the committed evidence files
`gt/.extractions/69-71_Maquila.evidence.md` (EVID-711..745) and
`gt/.extractions/67-68_72_80_81_ZF.evidence.md` (EVID-646..708) — both
...
- **GT-SPR-FR-160:** The system shall carry the ladder configuration as
  ...
  D-19-2016 art. 17 (added 31-03-2016). GOQ-08 fence: the ladder is
  provenance-limited to its printed text + tag — no pre-2016 ladder
  exists in print, and D-19-2016's transitional clauses (if any touched
  pre-existing beneficiaries) are unreadable; no transitional mechanic
  shall be modeled. (LB-009; EVID-730; GOQ-08 → OQ-005)
...
- **GT-SPR-FR-162:** The system shall implement the reglamento 23
  ...
  (LB-004; EVID-736; cross-ref GT-SPR-FR-114, FR-157, FR-158)
...
| l10n_gt_regimes.ladder_config | tier_rows · thresholds · recidivism_windows | dated config | 2/4/6 meses · 50 trabajadores · 1-enero–31-diciembre · 2 años · 3× — provenance D-19-2016 art. 17 (31-03-2016); GOQ-08 fence: no transitional mechanics | FR-160 |
...
| FR-160 | shared | ladder_config | 2/4/6 · 50 · 1-yr · 2-yr · 3× | Provenance D-19-2016 art. 17; GOQ-08 fence on transitionals |
...
law arts. 33-43 bis through the D-19-2016 layer; AG 533-89 arts. 23-33
...
external — fondo resarcitorios) and GOQ-08 (D-19-2016 transitional
dependencies of the suspension ladder and the art. 34 attach paragraph).
...
| OQ-005 | GOQ-08 (kin, transitional-clause dependency): the art. 43 bis ladder and the art. 34 trailing-planilla paragraph are D-19-2016 additions (arts. 17/13, 31-03-2016) whose transitional clauses are unreadable — whether pre-2016 beneficiaries were ever subject to a different suspension/cancellation regime cannot be resolved from this corpus; FR-160 fences the ladder config to the printed text + tag and blocks all transitional mechanics until D-19-2016 lands (top acquisition priority). | yes | GT synthesis wave S-GT6/S-GT7 (acquisition queue — D-19-2016) | open |
