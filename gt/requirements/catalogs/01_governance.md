...
| LB-006 | Portal cat.desa.sat.gob.gt, /xsd/alfa + /catalogos/alfa (recuperado 2026-08-18) | cat.desa.sat.gob.gtalfa directories (retrieved 2026-08-18) — second publication channel; drift comparand | `gt/sources/30_FEL_XSD_cat_catdesa/` | portal snapshot (EVID-030; master-index FEL authority preamble) |
