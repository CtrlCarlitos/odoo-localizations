...
| LB-017 | 103_ SAT Calendario Mensual Tributario, Enero–Agosto 2026 (8 app-printed PDFs; column header "Fecha Vencimiento Nombre Impuesto Concepto Asiste Web Declaraguate"): (IVA general art. 40, Enero) "05/01/2026 Al Valor Agregado (Operaciones afectas y exentas). Declaración jurada y recibo de pago mensual del Impuesto al Valor Agregado, para contribuyentes que realizan operaciones afectas a este impuesto, incluyendo las exentas (locales y de exportación). Decreto Número 27-92, Ley del Impuesto al Valor Agregado. Artículo 40. Durante Noviembre de 2025 2237" / (Agosto) "31/08/2026 Al Valor Agregado (Operaciones afectas y exentas). Declaración jurada y recibo de pago mensual del Impuesto al Valor Agregado, para contribuyentes que realizan operaciones afectas a este impuesto, incluyendo las exentas (locales y de exportación). Decreto Número 27-92, Ley del Impuesto al Valor Agregado. Artículo 40. Durante Julio de 2026 2237" / (inhábil ruling, every-page footer) "Conforme a la Resolución SAT-DSI-1328-2026 de fecha 10 de agosto de 2026, se otorga permiso laboral con goce de salario al personal de la SAT el día 14 de agosto de 2026. Por lo tanto, para el cómputo de plazos tributarios, aduaneros y administrativos, dicho día debe considerarse inhábil para el municipio de Guatemala, Departamento de Guatemala, municipio de Chiquimula, Departamento de Chiquimula y municipio de Sololá, Departamento de Sololá." / (CT boilerplate, same footer) "Nota Importante: De conformidad con lo establecido en el Artículo 8, numeral 2 del Código Tributario, Decreto Número 6-91, se consideran inhábiles tanto los días declarados o que se declaren feriados legalmente, como aquellos en los que la Administración Tributaria no haya prestado servicio al público por cualquier causa, debiendo llevarse un registro riguroso de ello." | Interpretation: (i) SAT's current calendar = FLAT per-obligation deadlines — ONE date per period, zero NIT-digit/group stagger in all 8 months (full-text verified: no "NIT"/"dígito"/"grupo" hits anywhere); the owner additionally verified the current Calendario app exposes NO digit-keyed windows → the historic per-NIT-digit model is retired from SAT's published practice; deadline ingestion = per-obligation flat dates + month-scoped inhábil rulings (GOQ-14/145 re-scope: digit windows stay an external/configurable legacy compat, never asserted as current SAT practice); the 14-ago-2026 inhábil is PER-LOCALITY (municipios Guatemala, Chiquimula, Sololá ONLY) — inhábil rolls must be municipality-scoped, never national, on top of the CT art. 8 num. 2 rule; (ii) each row prints Formulario/Asiste-Web/Declaraguate code columns — channel-map corroboration for this registry (unambiguous prints: "----- 2340" Declaraguate-only, "541 Agencia Virtual", "1111 -------" Asiste-Web-only; lone codes e.g. 2237 lack column attribution in the text layer); (iii) D-7-2019 RECA arts. 54 "A"-"F" ABSENT from all 8 months (0/8 — consistent with the D-31-2024 art. 25 derogation, registry cross-ref); D-31-2024 ICT rows appear Julio/Agosto only | `gt/sources/103_SAT_Calendario_2026-01.pdf` … `-08.pdf` (via `gt/.extractions/103_SAT_Calendario_2026.evidence.md`) | `103_-01` p.1 + `103_-08` p.4 (art. 40 rows, EVID-1096); footers all 35 pp. (ruling EVID-1094; boilerplate EVID-1093); flat verdict EVID-1095 + owner app note EVID-1115; channels EVID-1116; RECA absence EVID-1112; ICT EVID-1111 |
...
| OQ-005 | GOQ-14: "Accountant asks pending: calendario perpetuo vencimiento windows per NIT last-digit (JSF transcription, owner browser; atlas.com.gt cross-check only)…" Ingestion surface FR-024; window VALUES are external data — never invented; back-fill on acquisition (HANDOVER §8 plan B). ANNOTATED (W-GT8, 103_/LB-017): SAT's 2026 Calendario prints FLAT per-obligation deadlines — one date per period, zero NIT-digit/group stagger across all 8 captured months; owner-verified the current Calendario app exposes NO digit-keyed windows → digit windows re-scoped to external/configurable legacy compat, never asserted as current SAT practice; ingestion = per-obligation flat dates + month-scoped (municipality-scoped) inhábil rulings (GOQ-14/145 kin). | no | GT synthesis wave S-GT4 → accountant track / owner-browser JSF transcription (W6) | open (re-scoped per LB-017) |
