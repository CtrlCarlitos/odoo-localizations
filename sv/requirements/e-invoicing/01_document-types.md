...
- **SV-EINV-FR-012:** The system shall enforce the structural limits per document: cuerpo maximum 2000 items (CRE and CLE: 500); documentos relacionados maximum 50 documents totaling at most 2000 items; otrosDocumentos 1–10 entries (FEXE: 1–20); apéndice 1–10 entries. (LB-004 N°74 + LB-005 §1.5; R10; DCLE cap → OQ-005)
...
| l10n_latam.document.type | related_doc_codes | char list | 05/06→03,07 · 06→03,05,06,07 · 01/03→04,08,09 · 11→04 · 04→01,03,11 | FR-015 |
