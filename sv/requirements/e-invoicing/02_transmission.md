...
| OQ-003 | MOQ-05: Retorno / Operaciones Especiales event endpoint paths absent from 46_ v2.0 (25-May) and from the Anexos — check 52_ schemas and later manual revisions for service paths. | no | Takumi (schema pass) | open |
