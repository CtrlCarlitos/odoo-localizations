# SV — Commercial-legal — Society lifecycle: capital variable, fusión transnacional, transformación, liquidación, nullity/irregularity and foreign societies (fusión/Art. 358 per 111_ D.L. 905-2023; Art. 338 escheat per 109_ D.L. 153-2021)
...
| Authors | Takumi synthesis wave 5 (S5 commercial-legal) + W23 T3 |
| Updated | 2026-08-23 |
...
universal succession, the per-society agreement/inscription/
publication pipeline, CROSS-BORDER fusión with foreign societies
(111_ D.L. 905-2023: enablement, governing-law split,
SV-only inscription, the SAS formulario route and the
absorbed-abroad cancellation duty), the 90-day opposition window, the
dissident socio's retiro, and the notary/suscriptor
Superintendencia-de-Competencia comprobar-or-declarar checkpoint with
personality extinguished at inscription; the transformación
...
of Arts. 358-361 — as reformed by 111_ Art. 8: acts of commerce
permitted unless home law prohibits, the domicilio-fixing
adecuación-escritura route with personality continuity — including the
MINEC-first ordering of capital-change inscriptions, and the Art. 338
escheat of unclaimed liquidation sums to the Fondo General del Estado
(109_ D.L. 153-2021). This file also carries the SOQ-24 quiebra scope
note (Arts. 498-552 — terminology only, no FRs).
...
for the reformed articles, and THIS file's zone is hit at **Arts. 315,
316, 317 and 319 (111_ D.L. 905-2023, fusión transnacional — Arts. 4-7
of the decree; LB-005 annotated, LB-006/LB-008 re-anchored, LB-031/032
added), Art. 337 inciso 4 + Art. 338 (109_ D.L. 153-2021 — LB-018
annotated, LB-033 added) and Art. 358 (111_ Art. 8 — LB-033 added;
LB-028 keeps the surviving incisos 2-3 print) — RE-ANCHORED in-file
W23 T3** (FR-077/079/086/097 amended, FR-243..245 added). Arts. 318
and 320 (LB-007; FR-078) are OUTSIDE both reforms' touch — the 07_
print stands current there. Census residual (negative watch): por-anios
carries no cards for 2010/2012-2015 and 2019 looks partial — a
2009-2019 CC reform cannot be fully excluded from enumeration alone;
the six owned instruments carry the KNOWN post-2008 surface. Verbatim
text below is copied from the 07_ evidence file (EVID-221/222/224)
and — the evidence glosses summarize this article range — from the
extraction txt `sv/.extractions/07_Codigo_Comercio.pdf.txt` (citable
per standing ruling; page pointers = txt PAGE markers; reform tick
marks "(18)(24)(29)" stripped from quotations, provenance noted
here); the reformed-in-file articles quote the 111_/109_ reform texts
directly (LB-005/006/008/018 annotations + LB-031..033 below; txts
`sv/.extractions/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf.txt`
and `sv/.extractions/109_Reforma_CodigoComercio_DL153_2021_Asamblea.pdf.txt`,
...
| LB-005 | Código de Comercio, Art. 315 (inciso 1, as printed — untouched by 111_): "Hay fusión cuando dos o más sociedades integran una nueva, o cuando una ya existente absorbe a otra u otras. La nueva sociedad o la incorporante adquiere los derechos y contrae todas las obligaciones de las sociedades fusionadas o incorporadas." NEW incisos 2-3 (111_ D.L. 905-2023, Art. 4 — ADICIONADOS, operative from 11-feb-2024): "Una o más sociedades constituidas conforme a las leyes de la República de El Salvador, podrán fusionarse con una o más sociedades nacionales o extranjeras." "En la fusión de sociedades extranjeras con sociedades salvadoreñas, se cumplirán con las disposiciones y trámites que establezca la legislación a la que se encuentren sujetas las sociedades a fusionarse, incluyendo los relativos al proceso de toma de decisiones sobre la fusión. En lo que respecta a las sociedades salvadoreñas le será aplicable lo establecido en el presente Código." Art. 316 (as printed): "Cuando de la fusión de varias sociedades haya de resultar una distinta, su constitución se sujetará a los principios que rijan la constitución de la sociedad a cuyo género haya de pertenecer. Si la fusión es por absorción deberá modificarse la escritura de la sociedad incorporante." + NEW inciso final (111_ Art. 5): "Cuando tenga lugar la fusión de sociedades salvadoreñas con sociedades extranjeras, y la nueva sociedad resultante o la sociedad incorporante sea salvadoreña, el nuevo pacto social o las respectivas modificaciones al pacto social, se regirán por el presente Código y deberán ser acordes en su contenido y forma con el ordenamiento jurídico nacional." Art. 321 (as printed, untouched): "Los socios de las sociedades fusionadas que vengan a ser socios de la sociedad nueva o de la absorbente, recibirán participaciones sociales o acciones en la proporción equivalente a las que anteriormente tenían, salvo convenio." | There is fusión (merger) when two or more societies integrate a new one, or when an existing one absorbs another or others. The new or absorbing society ACQUIRES THE RIGHTS and contracts ALL the obligations of the merged/incorporated societies (universal succession). NEW (111_): one or more societies constituted under the laws of El Salvador may fuse with one or more NATIONAL OR FOREIGN societies (fusión transnacional enablement); in foreign+salvadoreña fusions each participant complies with the disposiciones y trámites of the legislation it is subject to — INCLUDING its decision-taking process — while the salvadoreñas apply this Code (governing-law split); and where the resulting new society or the incorporante is SALVADOREÑA, the new pacto social (or its modifications) is governed by this Code and must accord in content and form with the national ordenamiento. When a distinct society is to result, its constitution follows the principles governing constitution of the género it belongs to; if the fusión is by absorption, the absorbing society's escritura must be modified. Socios of the merged societies becoming socios of the new or absorbing one receive participaciones or acciones in the proportion equivalent to those previously held, unless otherwise agreed | `sv/sources/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf` (base print co-cited: `sv/sources/07_Codigo_Comercio.pdf`) | 111_ Arts. 4-5 (txt PAGE 10; EVID-409); 07_ Arts. 315-316 p.58; Art. 321 p.59 (EVID-221; txt PAGE 58-59) |
| LB-006 | Código de Comercio, Art. 317 (as REPLACED by 111_ D.L. 905-2023, Art. 6 — OPERATIVE from 11-feb-2024): "Art. 317.- El acuerdo de fusión entre sociedades constituidas de conformidad con la legislación salvadoreña, deberá ser tomado por cada una de ellas en la forma que establezca su pacto social y dicho acuerdo deberá inscribirse en el Registro de Comercio. Hecho el registro, deberá publicarse dicho acuerdo y el último balance de las sociedades." "Cuando la fusión tenga lugar entre sociedades salvadoreñas y extranjeras, únicamente las salvadoreñas procederán a la inscripción del respectivo acuerdo de fusión en el Registro de Comercio." [Provenance — 07_ historical print, superseded 11-feb-2024: "El acuerdo de fusión deberá ser tomado por cada sociedad en la forma que corresponda resolver la modificación de su pacto social y debe inscribirse en el Registro de Comercio del domicilio de cada una de las sociedades fusionadas, debiendo anotarse marginalmente en las inscripciones de las escrituras sociales de tales sociedades. Hecho el registro, deberá publicarse dicho acuerdo y el último balance de las sociedades." — the per-domicile registry clause ("del domicilio de cada una de las sociedades fusionadas") and the marginal-annotation duty ("debiendo anotarse marginalmente…") are GONE from the replaced text; the agreement-form basis shifts from "la forma que corresponda resolver la modificación de su pacto social" to "la forma que establezca su pacto social".] | The merger agreement between societies constituted under salvadoreña legislation is taken by EACH of them in the form its pacto social establishes, and the agreement is INSCRIBED in the Registro de Comercio (single registry — no per-domicile clause; the marginal-notes duty on the escritura-social inscriptions is superseded and dropped); once registered, the agreement AND the societies' LAST BALANCE are PUBLISHED (Art. 486 default engine applies, SV-CML-FR-017 by id). Cross-border: where the fusión is between salvadoreñas and foreign societies, ONLY the salvadoreñas proceed to the inscription of the respective merger agreement in the Registro de Comercio (317-II). (Historical, superseded 07_ text: per-domicile inscription + marginal annotations.) | `sv/sources/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf` (base print co-cited: `sv/sources/07_Codigo_Comercio.pdf`) | 111_ Art. 6 (txt PAGE 10; EVID-409); 07_ Art. 317 p.58 (EVID-221; txt PAGE 58 — historical) |
...
| LB-008 | Código de Comercio, Art. 319 (as REPLACED wholesale by 111_ D.L. 905-2023, Art. 7 — OPERATIVE from 11-feb-2024; full verbatim text at LB-032): the designados por las sociedades en proceso de fusión draft the nuevo pacto social or the necessary modifications of the absorbente's pacto social, "mismos que deberán ser aprobados por los socios o accionistas de las sociedades correspondientes de conformidad con los requisitos exigidos para el acuerdo de fusión"; execution by the specially designated, failing designation the administrators; "Con excepción de las sociedades por acciones simplificadas, la fusión se hará constar en escritura matriz; y, el testimonio de la misma se inscribirá en el Registro de Comercio, surtiendo efectos a partir de su fecha de inscripción."; cross-border: "será responsabilidad del notario autorizante, relacionar la documentación correspondiente de las sociedades extranjeras a fusionarse donde conste que estas han dado cumplimiento a la legislación aplicable a la fusión de sociedades en su país de origen."; SAS absorbente/resultante: "se deberá completar el respectivo formulario que contendrá el nuevo pacto social o las modificaciones necesarias en el pacto social y será el que se presente a inscripción al Registro de Comercio. Será responsabilidad del suscriptor del formulario hacer constar que las sociedades a fusionarse hayan dado previo cumplimiento a la legislación aplicable a la fusión de sociedades en su país de origen."; inscription checkpoint: "el notario público o el suscriptor del formulario, deberán comprobar ante el Registrador que se cuenta con la aprobación o resolución respectiva de la Superintendencia de Competencia cuando la misma fuese requerida, o bien, declarar que las mismas no deben ser obtenidas, quienes serán responsables administrativamente de la veracidad de la información incorporada y de cualquier perjuicio causado en su defecto."; "Hecha la inscripción, la personería jurídica de las sociedades integradas o absorbidas quedará extinguida."; absorbed-abroad: salvadoreñas whose fusion resulted in incorporation into a foreign society (or the rise of a new foreign-law society) MUST request cancellation of their Registro registration, attaching "la documentación extendida por autoridad competente que compruebe que la fusión ha sido inscrita en el país extranjero" — "El registrador hará constar en el asiento de cancelación el hecho de que ésta procede como resultado de una fusión. Asimismo, hará constar el número de registro o inscripción, la razón social o denominación y la forma jurídica que tenga la sociedad absorbente o resultante de la fusión en el país extranjero."; failure: "De no solicitar la sociedad salvadoreña la cancelación de su registro en el Registro de Comercio, continuará vigente su personería jurídica y en consecuencia, subsistirán sus obligaciones de comerciante, de conformidad con lo establecido en el presente Código." [Provenance — 07_ historical print, superseded 11-feb-2024: the REPRESENTANTES de las sociedades fusionadas drafted the pacto; escritura matriz with NO SAS exception; the Registrador verified one of three Ley de Competencia alternatives (a) not subject to notification / b) SC approval / c) notification without resolution in the law's term); and the express pre-inscription limb "mientras la inscripción no se verifique, las sociedades fusionantes conservarán su personería jurídica, como si la misma no se hubiese llevado a cabo" — all replaced: the checkpoint moves from registry-side to notary/suscriptor-side comprobar-or-declarar, and the retention clause is dropped, continuity now flowing from the extinguishment-at-inscription rule plus the absorbed-abroad subsistence limb.] | The DESIGNADOS (no longer "representantes") draft the new pacto social or the absorbente's modifications, approved by the socios/accionistas with the SAME requisites as the merger agreement; execution by designees or the administrators; the fusión is recorded in ESCRITURA MATRIZ — EXCEPT SAS, where the FORMULARIO containing the new pacto/modifications is the instrument presented for inscription (the 305-A formulario chassis, SV-CML-FR-225 by id) — the testimonio inscribed in the Registro de Comercio, effects FROM the inscription date; cross-border fusión: the authorizing NOTARY must relate the foreign societies' home-law compliance documentation; SAS-absorbente route: the formulario's SUSCRIPTOR is responsible for recording the participants' home-law compliance; for inscription the notary/suscriptor must COMPROBAR before the Registrador the Superintendencia de Competencia approval/resolución when required, OR DECLARE that none must be obtained — administratively responsible for the veracity of the information incorporated and any damage caused in defect; "Hecha la inscripción" the personality of the integrated/absorbed societies is EXTINGUISHED; SV societies absorbed into a foreign society (or merged into a new foreign-law society) MUST request cancellation of their Registro registration attaching foreign-authority proof of the foreign inscription — the registrar records in the cancellation asiento that it proceeds from a fusión, plus the foreign registry number, razón social o denominación and forma jurídica of the absorbente/resultante; FAILURE to request the cancellation → the salvadoreña's personality REMAINS IN FORCE and its merchant obligations SUBSIST (absorbed-abroad-until-cancelled). | `sv/sources/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf` (base print co-cited: `sv/sources/07_Codigo_Comercio.pdf`) | 111_ Art. 7 (txt PAGE 10-11; EVID-409); 07_ Art. 319 pp.58-59 (EVID-221; txt PAGE 58-59 — historical) |
...
| LB-018 | Código de Comercio, Art. 337 (incisos 1-2 as printed, operative): "En la misma sesión de junta general de accionistas en que se apruebe el balance final, podrán los liquidadores proceder a efectuar los pagos que les correspondan a aquellos accionistas presentes o representados. Cuando las acciones a ser liquidadas sean nominativas, los pagos a que hace referencia el inciso anterior, se efectuarán a favor del último accionista que aparezca registrado como tal en el libro de registro correspondiente, cancelándose inmediatamente dicho registro, todo sin perjuicio de la responsabilidad del accionista a cuyo favor se hayan liquidado las acciones, frente a terceros de buena fe a quienes haya traspasado con anticipación a la liquidación los títulos respectivos o constituido gravámenes." [incisos 3-5 as amended by 109_ D.L. 153-2021 — the inciso 4 BEARER limb is DEROGATED (109_ Art. 8: "Art. 8. Deróguense el inciso segundo del Art. 134; el inciso final del Art. 154; el romano IV del Art. 155; el inciso segundo del Art. 219 y el inciso cuarto del Art. 337."), effective 7-oct-2021; the surviving gloss — gravámenes registered on the acciones: liquidation sums consigned judicially before a Mercantile Tribunal for the accionista, judge cites the secured creditor within tercero día to prove the guaranteed obligation (delivery as necessary deposit if not yet exigible, as payment if matured; unproven → gravamen extinguished, sums delivered to the accionista); embargoes: sums placed at the disposal of the Tribunal that ordered the titles' sequestration; the 07_-printed bearer-payment limb (acciones al portador → pago únicamente contra entrega de los títulos) is DEAD — no bearer payment limb survives (nominative-absolute regime, SV-CML-FR-066 by id)] Art. 338 (as REPLACED by 109_ Art. 7 — OPERATIVE from 7-oct-2021): "Art. 338. Las sumas que pertenezcan a los accionistas y que no fuere posible pagar en la sesión de junta general que apruebe el balance final, de la manera expresada en el artículo anterior, se depositarán en una institución bancaria, a la orden del accionista, para cuyo efecto se indicará su número. Este depósito deberá efectuarse dentro del plazo de tres días hábiles contados a partir de la fecha de la aprobación del balance final." "Si transcurren cinco años sin que ninguna persona reclame la entrega de las cantidades depositadas, la institución bancaria deberá entregarlas al Fondo General del Estado." [Provenance — 07_ historical print, superseded 7-oct-2021: the deposit was "a la orden del accionista, si la acción fuere nominativa, o de quien presente el título, si fuere al portador, para cuyo efecto se indicará su número" — the bearer/presenter limb is GONE; and the 5-year unclaimed destination read "la institución bancaria deberá entregarlas al centro de beneficencia pública" — the charity limb is superseded by the Fondo General del Estado.] | At the junta approving the final balance the liquidators may pay present/represented accionistas; nominative acciones are paid to the LAST registered accionista with the register CANCELLED immediately (good-faith transferee/gravamen-holder exposure note); gravámenes handled by judicial consignment and embargoes by tribunal disposal; NO bearer limb (derogated 109_ Art. 8; FR-066 nominative-absolute by id). Sums unpayable at the session are DEPOSITED in a banking institution A LA ORDEN DEL ACCIONISTA (number indicated) within THREE DÍAS HÁBILES counted from the final-balance approval date (clock via the días-hábiles engine); FIVE YEARS unclaimed → the bank delivers them to the FONDO GENERAL DEL ESTADO (escheat — the 07_ charity destination is superseded; no bearer limb). | `sv/sources/109_Reforma_CodigoComercio_DL153_2021_Asamblea.pdf` (base print co-cited: `sv/sources/07_Codigo_Comercio.pdf`) | 109_ Arts. 7-8 (txt PAGE 2; EVID-407); 07_ Arts. 337-338 pp.62-63 (EVID-221; txt PAGE 62-63 — incisos 3-5 surviving limbs + historical) |
...
| LB-031 | Reformas al Código de Comercio (111_ = D.L. N° 905, 6-dic-2023; D.O. N° 234 T.441 13-dic-2023; vigencia Art. 11: 60 days post-publication → **11-feb-2024**), Arts. 4-6 (fusión transnacional — enablement + governing law + the new 317; operative texts riding LB-005 [annotated] and LB-006 [re-anchored]). Art. 4: "Art. 4.- Adiciónese el inciso segundo y el inciso tercero al artículo 315, de la manera siguiente:" "Una o más sociedades constituidas conforme a las leyes de la República de El Salvador, podrán fusionarse con una o más sociedades nacionales o extranjeras." "En la fusión de sociedades extranjeras con sociedades salvadoreñas, se cumplirán con las disposiciones y trámites que establezca la legislación a la que se encuentren sujetas las sociedades a fusionarse, incluyendo los relativos al proceso de toma de decisiones sobre la fusión. En lo que respecta a las sociedades salvadoreñas le será aplicable lo establecido en el presente Código." Art. 5: "Art. 5.- Adiciónese un inciso final al artículo 316, de la manera siguiente:" "Cuando tenga lugar la fusión de sociedades salvadoreñas con sociedades extranjeras, y la nueva sociedad resultante o la sociedad incorporante sea salvadoreña, el nuevo pacto social o las respectivas modificaciones al pacto social, se regirán por el presente Código y deberán ser acordes en su contenido y forma con el ordenamiento jurídico nacional." Art. 6: "Art. 6.- Sustitúyase el artículo 317, por el siguiente:" — the replaced Art. 317 text is quoted in full at LB-006 (re-anchored); LB-005 carries Art. 315 inciso 1 + Art. 316 as printed plus the Art. 4/5 additions. | The fusión-transnacional reform: SV-constituted societies may fuse with NATIONAL or FOREIGN societies (315-II, added); each participant society complies with the disposiciones y trámites of the legislation it is subject to — including its fusión decision-taking process — while salvadoreñas apply this Code (315-III, added); where the resulting/incorporating society is SALVADOREÑA, its new pacto social (or modifications) is governed by this Code and must be accordant in content and form with the national ordenamiento jurídico (316 final inciso, added); Art. 317 replaced wholesale (LB-006). Effective 11-feb-2024. | `sv/sources/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf` | 111_ Arts. 4-6 (txt PAGE 10; EVID-409) |
| LB-032 | Reformas al Código de Comercio (111_), Art. 7 (Art. 319 as REPLACED — full verbatim, OPERATIVE from 11-feb-2024): "Art. 7.- Sustitúyase el artículo 319, por el siguiente:" "Art. 319.- Los designados por las sociedades en proceso de fusión redactarán el nuevo pacto social, o bien, las modificaciones necesarias en el pacto social de la absorbente, mismos que deberán ser aprobados por los socios o accionistas de las sociedades correspondientes de conformidad con los requisitos exigidos para el acuerdo de fusión." "La ejecución de la fusión corresponderá a quienes especialmente sean designados y en defecto de designación, a los administradores de las sociedades que van a fusionarse." "Con excepción de las sociedades por acciones simplificadas, la fusión se hará constar en escritura matriz; y, el testimonio de la misma se inscribirá en el Registro de Comercio, surtiendo efectos a partir de su fecha de inscripción." "En el caso de fusiones entre sociedades salvadoreñas y sociedades extranjeras, será responsabilidad del notario autorizante, relacionar la documentación correspondiente de las sociedades extranjeras a fusionarse donde conste que estas han dado cumplimiento a la legislación aplicable a la fusión de sociedades en su país de origen." "Cuando la sociedad absorbente, o la nueva resultante de la absorción sea una sociedad por acciones simplificada, se deberá completar el respectivo formulario que contendrá el nuevo pacto social o las modificaciones necesarias en el pacto social y será el que se presente a inscripción al Registro de Comercio. Será responsabilidad del suscriptor del formulario hacer constar que las sociedades a fusionarse hayan dado previo cumplimiento a la legislación aplicable a la fusión de sociedades en su país de origen." "Para efectos de inscripción, el notario público o el suscriptor del formulario, deberán comprobar ante el Registrador que se cuenta con la aprobación o resolución respectiva de la Superintendencia de Competencia cuando la misma fuese requerida, o bien, declarar que las mismas no deben ser obtenidas, quienes serán responsables administrativamente de la veracidad de la información incorporada y de cualquier perjuicio causado en su defecto." "Hecha la inscripción, la personería jurídica de las sociedades integradas o absorbidas quedará extinguida." "Las sociedades salvadoreñas que hayan participado en procesos de fusión, teniendo como resultado su incorporación a una sociedad extranjera, o bien, el surgimiento de una nueva sociedad sujeta a la legislación de un país extranjero, deberán proceder a solicitar la cancelación de su registro en el Registro de Comercio de la República de El Salvador. Para tales efectos, el solicitante deberá adjuntar a la solicitud, la documentación extendida por autoridad competente que compruebe que la fusión ha sido inscrita en el país extranjero. El registrador hará constar en el asiento de cancelación el hecho de que ésta procede como resultado de una fusión. Asimismo, hará constar el número de registro o inscripción, la razón social o denominación y la forma jurídica que tenga la sociedad absorbente o resultante de la fusión en el país extranjero." "De no solicitar la sociedad salvadoreña la cancelación de su registro en el Registro de Comercio, continuará vigente su personería jurídica y en consecuencia, subsistirán sus obligaciones de comerciante, de conformidad con lo establecido en el presente Código." | The replaced Art. 319 in full: designados draft; approval per merger-agreement requisites; execution by designees/administrators; escritura matriz EXCEPT SAS (formulario instead); testimonio inscribed, effects from inscription date; cross-border notary relation duty (foreign home-law compliance documentation); SAS-absorbente/resultante formulario route with suscriptor responsibility for home-law compliance; notary/suscriptor comprobar-or-declarar before the Registrador on the Superintendencia de Competencia approval/resolución, with administrative responsibility for veracity; personality of integrated/absorbed societies extinguished AT inscription; absorbed-abroad cancellation duty with foreign-authority inscription proof and the cancellation-asiento data (foreign registry number, razón social o denominación, forma jurídica); failure to cancel → personality continues in force and merchant obligations subsist. | `sv/sources/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf` | 111_ Art. 7 (txt PAGE 10-11; EVID-409) |
| LB-033 | Reformas al Código de Comercio (111_), Art. 8 (Art. 358 inciso 1 replaced + incisos 4-5 added — OPERATIVE from 11-feb-2024) + Reformas al Código de Comercio (109_ = D.L. N° 153, 14-sep-2021; D.O. N° 185 T.432 29-sep-2021, effective 7-oct-2021), Arts. 7-8 (Art. 338 replaced; Art. 337 inciso 4 derogated). 111_ Art. 8: "Art. 8.- Sustitúyase el inciso primero y adiciónese el inciso cuarto y el inciso quinto al artículo 358, de la manera siguiente:" "Art. 358.- Las sociedades extranjeras podrán realizar actos de comercio en El Salvador, fijando domicilio en el país o estableciendo sucursales, siempre que la legislación de su país de origen no lo prohíba, y deberán registrarse en el Registro de Comercio." "Además, la sociedad extranjera que desee fijar su domicilio en la República de El Salvador, conservará la continuidad de su personalidad jurídica y deberá presentar para inscripción el testimonio de la escritura matriz, otorgada ante notario salvadoreño, de la adecuación de su pacto social, donde se hará constar las cláusulas que correspondan a la clase de sociedad que desea asumir, de conformidad con el presente Código, solicitando al Registro de Comercio la inscripción de la fijación del nuevo domicilio." "Será responsabilidad del notario autorizante de la escritura matriz o el suscriptor del formulario, relacionar la documentación en la que conste que la sociedad extranjera ha dado cumplimiento a la legislación de su país de origen aplicable al cambio de domicilio." [The 07_-printed Art. 358 incisos 2-3 — the solicitud + documents a-e + protest of submission (LB-028) — SURVIVE untouched; the printed inciso 1 "Las sociedades extranjeras que deseen realizar actos de comercio…" is superseded.] 109_ Art. 7 (Art. 338 REPLACED — OPERATIVE from 7-oct-2021; FULL VERBATIM at LB-018: sums unpayable at the balance-approving session deposit in a banking institution a la orden del accionista, número indicated, within TRES DÍAS HÁBILES counted from the final-balance approval date; FIVE YEARS unclaimed → the bank delivers them to the Fondo General del Estado). 109_ Art. 8 (DEROGATORIAS): "Art. 8. Deróguense el inciso segundo del Art. 134; el inciso final del Art. 154; el romano IV del Art. 155; el inciso segundo del Art. 219 y el inciso cuarto del Art. 337." | Art. 358 as reformed: foreign societies MAY perform acts of commerce in El Salvador — fixing domicile or establishing sucursales — PROVIDED home-country legislation does not prohibit it (home-law-permission gate), and must register in the Registro de Comercio; the foreign society fixing SV domicile CONSERVES THE CONTINUITY of its legal personality (no new personality) and presents for inscription the testimonio of the adecuación escritura matriz (granted before a salvadoreño notary) stating the clauses of the sociedad class it wishes to assume under this Code, requesting the inscription of the new-domicile fixing (inciso 4); the notary of the escritura matriz (or the formulario's suscriptor) must relate the documentation showing home-law compliance for the domicile change (inciso 5). 109_: the new Art. 338 (3-días-hábiles bank deposit a la orden del accionista; 5 years unclaimed → Fondo General del Estado) and the Art. 337 inciso-4 bearer-limb derogation — full operative reading at LB-018. | `sv/sources/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf` + `sv/sources/109_Reforma_CodigoComercio_DL153_2021_Asamblea.pdf` (base print co-cited: `sv/sources/07_Codigo_Comercio.pdf`) | 111_ Art. 8 (txt PAGE 11; EVID-409); 109_ Arts. 7-8 (txt PAGE 2; EVID-407); 07_ Arts. 358-359 pp.67-68 + 337-338 pp.62-63 (EVID-222/221; txt PAGE 67-68, 62-63 — surviving incisos + historical) |
...
- **SV-CML-FR-077:** The system shall model the Art. 315-317 fusión
  pipeline (317 as REPLACED by 111_ Art. 6 — LB-006 re-anchored):
  fusión takes the forms INTEGRATION (two or more societies
  ...
  deleted); the agreement is taken by EACH salvadoreña society in the
  form its *pacto social* establishes (quorum per type profile,
  SV-CML-FR-063 kin) and INSCRIBED in the Registro de Comercio (single
  registry; the superseded per-domicile clause and the MARGINAL-NOTES
  duty on the escritura-social inscriptions are DROPPED — no marginal
  annotation is recorded or required for fusions effective
  11-feb-2024 onward; registry-entry kinds consumed from SV-CML-FR-013
  by id); and once registered, the agreement AND each society's LAST
  BALANCE are PUBLISHED (Art. 486 default engine consumed from
  SV-CML-FR-017 by id — the article fixes no different count);
  cross-border fusión inscription split → FR-243/FR-244; socios of
  merged societies receive participaciones or acciones in EQUIVALENT
  proportion to those held, salvo convenio (Art. 321).
  (LB-005; LB-006 [111_ re-anchored]; LB-008; EVID-221/409)
- **SV-CML-FR-078:** The system shall compute and gate the Art. 318/320
  ...
  (LB-007; EVID-221)
- **SV-CML-FR-079:** The system shall implement the Art. 319 execution
  and personality regime as REPLACED by 111_ Art. 7 (LB-008/LB-032):
  the DESIGNADOS of the societies in process of fusión draft the new
  *pacto social* or the absorbente's modifications, approved by the
  socios/accionistas with the SAME requisites as the merger agreement;
  execution by the specially designated (or the administrators failing
  designation); the fusión is recorded in an ESCRITURA MATRIZ whose
  testimonio is inscribed in the Registro de Comercio, effects from the
  INSCRIPTION DATE — EXCEPT where the absorbente/resulting society is a
  SAS, where the FORMULARIO containing the new pacto/modifications is
  the instrument presented for inscription (no escritura matriz — the
  formulario chassis consumed from SV-CML-FR-225 by id; the SAS
  profile's own acts per SV-CML-FR-225..240 — incl. the UNIPERSONAL
  SAS case, SV-CML-FR-228 by id — never restated here); the
  inscription checkpoint is the NOTARY/SUSCRIPTOR comprobar-or-declarar
  duty: before the Registrador, comprobar the Superintendencia de
  Competencia approval/resolución when required, or declare that none
  must be obtained — the notary/suscriptor being administratively
  responsible for the veracity of the information (the superseded
  registry-side three-alternative verification of the 07_ print is
  DEAD; registry-side state simplified to checkpoint-recorded, with
  the Ley de Competencia thresholds/terms still NOT in corpus, OQ-002
  — no values invented); "Hecha la inscripción", the personality of
  the integrated/absorbed societies is EXTINGUISHED (the superseded
  express pre-inscription-retention clause is dropped — continuity
  flows from the extinguishment rule + FR-048's
  personality-by-inscription chassis consumed by id; presentation
  anchor SV-CML-FR-016); and the absorbed-abroad cancellation duty →
  FR-244.
  (LB-008 [111_ re-anchored]; LB-032; EVID-409)
- **SV-CML-FR-243:** The system shall enable FUSIÓN TRANSNACIONAL per
  111_ Arts. 4-5 (LB-005 [annotated]; LB-031): one or more societies
  constituted under the laws of El Salvador may fuse with one or more
  NATIONAL or FOREIGN societies (Art. 315-II — the fusion record
  carries participants of both nationalities; foreign participants as
  referenced records with their home-registry data); the GOVERNING-LAW
  SPLIT is modeled per participant (Art. 315-III): each society
  complies with the disposiciones y trámites of the legislation it is
  subject to — INCLUDING its fusión decision-taking process — while
  the salvadoreñas apply this Code (each participant row carries its
  applicable-legislation reference and decision-process flag; SV-side
  agreement mechanics per FR-077); and where the resulting new
  society or the incorporante is SALVADOREÑA, the new pacto social or
  its modifications are governed by this Code and must be ACCORDANT IN
  CONTENT AND FORM with the national ordenamiento jurídico (Art. 316
  final inciso — accord check surfaced as a validation note, the
  ordenamiento conformity itself being legal judgment).
  (LB-005 [111_ annotated]; LB-031; EVID-409)
- **SV-CML-FR-244:** The system shall implement the CROSS-BORDER
  fusión mechanics (Art. 317-II; Art. 319 as replaced — LB-006
  [re-anchored]; LB-031/LB-032): ONLY the salvadoreñas proceed to the
  INSCRIPTION of the fusión agreement in the Registro de Comercio (the
  foreign participants carry agreement evidence but NO SV inscription
  act); in salvadoreña-foreign fusions the authorizing NOTARY must
  RELATE the foreign societies' home-law compliance documentation
  (notary-relation record on the fusion; SAS route: the formulario's
  SUSCRIPTOR records the home-law compliance — FR-079 checkpoint
  surface); and the ABSORBED-ABROAD cancellation duty: a salvadoreña
  whose fusión resulted in incorporation into a FOREIGN society (or
  the rise of a new foreign-law society) MUST request cancellation of
  its Registro registration, attaching the foreign-authority
  documentation proving the foreign inscription — the cancellation
  asiento records that it proceeds from a fusión plus the foreign
  registry number, razón social o denominación and forma jurídica of
  the absorbente/resultante; FAILURE to request the cancellation →
  the salvadoreña's personality CONTINUES IN FORCE and its merchant
  obligations SUBSIST (state machine: absorbed-abroad-until-cancelled
  — an intermediate post-fusion state distinct from extinguished;
  matrícula/merchant-obligation surfaces keep operating while in it;
  FR-048 personality machinery consumed by id).
  (LB-006 [111_ re-anchored]; LB-031; LB-032; EVID-409)
...
- **SV-CML-FR-086:** The system shall compute the Art. 333-338/341
  distribution-and-payment mechanics (Art. 338 as REPLACED by 109_
  Art. 7 and Art. 337 inciso 4 DEROGATED — LB-018 re-anchored):
  PARTIAL distributions while the liquidation lasts, compatible with
  society and creditor interests, at pacto-modification majority,
  published like capital-reduction agreements (SV-CML-FR-017 engine
  by id) and EXECUTABLE only after the Art. 30-equivalent 30-day
  window from the third publication; the personas-society remanent
  rules (prorata distribution of divisible goods; preferential return
  of aportado-kind goods; lot formation with an 8-DÍA-HÁBIL
  modification window from the junta; silence = consent; disputed
  lots adjudicated in common under copropiedad) and the capitales
  final-balance discipline (each socio's part stated; publication +
  books/papers at accionistas' disposal; 15-DAY claims window from
  the LAST publication; definitive junta approval presided by a
  liquidator); PAYMENTS at the approving junta to present/
  ...
  the BEARER-ACCIÓN payment limbs are DEAD (Art. 337 inciso 4
  derogated by 109_ Art. 8; the nominative-absolute regime of
  SV-CML-FR-066 consumed by id — no bearer route exists anywhere in
  the payment surface); sums unpayable at the session DEPOSITED in a
  banking institution A LA ORDEN DEL ACCIONISTA (número indicated)
  within THREE DÍAS HÁBILES of final-balance approval (clock computed
  via the días-hábiles engine consumed from the fiscal calendar
  engine), and FIVE YEARS unclaimed → the bank delivers them to the
  FONDO GENERAL DEL ESTADO (escheat payee — the superseded
  centro-de-beneficencia charity limb is dropped; the lapse tracked
  with the Fondo-General payee recorded on the deposit); and the
  Art. 341 express route — a personas society with ALL socios
  agreeing, debts first cancelled, may grant the liquidation
  escritura at once by unanimous concurrence.
  (LB-015; LB-016; LB-017; LB-018 [re-anchored]; LB-021; EVID-221/407)
...
- **SV-CML-FR-097:** The system shall implement the Art. 358-361
  foreign-society registration package (Art. 358 inciso 1 as REPLACED
  by 111_ Art. 8 — LB-033): foreign societies MAY perform acts of
  commerce in El Salvador — fixing DOMICILE or establishing
  SUCURSALES — provided the legislation of their country of origin
  DOES NOT PROHIBIT it (home-law-permission gate recorded on the
  application; the permissibility itself is legal judgment — surfaced,
  never adjudicated), and register in the Registro de Comercio by
  solicitud of the
  ...
  (Art. 361). The DOMICILE-FIXING route of the reformed Art. 358
  (personality continuity + adecuación escritura matriz + the
  notary/suscriptor home-law relation duty) is FR-245 immediately
  below; the sucursal limbs of this FR are UNCHANGED by 111_.
  (LB-028; LB-029; LB-033; EVID-222/409)
- **SV-CML-FR-245:** The system shall implement the foreign-society
  SV-DOMICILE-FIXING route per Art. 358 as reformed by 111_ Art. 8
  (LB-033): the foreign society desiring to fix its domicile in El
  Salvador CONSERVES THE CONTINUITY OF ITS LEGAL PERSONALITY (no new
  personality is created — the SV registration record links to, never
  forks from, the home-law entity; FR-048's personality machinery
  consumed by id for the SV-surface reading); it presents for
  inscription the TESTIMONIO of the ADECUACIÓN ESCRITURA MATRIZ,
  granted before a SALVADOREÑO NOTARY, of the adecuación of its pacto
  social — the deed stating the clauses corresponding to the clase de
  sociedad it wishes to assume under this Code (class-clause checklist
  per the FR-046 kin, type-profile consumed by id) — REQUESTING from
  the Registro de Comercio the inscription of the new-domicile fixing
  (domicile_fixing route on the foreign.registration record:
  adecuación-deed reference + assumed-class reference + inscription
  request, distinct from the sucursal route of FR-097); and the
  NOTARY of the escritura matriz (or the formulario's SUSCRIPTOR)
  must RELATE the documentation showing the society's compliance with
  its country-of-origin legislation applicable to the CHANGE OF
  DOMICILE (notary/suscriptor relation record — the same
  relation-duty surface as the cross-border fusión checkpoint of
  FR-079/FR-244).
  (LB-033; EVID-409)
...
| l10n_sv_commerce.fusion | agreement/inscription state · publications | state · one2many (FR-017 engine) | per-society agreement per pacto social + Registro de Comercio inscription (new 317 — marginal-notes duty DROPPED as superseded 111_); publication of agreement + last balance; 90-day opposition clock from last D.O. publication | FR-077, FR-078 |
| l10n_sv_commerce.fusion | competencia_check · escritura_ref · executed_on | select · ref · date | sc_approval_verified · declared_not_required (new 319: notary/suscriptor comprobar-or-declarar; Ley de Competencia values = OQ-002 config-gaps); escritura matriz EXCEPT SAS → formulario (FR-225 chassis by id); personality extinguished at inscription | FR-079 |
| l10n_sv_commerce.fusion | foreign_participants · governing_law_split · sv_inscription_only | boolean/refs · per-participant selection · rule | cross-border fusión (315-II/III): participants national or foreign; each society's applicable legislation incl. its decision process, salvadoreñas per CC; salvadoreña result → pacto per CC + ordenamiento accord (316-final) | FR-243 |
| l10n_sv_commerce.fusion | cancellation_duty_state · foreign_inscription_proof · asiento_data | state · ref · fields | absorbed-abroad SV society MUST request Registro cancellation (foreign-authority inscription proof attached); asiento records foreign registry number, razón social, forma jurídica; failure → personality + merchant obligations persist (absorbed-abroad-until-cancelled; only salvadoreñas inscribe, 317-II) | FR-244 |
...
| l10n_sv_commerce.liquidation.payment | accionista_ref · action_kind · route · bank_deposit_ref | partner · select · select · ref | nominative_last_registered (register cancelled) · gravamen_consignation · embargo_tribunal (bearer_against_title RETIRED — Art. 337-4 derogated 109_ Art. 8; FR-066 by id); unpayable sums deposited ≤ 3 días hábiles from approval (días-hábiles engine); 5-year unclaimed → Fondo General del Estado payee (Art. 338 as replaced) | FR-086 |
...
| l10n_sv_commerce.foreign.registration | home_law_permission_gate · route | flag · select | sucursal · domicile_fixing (Art. 358-1 as replaced, 111_): acts of commerce permitted unless home law prohibits — gate surfaced, never adjudicated | FR-097 |
| l10n_sv_commerce.foreign.registration | personality_continuity · adecuacion_escritura_ref · assumed_class_ref · home_law_relation | flag · ref · ref (FR-046 kin) · record | domicile-fixing CONSERVES personality (continuity, no new entity); adecuación escritura matriz before salvadoreño notary stating the CC-class clauses; inscription request of the domicile fixing; notary/suscriptor home-law-compliance relation duty (Art. 358 incisos 4-5) | FR-245 |
...
| FR-077 | odoo | l10n_sv_commerce.fusion + registry.entry (FR-013) + publication (FR-017) | form, inscriptions | Universal-succession continuity (supersede, never delete); agreement per pacto social + Registro inscription (new 317, 111_ — marginal notes dropped); agreement + last balance published (486 default) |
...
| FR-079 | odoo | l10n_sv_commerce.fusion + registry.entry | competencia_check, escritura_matriz/formulario | New 319 (111_): escritura matriz EXCEPT SAS → formulario (FR-225 chassis); notary/suscriptor comprobar-or-declarar states (OQ-002 config-gaps); personality extinguished at inscription (FR-048 kin; anchor FR-016) |
| FR-243 | odoo | l10n_sv_commerce.fusion | foreign_participants, governing_law_split | Cross-border enablement (315-II/III); per-participant applicable legislation incl. decision process; salvadoreña result pacto per CC + national ordenamiento accord (316-final) |
| FR-244 | odoo | l10n_sv_commerce.fusion + registry.entry | sv_inscription_only, cancellation_duty_state | Only salvadoreñas inscribe (317-II); absorbed-abroad cancellation duty with foreign proof + asiento data; failure → absorbed-abroad-until-cancelled (personality/merchant obligations persist) |
...
| FR-097 | odoo | l10n_sv_commerce.foreign.registration + res.company | package checklist, MINEC-first gate, home-law gate | Art. 358 a-e + protest (incisos 2-3 as printed survive 111_); home-law-permission gate (new inciso 1); registro único via FR-008 by id; sucursal domicile = principal office; capital changes MINEC→Registro ordering gate; MINEC interface = OQ-004 |
| FR-245 | odoo | l10n_sv_commerce.foreign.registration | domicile_fixing route | Personality continuity (no new entity); adecuación escritura matriz (salvadoreño notary) with CC-class clauses + inscription request of the domicile fixing; notary/suscriptor home-law relation duty (Art. 358-4/5) |
...
10 years, 5 years) are statutory code constants with provenance — the
Art. 338 3-días-hábiles deposit clock and 5-year escheat lapse are now
109_-anchored (LB-018/LB-033, Fondo General del Estado payee), the rest
un-reformed 07_ text under the SOQ-22 residual watch — stored as code
constants, and the
...
- **AC-006:** Given a fusión whose escritura-matriz testimonio (or SAS
  formulario) is presented but NOT yet inscribed, when the personality
  states are evaluated, then the merging societies' records show no
  extinguishment yet (Art. 319 as replaced; FR-048 kin); upon recording
  the inscription with competencia_check = sc_approval_verified (the
  notary's comprobar of the SC approval), then the merged societies'
  records turn extinguished and the successor acquires rights/obligations
  by supersede-continuity (FR-079, FR-077).
...
- **AC-016:** Given an EIRL voluntary-liquidation record, when the
  ...
  (FR-090).
- **AC-017:** Given a fusión between a salvadoreña society and a
  foreign society, when the FR-077/FR-243 inscription flow runs, then
  ONLY the salvadoreña's fusión agreement inscribes in the Registro de
  Comercio (the foreign participant carries agreement evidence but no
  SV inscription act), the governing-law split records each
  participant's applicable legislation incl. its decision process, and
  — the resulting/incorporating society being salvadoreña — the pacto
  record is flagged for CC governance + nacional-ordenamiento accord
  (FR-243, FR-244; Art. 317-II).
- **AC-018:** Given a salvadoreña society absorbed into a foreign
  society (fusión inscrita abroad) that has NOT requested the
  cancellation of its Registro registration, when the FR-244 state
  machine evaluates, then the record holds the
  absorbed-abroad-until-cancelled state — personality continuing in
  force and merchant obligations subsisting (distinct from
  extinguished); given the cancellation request with the
  foreign-authority inscription proof attached, then the cancellation
  asiento records the fusión origin plus the foreign registry number,
  razón social o denominación and forma jurídica of the
  absorbente/resultante (FR-244).
- **AC-019:** Given a liquidation payment unpayable at the
  final-balance junta and deposited at a bank a la orden del
  accionista, when five years pass without any claim, when FR-086
  evaluates, then the deposit's unclaimed-lapse destination resolves
  to the Fondo General del Estado — never a charity/centro de
  beneficencia payee (the superseded 07_ limb), and no
  bearer/presenter route exists anywhere on the payment record
  (FR-086; FR-066 by id).
- **AC-020:** Given a fusión by absorción whose absorbente is a SAS,
  when the FR-079 execution flow runs, then the inscription instrument
  is the FORMULARIO containing the new pacto social/modifications (no
  escritura matriz is required or validated — the FR-225 chassis by
  id), and the suscriptor's home-law-compliance constancia duty +
  comprobar-or-declarar checkpoint ride the formulario record; given a
  non-SAS absorbente, then the escritura-matriz testimonio route
  applies (FR-079).
...
| OQ-002 | The Ley de Competencia is NOT in the corpus — and the 111_-replaced Art. 319 (LB-008/LB-032) has MOVED the checkpoint: the notary público or formulario suscriptor must comprobar ante el Registrador the Superintendencia de Competencia aprobación/resolución when required, or declarar that none must be obtained (administratively responsible for veracity) — the notification thresholds, the "cuando la misma fuese requerida" trigger and the resolución forms remain un-evidenced (values = config-gaps; FR-079 ships the two checkpoint states with NO values; OQ-002 keeps the 07_-era acquisition candidacy for the law itself). If ever automated (e.g. a notary/suscriptor-side warning or a required-vs-not classifier), acquire the law (SOQ-25 kin: acquisition candidate, sources-registry numbering ≥74). | no | Takumi S5 (sources watch) | open |
