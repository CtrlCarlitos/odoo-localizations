...
- **AC-005:** Given a fusión by absorción whose Art. 317 publications
  ...
  computes, then execution is eligible from 02-Jun (day after 01-Mar +
  90 days) absent opposition; given an opposition filed 15-Mar, then
...
- **AC-008:** Given a sociedad dissolved 01-Feb-2027 with a liquidation
  ...
  (the prórroga inscribes; a 7-month prórroga is accepted, a 9-month one
