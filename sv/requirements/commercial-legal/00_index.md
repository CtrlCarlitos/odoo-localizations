...
| **Total** | | SV-CML-FR-001..246 | **246** | **256** | **142** | **35** |

Numbering note: FR numbering is wave-sequential within the `SV-CML`
prefix (001-246, no gaps, no renumbering; 001-017 = C1, 018-030 = C2,
...
`../payroll/` sidecars, cited by id). W23 tails (2026-08-23): FR-225..246
