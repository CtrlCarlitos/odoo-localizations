...
| Status  | draft (W23 fold-in + W27 chapter-spine, in review) |
| Authors | Takumi synthesis wave 5 (S5 commercial-legal) + W23 T1/T2 + W27 controller |
| Updated | 2026-08-24 |
...
LB-026/LB-028 and §3.7 zone, **RE-ANCHORED in-file W23 T2**: LB-026/028
below carry the 109_ operative quotes, LB-039 adds the
Arts. 153/158/164/212 + transitorio layer, and FR-066/068 are
rewritten with FR-241..242 added — §3.7/§4)**. Census
...
directly (LB-026/028/033..038 below; txts
...
| LB-026 | Reformas al Código de Comercio (109_ = D.L. N° 153, 14-sep-2021), Art. 1 (Art. 134 inciso primero, as replaced — OPERATIVE): "Art. 134. Las acciones serán siempre nominativas." The 07_-printed incisos 3-5 SURVIVE untouched (the 109_ split: Art. 1 replaced ONLY inciso 1; Art. 8 derogated inciso 2): "Antes de la entrega de las acciones a los suscriptores, la sociedad podrá extenderles títulos provisionales representativos de las suscripciones hechas, los cuales quedarán para todos los efectos equiparados a las acciones." "Los títulos representativos a que se refiere el inciso anterior, tendrán una vigencia máxima de un año a partir de la fecha de su expedición y transcurrido el mismo, los administradores de la sociedad tendrán la obligación de canjearlos por títulos definitivos a favor de los accionistas que aparezcan inscritos como tales en el Libro de Registro respectivo." "Los administradores que contravengan la obligación del inciso precedente, serán personal y solidariamente responsables de los daños y perjuicios que se causen a los accionistas." Art. 8 (DEROGATORIAS): "Deróguense el inciso segundo del Art. 134; el inciso final del Art. 154; el romano IV del Art. 155; el inciso segundo del Art. 219 y el inciso cuarto del Art. 337." — the 07_-printed inciso 2 (post-payment bearer-title demand) is DEAD. Art. 10 (vigencia): "El presente decreto entrará en vigencia ocho días después de su publicación en el Diario Oficial." — D.O. N° 185, Tomo N° 432, 29-sep-2021 → effective **7-oct-2021**. [Provenance — 07_ historical print, superseded: inciso 1 read "Las acciones serán siempre nominativas, mientras su valor no se haya pagado totalmente." and inciso 2 read "Una vez satisfecho por completo el valor nominal de las acciones, los interesados podrán exigir que se les extiendan títulos al portador, siempre que la escritura social no lo prohíba." — retained as the pre-2021 historical text per the stale-print ruling, §2.] | OPERATIVE from 7-oct-2021: acciones are ALWAYS NOMINATIVE — absolute, with NO payment-state condition and NO escritura-permission exception. The provisional-title incisos survive: before delivering acciones to subscribers, the society may issue PROVISIONAL titles representing the subscriptions, equated for all effects to acciones; those titles have a maximum validity of ONE YEAR from issuance, after which the administrators are OBLIGED to exchange them for definitive titles in favour of the accionistas inscribed in the respective register book; administrators contravening that obligation are personally and solidarily liable for damages to the accionistas. The bearer-conversion demand (07_-printed inciso 2) is DEROGATED — no bearer-title right exists. (Historical, superseded 07_ text: nominative-while-unpaid + post-payment bearer demand.) | `sv/sources/109_Reforma_CodigoComercio_DL153_2021_Asamblea.pdf` (base print co-cited: `sv/sources/07_Codigo_Comercio.pdf`) | 109_ Arts. 1/8/10 + D.O. stamp p.4 (EVID-407; txt PAGE 1-2, 4); 07_ Art. 134 p.26 (EVID-220; txt PAGE 26 — surviving incisos + provenance) |
...
| LB-028 | Reformas al Código de Comercio (109_), Art. 3 (Art. 155 inciso primero parte primera, as substituted — OPERATIVE): "Art. 155. Las sociedades de capitales deberán llevar debidamente actualizado un registro de las acciones nominativas que emitan, que contendrá:" + new FINAL inciso added by the same Art. 3: "Estas sociedades deberán dar cumplimiento a las obligaciones de informar sobre sus accionistas y sobre la distribución de dividendos o utilidades, según lo previsto en el Art. 124 del Código Tributario." Art. 8 DEROGATES the romano IV ("La conversión de las acciones nominativas en acciones al portador.") — the registry content = ordinals I-III and V-VIII as printed in 07_: "I.- El nombre y el domicilio del accionista; la indicación de las acciones que le pertenezcan, expresándose los números, series, clases y demás particularidades. II.- Los llamamientos que se efectúen. III.- Los traspasos que se realicen. [IV.- DEROGATED per 109_ Art. 8 — nominative→bearer conversions no longer registerable.] V.- Los canjes de títulos. VI.- Los gravámenes que afecten a las acciones y los embargos que sobre ellas se trabaren. VII.- Las cancelaciones de los gravámenes y embargos. VIII.- Las cancelaciones de los títulos." Effective 7-oct-2021 (109_ Art. 10; LB-026). Art. 149 (title content, ordinals I-VII — UNCHANGED by 109_, 07_ print stands current): "Los títulos de las acciones y los certificados provisionales o definitivos, deben contener: I.- La denominación, domicilio y plazo de la sociedad. II.- La fecha de la escritura pública, el nombre del Notario que la autorizó y los datos de la inscripción en el Registro de Comercio, aunque éstos podrán omitirse en los certificados provisionales, si no se hubiere efectuado el registro. III.- El nombre del accionista, en el caso de que los títulos sean nominativos. IV.- El importe del capital social, el número total y el valor nominal de las acciones. V.- La serie y número de la acción o del certificado, con indicación del número total de acciones que corresponda a la serie. VI.- Los llamamientos que sobre el valor de la acción haya pagado el accionista, o la indicación de estar totalmente pagada. VII.- La firma de los administradores que conforme a la escritura social deban suscribir el título." [following incisos omitted — capital-change annotations required on titles: new capital amount and circulating acción count; under capital variable, the junta-agreement date/acta data; under capital fijo, the modification deed, notary and registry data — per Art. 151 exchange rules] | Capital societies must keep a DULY UPDATED (debidamente actualizado — a statutory currency duty) register of the acciones nominativas they issue, containing: I. accionista name and domicile; indication of his acciones with numbers, series, classes and other particulars; II. the llamamientos effected; III. traspasos realized; [IV. DEROGATED — nominative→bearer conversions]; V. title exchanges (canjes); VI. encumbrances (gravámenes) affecting the acciones and attachments (embargos) laid on them; VII. cancellations of encumbrances and attachments; VIII. cancellations of titles. NEW final inciso: these societies must comply with the obligations to inform about their accionistas and about the distribution of dividendos o utilidades, as provided in Art. 124 of the Código Tributario (the CT-124 tax-interface hook — FR-068/FR-242). Art. 149 unchanged: action titles and provisional/definitive certificates must contain: I. the society's denominación, domicile and term; II. the public deed's date, the authorizing Notary's name and the Commerce Registry inscription data (omissible in provisional certificates if not yet registered); III. the accionista's name for nominative titles; IV. the social capital amount, total number and nominal value of acciones; V. the acción/certificate series and number, with the series' total acción count; VI. the llamamientos the accionista has made, or the indication of being fully paid; VII. the signature of the administrators who per the escritura must subscribe the title. (Following incisos: capital-change annotations per regime, exchanged per Art. 151.) | `sv/sources/109_Reforma_CodigoComercio_DL153_2021_Asamblea.pdf` (base print co-cited: `sv/sources/07_Codigo_Comercio.pdf`) | 109_ Arts. 3/8 + D.O. stamp (EVID-407; txt PAGE 2, 4); 07_ Arts. 149, 155 pp.28-30 (EVID-220; txt PAGE 28-30 — surviving ordinals I-III/V-VIII + Art. 149) |
...
| LB-039 | Reformas al Código de Comercio (109_ = D.L. N° 153, 14-sep-2021), Arts. 2/4/5/6 + TRANSITORIO (Art. 9) — the nominative-title mechanics layer, effective 7-oct-2021 (Art. 10; LB-026). Art. 2 (Art. 153, as replaced): "Art. 153. Los títulos deberán ser siempre nominativos." Art. 4 (Art. 158 inciso segundo, as substituted): "Las acciones nominativas totalmente pagadas pueden traspasarse sin consentimiento de la sociedad, aun contra pacto expreso en contrario." [The 07_-printed Art. 158 inciso primero SURVIVES: "En la escritura social puede pactarse que el traspaso de las acciones nominativas cuyo valor no esté totalmente pagado, sólo se haga con autorización de la administración social. Esta cláusula se hará constar en el texto de los títulos."] Art. 5 (Art. 164 inciso primero, as substituted): "Art. 164. La sociedad debe considerar como accionista al titular de las acciones nominativas inscrito como tal en el registro respectivo." Art. 6 (Art. 212 inciso primero parte primera + romano IV, as substituted): "Art. 212. Los bonos de fundador serán nominativos y deberán contener:" + "IV. El nombre o razón social del titular, la participación que corresponda a bono en las utilidades y el lapso en que deba ser pagada." TRANSITORIO (Art. 9, summarized — historical/enforcement awareness): societies that at vigencia had issued acciones or bonos de fundador AL PORTADOR must convert them to nominative titles (possessor-presenters recorded as owners in the libro de registro; pacto-social modification if applicable) within ONE YEAR counted from the day following vigencia; persons distributing utilidades o dividendos to bearers within that period must inform the Administración Tributaria within THREE MONTHS of the reparto (accionista identity + amount paid); post-deadline: entities supervised by the Superintendencia del Sistema Financiero may not conduct active/passive/neutral operations whose capital is represented by bearer acciones, and the Dirección General de Impuestos Internos BLOCKS the RUC of non-converting sociedades por acciones until regularized; numeral 3 — surviving bearer portadores may neither vote in juntas de accionistas nor receive utilidades o dividendos until the acciones y bonos are debidamente asentados as nominativos and informed to the Administración Tributaria; numeral 4 — unconverted bonos de fundador al portador may not be used by their poseedores for the effects of Arts. 210, 211 inciso segundo, 213 and 215 of this Code (authority-side enforcement facts, awareness only). | Titles must ALWAYS be nominative (Art. 153 as replaced — the 07_ "nominativos o al portador" option is dead). Totally-paid nominative acciones may be transferred WITHOUT the society's consent, EVEN AGAINST EXPRESS CONTRARY PACT (Art. 158-II as substituted; the surviving inciso 1 keeps the escritura authorization gate ONLY for not-wholly-paid acciones). The society must consider as accionista the titular of the nominative acciones INSCRIBED as such in the respective register (Art. 164 as substituted — the bearer-holder alternative is dead; the ledger inscription is the identity source). Bonos de fundador are nominative, with the new numeral IV content (titular's name/razón social, per-bono participation in utilidades, payment lapse). Transitorio (historical): 1-year bearer→nominative conversion window from the 7-oct-2021 vigencia; 3-month AT-information duty for bearer-dividend payers; post-deadline SSF bar + DGII RUC-block + the numeral-3 bearer voto/utilidades bar + the numeral-4 bono-usability bar (Arts. 210/211-II/213/215) — authority-side enforcement facts, awareness only. | `sv/sources/109_Reforma_CodigoComercio_DL153_2021_Asamblea.pdf` (base print co-cited: `sv/sources/07_Codigo_Comercio.pdf`) | 109_ Arts. 2/4/5/6/9-10 + D.O. stamp (EVID-407; txt PAGE 1-4); 07_ Art. 158 p.30 (EVID-220; txt PAGE 30 — surviving inciso 1) |
| LB-040 | Reformas al Código de Comercio (111_), Art. 3 (Arts. 305-Q, 305-R — the SAS-eligibility routes; print intra-word spacing cleaned: "305 -Q" read 305-Q, "o stente" read ostente). Art. 305-Q: "Cualquier sociedad podrá adoptar el tipo de la sociedad por acciones simplificada por medio de su transformación o fusión siempre que medie aprobación de junta general o por quien el pacto social designe para tales efectos." "El acuerdo correspondiente deberá asentarse en el libro respectivo e incorporar la información del mismo en el formulario a inscribirse en el Registro de Comercio. Para el caso de la fusión, adicionalmente, se deberá dar cumplimiento a lo establecido en el artículo 317 del presente Código." "La sociedad por acciones simplificada podrá transformarse o fusionarse con cualquiera de los tipos societarios previstos en el presente Código, siempre y cuando se acuerde por la junta general de accionistas, o por quien el pacto social designe para tales efectos, con el acuerdo de las tres cuartas partes de los títulos representativos de las acciones del capital social, o en su caso, por el accionista único, debiendo cumplir con las formalidades del acto que correspondan al tipo societario al cual se transformarán o con el cual se fusionará." Art. 305-R: "En aquellos casos en que una sociedad por acciones simplificada ostente más del noventa por ciento de las acciones de otra sociedad por acciones simplificada, aquélla podrá absorber a ésta, mediante acuerdo adoptado por la junta general de accionistas o por el accionista único, según corresponda, el cual se asentará en el libro correspondiente y se relacionará en el formulario que contenga las modificaciones al pacto social de la absorbente, el cual surtirá efectos a partir de su inscripción en el Registro de Comercio." | ELIGIBILITY ROUTES: ANY sociedad, whatever its type, may ADOPT the SAS type via TRANSFORMACIÓN or FUSIÓN — approval of the junta general or of the pacto-social designee; the acuerdo is asentado in the respective libro and its information incorporated in the Registro-de-Comercio inscription formulario; the fusión route additionally complies with Art. 317 (the general fusión procedure — the 05 fusión chassis FR-077..079, consumed by id). Conversely, an SAS may TRANSFORM into or FUSE with any societario type of this Code, agreed by the junta general de accionistas or the pacto designee WITH the agreement of THREE-FOURTHS (3/4) of the títulos representing the capital acciones — or, where applicable, by the ACCIONISTA ÚNICO — with the formalities of the target/counterparty type. PARENT ABSORPTION: a parent SAS holding MORE THAN 90% of the acciones of another SAS may ABSORB it (simplified fusión): acuerdo of the junta general de accionistas or the accionista único as applicable, asentado in the respective libro and related in the formulario containing the modifications to the ABSORBENTE's pacto social, effective upon its Registro-de-Comercio INSCRIPTION | `sv/sources/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf` | 111_ Art. 3 (305-Q txt PAGE 7; 305-R txt PAGE 8; EVID-409) |
| LB-041 | Reformas al Código de Comercio (111_), Art. 3 (Art. 305-C — the accionista-not-employee invariant; print article-number spacing "305 -C" read 305-C, per the LB-040 discipline). "Art. 305-C.- El accionista único o los accionistas en ninguna circunstancia podrán ser considerados como empleados o trabajadores de la sociedad, excepto que la sociedad celebre un contrato laboral con éstos en donde tal circunstancia y condiciones consten por escrito." | HR-INTERFACE GUARD: the accionista único / the accionistas can in NO circumstance be considered empleados o trabajadores of the SAS — EXCEPT where the society celebrates a CONTRATO LABORAL with them in which that circumstance and its conditions are recorded IN WRITING. The accionista↛employee separation is STATUTORY, not configurative: share ownership never derives an employment relationship; the only activation path is the written contrato laboral (FR-247's gate; payroll-side consumption by id) | `sv/sources/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf` | 111_ Art. 3 (305-C txt PAGE 5; EVID-409) |
| LB-042 | Reformas al Código de Comercio (111_), Art. 3 (Art. 305-I — the documentary-proof interface). "Art. 305-I.- La existencia de la sociedad por acciones simplificada, su constitución y todos los actos societarios se probarán con el documento que acredite la respectiva inscripción, emitido por el Registro de Comercio." | The SAS's EXISTENCE, its CONSTITUTION and ALL its social acts are proven with the document accrediting the respective INSCRIPTION, issued by the REGISTRO DE COMERCIO — the Registro-issued inscription certificate is THE proof artifact for the SAS (the society has no escritura pública, LB-034/FR-225; this row supplies the documentary-proof class the escritura otherwise provides — FR-248) | `sv/sources/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf` | 111_ Art. 3 (305-I txt PAGE 5; EVID-409) |
| LB-043 | Reformas al Código de Comercio (111_), Art. 3 (Art. 305-T — the intra-societary dispute-resolution clause; awareness only). "Art. 305-T.- Las diferencias que ocurran entre los accionistas, los accionistas y la sociedad o sus administradores o liquidadores, y la sociedad y sus administradores o liquidadores, deberán ser resueltas por medio de arreglo directo o arbitraje, de conformidad a lo establecido en el pacto social." "Mediante el arreglo directo, cada parte en conflicto nombrará un mediador independiente, quienes a su vez nombrarán a un tercero de común acuerdo, quien será el mediador presidente." "En caso de no llegarse a un acuerdo amistoso, las diferencias mencionadas en el inciso anterior podrán someterse a decisión arbitral, si así se pacta." "En caso de no optar por los medios alternos, podrán someterse a los tribunales judiciales correspondientes del domicilio de la sociedad." | Differences among accionistas, between accionistas and the society or its administradores/liquidadores, and between the society and its administradores/liquidadores, MUST be resolved by ARREGLO DIRECTO or ARBITRAJE as the pacto social establishes. Arreglo directo mechanics: each party appoints an independent mediador; the mediadores jointly name a third who presides. absent amicable agreement, ARBITRAL decision applies only si así se pacta; failing election of the alternative means, the judicial courts of the society's DOMICILIO apply. Pacto-social CONTENT GUIDANCE + awareness gloss only — NO Odoo enforcement surface (recorded to complete the 305-A..Z chapter spine) | `sv/sources/111_Reforma_CodigoComercio_DL905_2023_Asamblea.pdf` | 111_ Art. 3 (305-T txt PAGE 8; EVID-409) |
...
- **SV-CML-FR-066:** The system shall enforce the S.A. nominative
  regime as ABSOLUTE per Art. 134 (as replaced by 109_ D.L. 153-2021,
  effective 7-oct-2021 — LB-026 re-anchored): acciones are ALWAYS
  NOMINATIVE, with NO payment-state condition and NO
  escritura-permission exception (the 07_-printed
  nominative-while-unpaid rule was replaced and the post-payment
  bearer-title demand DEROGATED — both dead); the bearer-conversion
  gate is REMOVED ENTIRELY from the data model and UI (no bearer
  title kind, no conversion flow, no escritura-permission slot — any
  bearer-title creation attempt dated after 7-oct-2021 is BLOCKED
  with the Art. 134 reason "Las acciones serán siempre nominativas.");
  and the provisional-title machinery SURVIVES (incisos 3-5 as
  printed): provisional titles issued before delivery are equated to
  acciones, valid for at most ONE YEAR from issuance, after which
  ...
  (LB-026 [109_ re-anchored]; EVID-407/220)
...
- **SV-CML-FR-068:** The system shall implement the S.A. share
  register with the Art. 155 content as amended by 109_ (LB-028
  re-anchored) = SEVEN kinds: (I) accionista name and domicile + his
  acciones' numbers, series, classes and other particulars; (II)
  llamamientos effected; (III) traspasos realized; (V) title canjes;
  (VI) gravámenes affecting the acciones and embargos laid on them;
  (VII) cancellations of gravámenes/embargos; (VIII) cancellations of
  titles — numeral IV (nominative→bearer conversions) is DEROGATED
  (109_ Art. 8) and ABSENT from the ledger kinds (the §4 catalog
  retires the value); the registry must be kept DEBIDAMENTE ACTUALIZADO
  (the substituted inciso primero makes currency a statutory duty —
  the ledger posts movements as they occur, never as a batch
  reconstruction); the ledger (not the certificate) is the S.A.
  register of record; and the NEW final inciso mounts the CT Art. 124
  information duty (accionistas + distribución de dividendos o
  utilidades) as a TAX-INTERFACE POINTER on the registro and the
  distribution records — the duty's filing mechanics are
  taxation-owned (SV-TAX-FR-132..149 zone, consumed by id there;
  never restated here — FR-242). The Art. 149 title-content profile
  (7 ordinals, unchanged by 109_: denominación/domicilio/plazo; deed
  date/notary/registry data; accionista name for nominative;
  capital/total acciones/nominal value; serie+número with series
  count; llamamientos paid or fully-paid indication; signatures)
  governs title/certificate rendering, including the capital-change
  annotation incisos (new capital + circulating count;
  regime-specific deed/junta data) applied via Art. 151 exchange
  rules — exchange, never overwrite (no-alteration kin, SV-CML-FR-024
  by id).
  (LB-028 [109_ re-anchored]; EVID-407/220)
...
(Tail scope note: FR-241..242 (acciones re-anchors), FR-246
(305-Q/R eligibility routes) and FR-247..248 (305-C/I chapter-spine
additions, W27) are wave-contiguous additions living at
this section's tail by numbering contiguity, not by topic; FR-066/068
own the base acciones regime.)
...
- **SV-CML-FR-241:** The system shall implement the nominative-title
  mechanics per 109_ (LB-039): títulos are ALWAYS NOMINATIVE
  ("Los títulos deberán ser siempre nominativos." — Art. 153 as
  replaced: the share.title object carries a NOMINATIVE-ONLY profile,
  no bearer kind exists anywhere in the title surface); totally-paid
  acciones nominativas are traspasable WITHOUT the society's consent,
  EVEN AGAINST EXPRESS CONTRARY PACT (Art. 158 inciso segundo as
  substituted — the share-ledger traspaso flow carries NO consent gate
  for paid acciones; an escritura consent clause is unenforceable in
  the flow and recorded as informational only — while the SURVIVING
  inciso 1 keeps the escritura authorization gate for
  NOT-wholly-paid acciones as the only consent surface); and the
  society considers accionista the TITULAR INSCRITO in the respective
  registro (Art. 164 as substituted — the ledger inscription is the
  identity source of record: voting, dividend and notice rights key
  to the REGISTERED titular, never to physical possession — the
  register-of-record character of FR-068's ledger sharpened).
  (LB-039; EVID-407)
- **SV-CML-FR-242:** The system shall expose the CT Art. 124
  shareholder/dividend information-duty INTERFACE (109_ Art. 3 final
  inciso riding LB-028's re-anchored Art. 155 + the Art. 9
  transitorio): capital societies' registro de acciones nominativas
  and their dividend/utilidad distributions FEED the Código
  Tributario Art. 124 reporting duty on accionistas and on the
  distribución de dividendos o utilidades — the interface POINTER
  only (registro + distribution records carried as the data source,
  exportable to the taxation surface); the duty's filing mechanics
  are TAXATION-OWNED (SV-TAX-FR-132..149 zone, consumed by id there —
  no restatement here); and the transitorio enforcement surface (the
  1-year bearer→nominative conversion window that ran from the
  7-oct-2021 vigencia; the bearer-dividend payers' 3-month
  AT-information duty; the post-deadline DGII RUC-block + SSF
  supervised-entity bar) is AWARENESS GLOSS ONLY — historical/
  enforcement context with NO Odoo enforcement mechanics (the RUC
  block and the SSF bar are authority-side acts, never system
  gates).
  (LB-039; LB-028 [final inciso]; EVID-407)
- **SV-CML-FR-246:** The system shall encode the Art. 305-Q/305-R
  SAS-eligibility routes: (a) ANY sociedad may adopt the SAS type
  (transformación into SAS) per the 305-Q approval quorums (junta
  general or pacto-designee; where an SAS transforms into another
  type, 3/4 of títulos) — consuming the transformación chassis of
  SV-CML-FR-080..082 by id, formulario formality per FR-225; (b)
  fusión-into-SAS / parent-SAS absorption: a parent SAS holding >90%
  of another sociedad's acciones (305-R print: of otra sociedad por
  acciones simplificada) may absorb it via the SIMPLIFIED formulario
  route per 305-R — consuming the fusión chassis of SV-CML-FR-077..079
  by id with the FR-225 formulario exception; no new mechanics
  restated. (LB-040; EVID-409)
- **SV-CML-FR-247:** The system shall encode the Art. 305-C
  accionista-not-employee invariant on the SAS profile: an accionista
  (including the accionista único) is NEVER treated as an
  empleado/trabajador of the society by default — no employment record,
  payroll linkage or employee-derived flag derives from share
  ownership; the ONLY activation path is a recorded CONTRATO LABORAL
  with the society in which that circumstance and its conditions
  consta por escrito (an attachable written-contract record gates any
  accionista→employee link; the payroll surfaces consume this by id —
  no payroll mechanics restated here).
  (LB-041; EVID-409)
- **SV-CML-FR-248:** The system shall require, for every SAS
  proof-of-existence, constitution or social-act evidentiary need, the
  REGISTRO-DE-COMERCIO-ISSUED INSCRIPTION DOCUMENT as the valid proof
  artifact (305-I): the inscription-certificate document class on the
  society record — the SAS has NO escritura pública (FR-225), and this
  row supplies the documentary-proof interface the escritura class
  otherwise provides for the other types.
  (LB-042; EVID-409)
...
| l10n_sv_commerce.share.register.entry | accionista_ref · action numbers/series/classes | partner · ints/chars | Art. 155-I; registry kept debidamente actualizado (109_) — movements post as they occur | FR-068 |
| l10n_sv_commerce.share.register.entry | entry_kind | select | llamamientos · traspasos · canjes · gravamenes_embargos · gravamen_cancellations · title_cancellations (Art. 155 II-III, V-VIII per 109_ — SEVEN kinds; numeral IV nominative→bearer DEROGATED). `nominative_to_bearer` RETIRED from the catalog W23 (migration: the value leaves the selection/handlers; historical rows bearing it become read-only per D15) | FR-066, FR-068 |
| l10n_sv_commerce.share.title | art149_content_profile · nominative_only | computed checklist · boolean (always true) | 7 ordinals + capital-change annotations (Art. 149, unchanged by 109_); exchange-per-151, never overwrite; titles ALWAYS nominative (Art. 153 per 109_) — no bearer kind in the profile; bearer-title creation post-7-oct-2021 blocked with the Art. 134 reason | FR-066, FR-068, FR-241 |
| l10n_sv_commerce.share.holding | holder_kind · own_share_exception · resale_deadline · traspaso_consent_free | select · select · date · computed flag | society_own (only remate/adjudicación judicial; 3-month resale clock; no assembly representation) · socio (default) — loan/advance-on-own-shares blocked outright; traspaso_consent_free = true when acciones totally paid (Art. 158-II per 109_ — NO consent gate on the ledger traspaso flow for paid acciones, even contra pacto; consent surface survives only for not-wholly-paid acciones via escritura pact, informational) | FR-067, FR-241 |
...
**SAS profile additions (111_ Capítulo VIII-Bis; FR-044 flip + FR-225..240 + FR-246):**
...
| l10n_sv_commerce.transformacion / l10n_sv_commerce.fusion (sas eligibility fields) | sas_route flags · exit quorum · parent_threshold | flag · fraction · percent | 305-Q: adoptable_into_sas = true for ANY sociedad (junta general or pacto-designee approval; SAS into another type = 3/4 of títulos, or accionista único); 305-R: parent SAS holding >90% of the acciones (of otra sociedad por acciones simplificada, as printed) → simplified absorption formulario, effective at Registro inscription — chassis consumed from `05` by id (FR-080..082 / FR-077..079), formality per FR-225 | FR-246 |
...
| FR-066 | odoo | l10n_sv_commerce.share | nominative invariant | ALWAYS nominative — ABSOLUTE per Art. 134 as replaced by 109_ (from 7-oct-2021; LB-026 re-anchored); no payment-state condition, no escritura exception; bearer-conversion machinery REMOVED entirely (no bearer kind/flow; creation attempt post-7-oct-2021 blocked with the Art. 134 reason); provisional-title ≤1y + exchange clock SURVIVES (incisos 3-5) |
...
| FR-068 | odoo | l10n_sv_commerce.share.register.entry + share.title | Art. 155 ledger (7 kinds per 109_) | Numeral IV nominative→bearer DEROGATED — SEVEN kinds; debidamente actualizado currency duty; ledger = register of record; CT-124 information-duty hook = tax-interface pointer (SV-TAX-FR-132..149 by id, FR-242); Art. 149 title profile + capital-change annotations exchanged per Art. 151 (no-alteration kin SV-CML-FR-024 by id) |
...
| FR-241 | odoo | l10n_sv_commerce.share.title + share.holding + share.register.entry | nominative-only titles · no-consent traspaso · registered titular | Art. 153 per 109_: títulos ALWAYS nominative (nominative_only profile, no bearer kind); Art. 158-II: totally-paid acciones traspaso WITHOUT consent even contra pacto (traspaso_consent_free — NO consent gate in the ledger flow; escritura gate survives only for unpaid acciones, informational); Art. 164: the INSCRIBED titular is the accionista of record (LB-039) |
| FR-242 | odoo | l10n_sv_commerce.share.register.entry + dividend.distribution | CT-124 interface pointer | Registro + distributions FEED the CT Art. 124 accionistas/dividendos reporting duty — filing mechanics taxation-owned (SV-TAX-FR-132..149 by id, no restatement); RUC-block + SSF bar + conversion transitorio = awareness gloss only (authority-side; no Odoo enforcement mechanics) |
| FR-246 | odoo | l10n_sv_commerce.transformacion/fusion eligibility fields | sas_route flags · 3/4 quorum · >90% parent threshold | 305-Q: any sociedad → SAS via transformación/fusión (junta general or pacto-designee; SAS → otro tipo = 3/4 of títulos, or accionista único); 305-R: >90% parent-SAS absorption via the simplified formulario — FR-080..082 / FR-077..079 chassis consumed by id, formality per FR-225 (LB-040) |
| FR-247 | odoo | l10n_sv_commerce.share.holding (+ hr-link gate) | accionista_not_employee | 305-C: accionistas NEVER empleados/trabajadores absent a WRITTEN contrato laboral recorded (LB-041) — no employment derives from ownership; payroll consumes by id |
| FR-248 | odoo | l10n_sv_commerce.company proof-document class | inscription_certificate | 305-I: the Registro-issued inscription document = proof of existence/constitution/ALL social acts (LB-042); escritura N/A per FR-225 |
...
- **AC-019:** Given a fully-paid acción whose traspaso is recorded in
  the share ledger WITHOUT any society-consent record — even with an
  express contrary escritura pact on file — when the FR-241 flow
  posts, then the traspaso entry posts with NO consent gate (the
  Art. 158-II reason; the pact clause renders informational only);
  given any bearer-title creation attempt (a bearer title kind or a
  nominative→bearer conversion) dated after 7-oct-2021, when the
  FR-066 guard runs, then it is BLOCKED with the Art. 134 reason
  ("Las acciones serán siempre nominativas.") and the
  `nominative_to_bearer` catalog value is absent from new-entry
  selection (FR-066, FR-241).
- **AC-020:** Given a parent SAS holding 95% of another SAS's acciones
  absorbing that subsidiary, when the FR-246 route selection runs,
  then the SIMPLIFIED formulario absorption applies (305-R: junta
  general or accionista único acuerdo, asentado in the libro,
  related in the absorbente's pacto-modification formulario,
  effective at Registro inscription — FR-077..079 chassis by id);
  given an SAS transforming into an S.A., when the transformación
  agreement is validated, then the 3/4-títulos quorum gate applies
  (305-Q: junta general or pacto-designee with the agreement of the
  three-fourths of the títulos of the capital — or the accionista
   único, with the target type's formalities — FR-080..082 chassis by
   id; formality per FR-225) (FR-246).
- **AC-021:** Given an SAS accionista (or the accionista único) with
  no recorded contrato laboral, when any accionista→employee linkage
  or payroll import is attempted, then NO employment relationship is
  created and the 305-C reason surfaces (accionista not
  empleado/trabajador — written-contract exception only); given a
  written contrato laboral recorded against the society for that
  accionista, then the employment link activates with the contract's
  recorded conditions (FR-247).
- **AC-022:** Given an SAS whose documentary proof is requested at any
  evidentiary surface (constitution verification, social-act
  inspection), then the accepted artifact is the
  REGISTRO-ISSUED INSCRIPTION CERTIFICATE (305-I) — an escritura
  pública is neither required nor validated for SAS lifecycle acts
  (FR-225; FR-248).
