...
- **SV-CML-FR-194:** The system shall expose the transitory ADAPTATION
  ...
  the kept instruments remain the operative layer).
  (LB-030; EVID-246)
...
- **SV-CML-FR-209:** The system shall implement the OFFICER NOTICE
  ...
  UIF and the routed supervisors (71_ Art. 9.8 — law level; 72_ Art. 7 m)
...
|----|----------|-----------|-------|--------|
| OQ-001 | New AML Reglamento + new UIF instructivo PENDING (71_/72_ OQ-1 chain, R28): Art. 61 keeps D.E. 2-2000 + Acuerdo 380 until they issue, and Art. 56's own deadlines (instructivos ≈Apr-2026; technical norms ≈Jul-2026; Reglamento ≈Jan-2026 per Art. 60) are already past with no issuance visible on uif.gob.sv as of 2026-08-18. Watch uif.gob.sv/marco-legal/ + D.O.; when issued, the threshold rows re-anchor (72_ Art. 51 → reglamento), the sujetos list, formats (goAML) and sanctions re-verify, and FR-194's overdue flags clear. | no | Takumi S5 (sources watch) | open |
