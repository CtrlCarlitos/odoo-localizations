...
stands unchanged — the classification/measurement/FV/FX machinery
encodes the Norma as printed, every jurisdictional parameter (functional
currency, markets, rate feeds) stays company config.
...
| OQ-3 | SOQ-46 carried: the SV NIIF-adopting instrument (Consejo de Vigilancia criteria per CC Arts. 443-444, or successor legislation) is NOT in the corpus — this file encodes the Norma's instrument/FV/FX machinery as printed with NO invented SV thresholds, markets or rate feeds; every jurisdictional parameter stays company config. Same instrument as commercial-legal/03 OQ-002 (criteria-instrument hunt open: candidates Res. 175-2023 [derogated intermediate] / Res. 82-2024; authority chain 76_-78_ owned W18; registry numbering ≥127). | no | Takumi S8 (sources watch) | open |
