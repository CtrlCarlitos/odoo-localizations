...
- **SV-TAX-FR-074:** The system shall compute ISR for domiciled natural
  ...
  *cuota fija* (fixed quota). Version note (D12): TWO table vintages as
  ...
  vintage by liquidation-period date. The PERIODIC payroll retention
