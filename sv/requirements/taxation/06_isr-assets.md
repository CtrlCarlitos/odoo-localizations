...
- **SV-TAX-FR-156:** The system shall capitalize the depreciation of goods
  ...
  other goods, and in the *lotificación* of bienes inmuebles: the annual
...
- **SV-TAX-FR-161:** The system shall never depreciate *mercaderías* or
  inventory existences, nor rural or urban LAND — except what is built on
  it — and, for *edificaciones*, shall require the accounting SEPARATION of
  the land value from the building value, depreciating only the building
  component. (LB-005; EVID-101)
...
- **SV-TAX-FR-164:** The system shall amortize the acquisition or
  ...
  full quota; shorter schedules require an authorized higher percentage
  that the law does not grant — OQ-007), only for OWNED software while in
...
- **AC-013:** Given software acquired for $100,000.00 (new, owned, in
  ...
  $25,000.00 over a 4-year span; given it entered use on 1-Sep (8 of 12
