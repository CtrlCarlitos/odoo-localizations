...
OQ-tracked; closes `taxation/02_isr-deductions.md` OQ-009 by pointer). It
also carries the 108_ PROVEEDORES-LOCALES relief class (FR-421): local
suppliers realizing ventas de bienes or prestaciones de servicios in favor
of the energy-package exemption beneficiaries do NOT apply the Art. 66
crédito-fiscal proportionality on those operations — an express-statutory
seller-side exclusion (108_ Art. 2 final paragraph; the 97_ kin recorded at
LB-009). And it owns the Arts. 67-70 remanente regime: the indefinite
carryforward of
