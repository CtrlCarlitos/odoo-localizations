...
the underlying LAW texts remain absent (SOQ-39/MOQ-04). **V1 citation
...
mechanics beyond 31_'s print are asserted. The SOQ-54 vintage watch (§2
...
- **SV-TAX-FR-242:** The system shall enforce, on the IVA base engine, the
  ...
  the Ley-side rule the base engine enforces. SOQ-39/MOQ-04: the
  instruments are absent — the guard holds for ANY per-unit fuel
  contribution configured in the family, provenance-dated (OQ-3).
...
design — re-validate at instrument acquisition (SOQ-39/MOQ-04, OQ-2/OQ-3).
...
| OQ-3 | SOQ-39/MOQ-04 (guard note): the FOVIAL law text (D.L. 208-2000 as reformed, post-597-2001 evolution, current $/gal) and the COTRANS instrument remain absent — FR-242's guard is instrument-independent (it excludes ANY configured per-unit fuel contribution from the IVA base) but the $0.20 value and the chain mechanics ride 31_'s 2001 print with CAT-015 v1.1 (2026-07) as consistency note only; FR-245's COTRANS rows stay config-gated until acquisition. Acquire both instruments; re-date the provenance rows. | no | Takumi S9 (sources registry) | open |
