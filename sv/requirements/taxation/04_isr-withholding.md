...
- **SV-TAX-FR-116:** The system shall aggregate EXTRAORDINARY
  ...
  *vacaciones* (vacation pay), *bonificaciones, premios,
  ...
  with the salary and the monthly table applied; where deductions apply
  on the same payment date they are deducted from the total, and where
  payment dates differ, from the LAST remuneration paid within the
  monthly period. (LB-011; EVID-159)
...
- **AC-003:** Given a quincenal base of $500.00, then the retention =
  ...
  $20.24 (FR-109).
- **AC-004:** Given a monthly base of $700.00 for a worker projected at
  ≤ $9,100.00/yr, then the Tramo II $1,600 proration applies per the
  OQ-001 working assumption (700.00 − 133.33 = 566.67 → Tramo I,
  SIN RETENCIÓN); the assumption flag OQ-001 is surfaced on the payslip
  trace (FR-103).
- **AC-005:** Given January-May cumulative gravadas of $14,000.00 with
  prior retentions of $180.00 and a June gravada of $3,400.00, then the
  June recálculo accumulates $17,400.00, the June table yields 10% ×
  (17,400.00 − 3,300.00) + 106.20 = $1,516.20, and the June retention =
  max(0, 1,516.20 − 180.00) = $1,336.20 (FR-110).
...
- **AC-007:** Given ejercicio gravadas of $30,000.00 and Jan-Nov
  ...
  3,462.86 = $5,115.72, and the December retention = max(0, 5,115.72 −
  2,500.00) = $2,615.72 (FR-111).
