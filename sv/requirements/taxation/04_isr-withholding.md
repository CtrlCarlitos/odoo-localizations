...
(D.E. 10-2025, operative; **published D.O. N° 79 T.447 30-abr-2025 =
gazette print `60_`; effective 2025-05-08 — SOQ-03 RESOLVED, EVID-171;
all [sic] digits verified against the gazette original**) > 10_ (D.E.
...
| LB-013 | D.E. 10-2025, Art. 1 i), Arts. 2-4 | Mismatch duty: if ejercicio retentions do not match the Art. 37 liquidation, declare/pay per Arts. 37 & 48 or request refund; in any case subjects with rents > US$60,000.00 MUST file; online-only filing for withheld domiciled natural persons via MH website aplicativos (Art. 2 — informational; consumed by `01_isr-framework.md` FR-029/FR-031); repeals D.E. 95-2015 (18-XII-2015, D.O. 236 T.409 22-XII-2015) (Art. 3); vigencia 8 days after D.O. publication → **effective 2025-05-08 CONFIRMED: published D.O. N° 79 T.447 30-abr-2025, pp. 25-32 (gazette print = `60_`; EVID-171; SOQ-03/OQ-002 resolved)** | `sv/sources/53_Tablas_Retencion_ISR_DE10_2025.pdf` + `sv/sources/60_DE10_Tablas_Retencion_DO_2025-04-30.pdf` | Art. 1 i), Arts. 2-4 pp.7-8 (EVID-161; 60_ Art. 4 p.8 EVID-171) |
...
| LB-021 | Ley ISR (consolidada), tail "DISPOSICIONES RELACIONADAS" | Aguinaldo transitories overriding the standing 2-SMM rule by year: D.L. 877-2014, 177-2015, 540-2016, 831-2017, 160-2018 (2014-2018: aguinaldo retention fully exempted for the year); D.L. 229-2021 (D.O. 233 T.433 7-XII-2021) "hasta un límite de $1,100"; D.L. 596-2022 (D.O. 231 T.437) "$1,500"; D.L. 900-2023 (D.O. 225 T.441) "$1,500.00"; D.L. 159-2024 (D.O. 227 T.445 27-XI-2024) "$1,500.00"; no transitory listed after 159-2024 → 2025+ standing 2-SMM rule assumed (SOQ-05/OQ-003); vintages instrument-anchored since W19 T5 (EVID-398..401 + chain verification EVID-403) | `sv/sources/91_Disposiciones_Transitorias_Aguinaldo_DL229_DO_2021-12-07_pp4-5.pdf` + `sv/sources/92_Disposiciones_Transitorias_Aguinaldo_DL596_DO_2022-12-07_pp22-24.pdf` + `sv/sources/93_Disposiciones_Transitorias_Aguinaldo_DL900_DO_2023-11-30_pp8-10.pdf` + `sv/sources/94_Disposiciones_Transitorias_Aguinaldo_DL159_DO_2024-11-27_pp64-66.pdf` (W19 T5 primary instruments of the vintage limb) + `sv/sources/54_Ley_ISR_consolidada_DO79_T447_2025-04-30.pdf` (standing-rule text + consolidation-tail navigation co-cite) | Vintage caps + vigencia: 91_ Art. 1/2 txt PAGE 2 · 92_ Art. 1/2 txt PAGE 2 · 93_ Art. 1/2 txt PAGE 2 · 94_ considerando IV + Art. 1/2 txt PAGE 1-2 (EVID-398..401 + chain verification EVID-403, W19 T5); standing rule: Art. 4.16 p.7 (EVID-165); consolidation tail: DISPOSICIONES RELACIONADAS pp.61-63 (EVID-167) |
...
- **SV-TAX-FR-108:** The system shall load the periodic retention tables
  ...
  all anomaly digits VERIFIED against the D.O. gazette print `60_`,
  EVID-171 — they are in the original, not certified-copy artifacts);
  ...
  2025-05-08 (published D.O. N° 79 T.447 30-abr-2025 — SOQ-03
  resolved, EVID-171); the annual Art. 37 table vintages consumed by the
...
- **SV-TAX-FR-120:** The system shall compute the aguinaldo retention
  ...
  SOQ-05/OQ-003) (vintage limbs instrument-anchored to 91_-94_ since
  W19 T5; 2025+ standing row chain-verified — EVID-403); CT 155 inc.
  2's blanket-exemption reading never
...
| FR-108 | odoo | l10n_sv.isr.withholding.table / l10n_sv.isr.rate.bracket | CSV seeding | Version regime (D12): retention-decree chain D.E. 25-1992 → D.E. 95-2015 (values absent from corpus, OQ-005) → D.E. 10-2025 operative valid_from 2025-05-08 (published D.O. 79 T.447 30-abr-2025 = 60_; [sic] digits gazette-verified EVID-171; SOQ-03 resolved); [sic] fidelity per SOQ-03 (note column) |
...
| FR-120 | odoo | l10n_sv.isr.aguinaldo.exemption | vintage rows | Version regime (D12): 2014-2018 full exemption; 2021 $1,100; 2022-2024 $1,500; 2025+ standing 2-SMM with floor DEDUCTED (D.L. 458-2019); SMM value from 16_ payroll-wave feed (concept only here — no value encoded); SOQ-05/OQ-003 re-verification at encoding; 91_-94_ instruments co-anchored W20 (EVID-398..401/403) |
...
30-abr-2025 = gazette print 60_; SOQ-03 resolved EVID-171) and the D.E.
25-1992 historical vintage (effective
...
(verified: no 2025 transitory — EVID-403 chain verification + 54_ print
2025-04-30 tail; annual Diciembre-window re-check at encoding).
...
| OQ-002 | SOQ-03: D.E. 10-2025 provenance + fidelity: pin the publishing D.O. issue (vigencia 8 días tras publicación → 2025-05-08 assumed per MH dating) and verify the printed-digit anomalies — June 5,371.44 (exact halving 5,371.43), 12,228.60 (= 12,228.57), cuota 106.20 (= 106.06; largest deviation, deliberate-looking), cuota 1,731.42 (= 1,731.43), semanal IV DESDE 509.53 (= 509.5275), semanal III HASTA 509.52 (= 509.525), quincenal IV DESDE 1,019.06 (= 1,019.055, consistent round-up). CSV transcribes as printed with [sic] notes (01-file OQ-005 kin). **RESOLVED 2026-08-18 (EVID-171, source 60_): D.E. 10 published D.O. N° 79, T. 447, 30-abr-2025, pp. 25-32 → effective 2025-05-08 CONFIRMED; every anomaly digit re-verified IDENTICAL in the D.O. gazette print (December table exact-consistent as contrast) — the deviations are gazette-original, [sic] rows stand as transcribed.** | no | Takumi S2 (sources registry) | resolved |
| OQ-003 | SOQ-05: does a 2025/2026 aguinaldo transitory exist capping the Art. 4.16 2-SMM exemption at a fixed $? The 54_ related-laws tail lists none after D.L. 159-2024 ($1,500) → FR-120 assumes the standing 2-SMM rule for 2025+; the payroll wave re-verifies at encoding time and owns the SMM feed (16_). Verified W19/W20 (EVID-403 chain verification + 91_-94_ instruments anchored, EVID-398..401): no 2025 transitory exists — the 54_ print 2025-04-30 tail lists none after D.L. 159-2024 and no 91_-94_ instrument extends its single-fiscal-year cap; 2025+ stands on the Art. 4.16 standing 2-SMM rule. Standing note: the annual Diciembre-transitory re-check rides the SMM/aguinaldo encoding pass (SOQ-05 kin — a December-2026 instrument would re-key the FR-120 vintage row at encoding time). | no | Takumi payroll wave | **resolved** (W20; EVID-403 + 91_-94_ anchored) |
