...
consolidation text (54_-verify rule; EVID-166 residual-risk note).
...
- **SV-TAX-FR-032:** The system shall schedule retention remittances (when
  ...
  December declaration of the year the cost or expense was incurred. Flag:
  this Ley rule is likely superseded/complemented by the CT retention-agent
  regime — see OQ-001. (LB-027; EVID-104)
...
- **AC-005:** Given a taxpayer dying on 15-May with rents Jan 1-May 15, then
  ...
  and accepted 20-September of the next year, then the estate computes
  16-May→31-Dec of year 1, a full ejercicio for the intervening year, and
  1-Jan→20-Sep of the acceptance year (FR-016).
