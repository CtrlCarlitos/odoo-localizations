...
| Status  | draft (S7, 2026-08-19; W19 fold-in 2026-08-22; W24 fold-in 2026-08-24) |
| Authors | Controller + S7 subagent wave |
| Updated | 2026-08-24 (W24 T5 index rollup) |
...
| [08_fovial-cotrans.md](08_fovial-cotrans.md) | FOVIAL $0.20/galón per-unit special contribution on diesel/gasolinas (excl. aviación) with the IVA-exclusion guard (never in base imponible), separate document fila/casilla, B2B control-account chain (RETENCIÓN/CTA POR COBRAR-FOVIAL), own-consumption ISR deductibility (SV-TAX-FR-045 by id), COTRANS $0.10/galón passenger-tariff contribution (W19 identity correction: 89_ = D.L. 257-2021 tariff-stabilization law, NOT cargo transport), D1-tributo DTE wiring + F-07 fuel-annex feeds by id; W19 T2: instruments acquired (86_-89_) — FR-185..189 (FOVIAL enter duty + pesca/aviación exclusion surface; COTRANS retention/multa + FOVIAL×COTRANS stacking; vigencia-chain dated rows) + FR-166/167/174 re-anchored; W24: FR-175 SOQ-40 pointer RESOLVED (taxation/09 OQ-2 — design confirmed, config-gated; LB count now includes the W21 LB-013 106_ row) | SV-SPE-FR-166..175 + 185..189 | 15 | 13 | 10 | 8 |
| **Total** | | SV-SPE-FR-001..204 | **204** | **165** | **100** | **60** |

Numbering note: FR numbering is wave-sequential within the **SV-SPE** prefix
(001-175 from the S7 wave + 176-203 from the W19 fold-in + 204 from the
W24 fold-in, no gaps, no
...
`01`/`02`, W24 T1: 204 the 108_ energía-eléctrica package family in
`02` — files 01/02/06/07/08 carry non-contiguous tails, consumers cite
...
SV-TAX-FR-405..416 owns the Chapter V engine; W21: `08` OQ-8 resolved —
...
the 10-instrument named set complete,** ~~FR fold-ins pending~~ — **fold-ins
EXECUTED W24 (T1: spe/01 FR-200 amendment + LB-034/035, spe/02 FR-204 +
LB-024 + OQ-10; taxation limbs SV-TAX-FR-417..421 in the sibling
index)**), F-11 v20 print.
