...
| OQ-3 | SOQ-36 carried (W18 verdict, 2026-08-21): the Comité Aduanero DUCA user manual is PORTAL-INTERNAL — not publicly posted (SIECA catalog + media REST API, oie.sieca.int/documentos, sitio.aduana.gob.sv all checked; identity proven via the Comité Aduanero 29-abr-2025 comunicado: Portal-de-Captura DUCA-T usuario/administrador manuals approved as updated, files live inside the operational Portal); Res. 409-2018 NOT superseded (no replacing COMIECO resolution in the SIECA catalog — 43_ remains the DUCA basis); FYDUCA successor-format owned (83_/84_ = Res. IM-UA 119-2024 + Anexo 1 format, in force 1-ago-2024, deroga 11-2017 + 91-2021; 85_ = SIECA glossary — $5.00/FYDUCA transmission fee per RIM 117-2024). FR-112 keeps NO invented field obligations (field_requiredness config slots with no defaults); field-numbering reconciliation kin with 04's OQ-2 (this file cites fields 14/56 as printed). Residual = the Portal-internal manuals (mandatory-vs-optional marking), acquisition via Portal registration only. | no | Takumi S7 (sources watch) | open |
