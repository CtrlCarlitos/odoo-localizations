...
| OQ-3 | SOQ-31 carried — **RESOLVED NEGATIVE W25 (2026-08-24)**: the Reglamento General de la Ley de Zonas Francas (mandated by 12_ Art. 51) was never printed — the full D.O. window scan 23-sep→23-dic-1998 (65 issues, two OCR passes each) found no such instrument, and MINEC qualifying acuerdos still cite the SUPERSEDED 1990 law + its reglamento (practice corroboration). Solicitud/informe formats and DACG structures ride the resoluciones/DACG practice layer. FR-019 exposes the procedure clocks as printed; the format-level details ship as config slots with NO defaults. **W19 T3: FR-191's cambio-de-tipo requisitos and FR-192's permit surfaces also cite "su Reglamento" (82_ Arts. 8-9) — same config-slot family.** | no | Takumi S7 (sources watch) | **resolved** (W25 negative-confirmed; gloss de-staled W26) |
