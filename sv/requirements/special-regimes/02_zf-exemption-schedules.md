...
municipal proration — **W19 T3: the 82_ tail (D.L. 493-2025, vigencia
~31-dic-2025) folded — the substituted/added extension economics (usuario
+10y per 17-A with BCR adjustment; NEW DPA +10y per 19-A/19-B;
...
Industriales y de Comercialización") + **82_** (W19 T3: Reformas a la Ley
de Zonas Francas, D.L. Nº 493-2025, D.O. N° 243 T.449 23-dic-2025, vigencia
8 días después → ~31-dic-2025 — the first post-318-2013 reform; reformed
Ley Arts. 10/11/17/19 + the 2-yr grace transitory touch THIS file's
ladders/extensions; co-cite 12_+82_ for the tail, 12_ for unreformed text;
12_ remains the last consolidated print). Pointer LBs of this file: the Ley ISR
...
declaration-duty kin = **80_** (LSI Art. 14, explicit text — W19 T3: 14_
superseded by 80_ thru D.L. 277-2013, Art. 14 unchanged by the reform; the
ZF-side
...
consolidation ends at D.L. 318-2013 — **W19 T3: the parity ENDED
23-dic-2025 — the ZF tail = 82_ (D.L. 493-2025, vigencia ~31-dic-2025);
extension-inciso and transitory changes folded below with dated rows;
post-2025 traffic beyond 82_ remains unverified** (SOQ-22 kin); article
text is cited **as printed** (12_ for unreformed text; 82_ quotes carry
the OCR-cleaning note of EV82). Verbatim text below is copied
from the W13 evidence files (EVID-253/254/255/256/257), the W19 T3
evidence (EVID-385..390, EV82) and, where the
...
| LB-017 | Ley de Servicios Internacionales, Art. 14 (kin authority, explicit text; the ZF-side 12_ print is corpus-silent on the point): the desarrollista ISR exemption "NO LIBERA… DE LA OBLIGACIÓN DE PRESENTAR LA RESPECTIVA DECLARACIÓN TRIBUTARIA EN CADA EJERCICIO" | The special-regime exemption does NOT release the beneficiary from the obligation to present the respective tax declaration in each ejercicio (LSI twin text; applied here as the declaration-duty-survives-exemption guard for ZF/DPA rows, with the F-11 v20 surface as pointer) | `sv/sources/80_Ley_Servicios_Internacionales_consolidada_DL431_DL277.pdf` | Art. 14 p.11 (EVID-262; 80_ txt PAGE 11 — unchanged by 277-2013; 14_ re-keyed W19) |
| LB-018 | Reformas a la Ley de Zonas Francas (82_), Art. 3 (ZF-law Art. 11, inciso after literal c) sustituido + 3 added): "Los Desarrollistas tendrán derecho a un plazo adicional de diez años para las exenciones contenidas en este artículo, siempre que durante el periodo de la exención total o su respectivo plazo adicional hayan invertido en una ampliación de la Zona Franca, cuya superficie total de la ampliación sea como mínimo una extensión igual o superior a la que posean en el momento de solicitar la exención, cumpliendo con los requisitos mínimos de infraestructura establecidos en el artículo 10 de la presente Ley." + "El plazo adicional de exenciones podrá ser solicitado en más de una ocasión siempre que, para cada nueva solicitud, el Desarrollista acredite nuevamente el cumplimiento de los requisitos exigidos en el inciso anterior." + ISR proportional rule: "…cuando se cumpla con el requisito de invertir en una ampliación… igual o superior al 100% de la construcción inicial, los Desarrollistas gozarán de dicho beneficio, tanto por los ingresos producidos por la nueva inversión como los producidos por la totalidad de la inversión inicial. En caso de que no se cumpla con dicho requisito, los Desarrollistas podrán gozar de la totalidad del beneficio respecto de los ingresos producidos por la nueva inversión, como también por los ingresos producidos por la inversión inicial en el porcentaje que de la misma represente la nueva inversión. Para tales efectos, los Desarrollistas deberán llevar registros especiales en que se pueda constatar separadamente el correcto uso de dicho beneficio." + sociedad/socios proportional inciso + "El Acuerdo que emita el Ministerio de Economía en que se dé la autorización al Desarrollista, deberá incorporar de forma clara y taxativa, la mención de la actividad económica incentivada a favor de este último." | Desarrollista extension regime from ~31-dic-2025: +10 YEARS (was +5 with the 5-km/8-manzanas predicate — LB-005) when during the total-exemption period (or a previous additional term) they invested in an ampliación whose total surface is ≥ the surface possessed at the request moment, meeting Art. 10 infrastructure (reformed 10.3.b — spe/01 FR-192); REPEATABLE (more than one request, re-accreditation each time); ISR proportional rule — ampliación ≥100% of the initial construction ⇒ exemption covers new + ALL initial income; below that ⇒ new-income exemption full, initial-income exemption prorated by the new-investment share; SPECIAL REGISTRIES must separate the benefit's use; sociedad + socios proportional; the MINEC acuerdo must state the incentivized activity clearly and taxatively | `sv/sources/82_Reforma_Ley_ZF_DL493_DO_2025-12-23.pdf` | 82_ Art. 3 pp.2-3 (EVID-385/387; 82_ txt PAGE 2-3; vigencia ~31-dic-2025 — co-cite 12_+82_; OCR PSM 4) |
...
- **SV-SPE-FR-026:** The system shall implement the usuario
  ...
  **W19 T3 scope note: this 12_ regime governs determinations before the
  82_ vigencia (~31-dic-2025); from that date the substituted +10-year
  regime of FR-195 applies (dated rows, both retained, never merged)**.
  (LB-002 final inciso; EVID-254; EVID-387 W19 T3)
...
- **SV-SPE-FR-030:** The system shall implement the
  ...
  desarrollistas/administradores (54-C final paragraph) — **W19 T3 scope
  note: this 12_ inciso-final regime governs determinations before the 82_
  vigencia (~31-dic-2025); from that date the substituted +10-year
  desarrollista regime of FR-197 applies (dated rows, both retained; the
  54-C cross-reference interaction is OQ-7; the Art. 10 infrastructure
  predicate resolves against the reformed 10.3.b split — spe/01 FR-192)**.
  (LB-005 final; LB-006; EVID-253; EVID-386/387 W19 T3)
...
- **SV-SPE-FR-033:** The system shall implement the Art. 19-C DPA extension
  ...
  are recorded on their own row sets and never cross-applied (W19 T3:
  Arts. 17-B/19-C are NOT in the 82_ reform map — these strategic-sector
  extensions survive unchanged; the 82_ +10-year regimes of FR-195..197
  are a SEPARATE extension family, cumulative per the statute's own terms,
  never merged with these).
  (LB-011; EVID-255; EVID-385 W19 T3)
...
### 3.9 Quincena-25 certificado consumption + declaration guard (SV-TAX-FR-174 by id; 80_ Art. 14 kin)
...
### 3.11 W19 T3 fold-in — the 82_ extension economics (D.L. 493-2025, vigencia ~31-dic-2025)

- **SV-SPE-FR-195:** The system shall implement the SUBSTITUTED usuario
  extension regime (82_ Art. 4 → ZF-law Art. 17) as extension events with
  valid_from = ~31-dic-2025, dated rows DISTINCT from the pre-vigencia
  FR-026 events (both families retained, selected by the determination
  date): +10 YEARS when the beneficiary proves a ≥100% investment increase
  over its INITIAL investment realized during the total-exemption period
  or a previous additional term — the increase computed per Art. 17-A
  (FR-010 rows by id) and the base value ADJUSTED by the latest annual
  inflation percentage reported by the Banco Central de Reserva (BCR
  adjustment input = a dated config lookup, external-source assumption);
  EMPLOYMENT ROUTE as a distinct predicate set: beneficiaries that met the
  jobs requisito instead prove investment equal to the initial investment
  (floor US$500,000.00) PLUS a 100% increase in job count against the
  average ACTIVE jobs of the LAST THREE YEARS (payroll headcount records
  by id); the extension is REPEATABLE (more than one request, each with
  fresh accreditation); sociedad + socios benefit proportionally to the
  investment; and the MINEC authorization Acuerdo must carry the
  no-necessary-goods tariff detail (FR-038 kin) plus the clear, taxative
  mention of the incentivized economic activity (or set) — an
  Acuerdo-content validation flag consumed from the profile record.
  (LB-019; EVID-387 W19 T3)
- **SV-SPE-FR-196:** The system shall implement the NEW DPA-titular
  extension regime (82_ Art. 6 → ZF-law Art. 19) as extension events on
  the FR-027/028 row sets, valid_from = ~31-dic-2025 — the 12_ print
  carried NO DPA investment extension, so this family has no pre-vigencia
  twin: +10 years on ≥100% investment increase over initial (computed per
  Arts. 19-A/19-B, FR-012 rows by id; BCR-inflation-adjusted); employment
  route = investment equal to the initial (floor US$800,000.00, matching
  the 19-A value) + 100% jobs increase vs the 3-year active-jobs average;
  repeatable; sociedad + socios proportional; the same Acuerdo-content
  duty — DPA extension events never cross-apply to usuario row sets and
  vice versa (regime-distinctness invariant; FR-033 kin).
  (LB-020; EVID-388 W19 T3)
- **SV-SPE-FR-197:** The system shall implement the SUBSTITUTED
  desarrollista extension regime (82_ Art. 3 → ZF-law Art. 11) as
  extension events with valid_from = ~31-dic-2025, distinct from the
  pre-vigencia FR-030 events: +10 YEARS (was +5 with the 5-km-radius /
  ≥8-manzanas predicate) when during the total-exemption period or a
  previous additional term the desarrollista invested in an AMPLIACIÓN of
  the zona franca whose total surface is at least equal to (≥100% of) the
  surface possessed at the request moment, meeting the (reformed) Art. 10
  infrastructure requisitos (spe/01 FR-192 by id); repeatable with fresh
  accreditation; and the ISR PROPORTIONAL RULE rides the ISR row: ampliación
  ≥100% of the initial construction ⇒ the exemption covers new-investment
  AND all initial-construction income; below that ⇒ new income fully
  covered, initial-construction income covered only in the proportion the
  new investment represents of it — enforced through SPECIAL SEGREGATED
  REGISTRIES the desarrollista must keep ("registros especiales en que se
  pueda constatar separadamente el correcto uso de dicho beneficio" — a
  bookkeeping-segregation flag on the row set, SV-TAX-FR-035/036 kin);
  sociedad + socios proportional; the Acuerdo carries the taxative
  incentivized-activity mention.
  (LB-018; EVID-387 W19 T3)
- **SV-SPE-FR-198:** The system shall implement the 82_ transitory 2-YEAR
  GRACE as a dated bridging regime on every ZF/DPA benefit row whose
  statutory term (acuerdo plazo or extension end) expires at/after the 82_
  vigencia: from the expiry of the respective Acuerdo's term the
  beneficiary continues enjoying ALL the law's benefits for TWO years —
  EXPRESSLY including the ISR exemption on utilidades/dividends
  distributed to socios or accionistas from the favored activity (the
  FR-035 dividend-window suppression extends through the grace span) — as
  grace rows stamped on the exemption-row chassis (row kind
  `grace_period_82`, anchor = the acuerdo-term end, +2 years, values
  frozen at the pre-expiry level); during the span the system tracks the
  adequacy-investment obligation (config slots — the "concreción" criteria
  are unstated, EV82 OQ-5); and on failure to concretize the investment
  within the period, a CLAWBACK obligation row computes and records the
  rights and taxes that WOULD have been generated during the grace period
  absent the benefit (payable flag + amount surface; the specific tax
...
- **SV-SPE-FR-203:** The system shall implement the 97_ biogás-Acelhuate
  ...
  (identity corpus-silent — config-gap with NO default, OQ-8); the ISR side
...
| Entity | Field | Type | Catalog / values | Reference |
|--------|-------|------|------------------|-----------|
| l10n_sv_special_regime.extension_event | kind | select | ampliation_5y (≥8 manzanas · 5-km radius · Art. 10 infrastructure — pre-82_ vigencia) · investment_increase_5y (100% over initial, last 5 total-exemption years, land/buildings/machinery — pre-82_ vigencia) · strategic_sector_5y (six-sector list) · estrategica_10y (MINEC declaration; Art. 2 b) ≥US$10,000,000 gloss) · grandfather_54c_5y · **W19 T3 (82_, valid_from ~31-dic-2025): usuario_10y_82 (100% over initial per 17-A, BCR-adjusted · employment route US$500,000 + 100% jobs vs 3-y average · repeatable · proportional) · dpa_10y_82 (per 19-A/19-B · employment route US$800,000 · NEW, no pre-vigencia twin) · desarrollista_10y_82 (ampliación surface ≥ possessed surface · repeatable · ISR proportional rule + special registries)** | FR-026, FR-030..033, FR-195..197 |
| l10n_sv_special_regime.extension_event | predicate_values · proof_ref | config · char | sector list row · manzanas/radius/infrastructure flags · investment base+increase measurement (bookings against T1 requisito log) · BCR inflation-adjustment input · 3-year active-jobs average (payroll by id) · acuerdo refs | FR-026, FR-030..032, FR-195..197 |
| l10n_sv_special_regime.extension_event | effective_date · added_years · regenerates | date · int · boolean | row-set regeneration flag (windows recomputed from the extension); 82_ events add 10 years | FR-026, FR-030..033, FR-195..197 |
| l10n_sv_special_regime.exemption_row | grace_period_82 | boolean/dated rows | 82_ transitory: row kind stamped at the acuerdo-term end, +2 years, values frozen (incl. socio-level dividend ISR exemption); failure-to-invest ⇒ clawback row (rights+taxes that would have been generated) | FR-198 |
...
| FR-195 | odoo | l10n_sv_special_regime.extension_event | kind usuario_10y_82 | 82_ Art. 4 (ZF Art. 17): +10y, 100% over initial per 17-A, BCR-adjusted; employment route US$500,000 + 100% jobs vs 3-y avg; repeatable; proportional; Acuerdo nomenclature + taxative-activity flags |
...
- **AC-012:** Given a metro ZF usuario whose total-exemption window ends
  2027-03-02 and who proves in 2026 a 105% investment increase over the
  BCR-adjusted initial investment, when the extension resolves, then the
  82_ usuario_10y_82 event regenerates the 100% window through 2037-03-01
  (never the pre-vigencia +5-year shape), the repeatable-reaccreditation
  counter starts at 1, and the Acuerdo record carries the nomenclature +
  taxative-activity flags (FR-195).
- **AC-013:** Given a ZF beneficiary whose acuerdo term expires
  2026-06-30, when the FR-198 grace rows stamp, then all benefits continue
  at pre-expiry values through 2028-06-30 including the socio-level
  dividend ISR exemption (FR-035 suppression extended), and on
...
| OQ-3 | SOQ-30 carried: the 12_ consolidation ends at D.L. 318-2013 — **W19 T3: the 82_ tail (D.L. 493-2025, vigencia ~31-dic-2025) folded as FR-195..198 + LB-018..021; post-2025 traffic beyond 82_ remains unverified**; every LB cites as printed (12_+82_ co-cite for the tail); re-verify before implementation. | no | Takumi S7 (sources watch) | open |
