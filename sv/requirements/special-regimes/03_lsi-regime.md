...
Authority order (binding, per master evidence index §S7-A): LSI = **14_**
(D.L. Nº 431, 11-oct-2007, D.O. N° 199 T.377 25-oct-2007; vigencia 8 days
after publication (Art. 71) → effective 2-nov-2007; 2007 Asamblea-style
print, header "Reformas: S/R") + **17b_** (Reglamento de Aplicación, D. Nº
131, 4-dic-2008, D.O. N° 235 T.381 12-dic-2008; vigencia 8 days (Art. 67)
→ effective 20-dic-2008; its Art. 22 local-market caps, Arts. 45-61
...
**SOQ-30 verification note (rides EVERY regime LB in this file):** the 14_
and 17b_ prints are the 2007/2008 originals with no reform block
("Reformas: S/R") — post-cutoff reforms are unverified until official
routes recover (SOQ-22 kin; D.L. 598-2020-era traffic may have touched the
law); article text is cited **as printed**. Verbatim text below is copied
from the W13 evidence file (EVID-259/262/264/265/267) and, where the
...
- **SV-SPE-FR-046:** The system shall generate, for a *centro de
  ...
  FR-045 (list rows with 14_ Art. 25 provenance; gate mechanics consumed
...
- **SV-SPE-FR-048:** The system shall implement the local-market service
  ...
  investigación y desarrollo → cap 30% — the measurement basis being VENTAS
...
### 3.3 Semestral auditor-dictamen family (14_ Art. 47 f); 17b_ Arts. 45-61)
...
### 3.4 Requisito monitors — LSI-specific tracking (14_ Arts. 22/23/46)
...
- **SV-SPE-FR-056:** The system shall monitor the LSI qualification
  ...
  row); the BPO per-year monitors — investment ≥US$150,000 (working
  capital + fixed assets), ≥10 permanent jobs, ≥1-year written contract —
  ...
  thresholds ($10,000,000.00 quirúrgico / $3,000,000.00 no-quirúrgico
  [print "$3,000.000,00" sic], location and insured-patients predicates)
  as admission-time checks logged against the T1 rows; the DGA
  ...
  (LB-011; LB-012; EVID-262/264)

### 3.5 Usuario-indirecto consignment liability (14_ Art. 22 f)-g))
...
### 3.6 Staffing quota — 90% Salvadoran (14_ Art. 47 k))
...
### 3.7 CT-158-II carve-outs (17b_ Art. 65; 14_ Art. 4 inc. 2)
...
- **SV-SPE-FR-059:** The system shall suppress, on the vendor bills of an
  ...
  retention (17b_ Art. 65 per 14_ Art. 4 inc. 2) — a suppression config
...
- **SV-SPE-FR-060:** The system shall suppress the same CT Art. 158
  ...
  beneficiary working in a parque or centro (14_ Art. 4 inc. 2 — the law's
...
### 3.8 Fianza + AML-conviction revocation link (14_ Art. 50)
...
### 3.9 ZF→LSI migration transitorias (14_ Arts. 63/64/66)
...
| Entity | Field | Type | Catalog / values | Reference |
|--------|-------|------|------------------|-----------|
| l10n_sv_special_regime.local_market_cap | letter_group · cap_percent | select · percent | ab_distribucion_logistica: 50 · hjc_bpo_financieros_callcenter: 40 · de_ti_investigacion: 30 — of total servicios prestados; f/g/i = empty slots (no printed cap) | FR-048 |
...
| res.partner / hr.employee | sv_spe_nondomiciled_foreign | boolean | extranjeros no domiciliados of a beneficiary: same CT-158-II suppression (14_ Art. 4 inc. 2); all other employees fully taxed | FR-060 |
...
| FR-060 | odoo | res.partner / hr.employee | sv_spe_nondomiciled_foreign | extranjeros no domiciliados carve-out (14_ Art. 4 inc. 2); other employees fully taxed; OQ-4 cross-check |
