...
| Status  | draft |
| Authors | Takumi synthesis wave 7 (S7 special-regimes); W19 T1 fold-in (79_ LESIA); W19 T3 re-verification (80_/82_) |
| Updated | 2026-08-22 |
...
obligation catalogs (80_ Arts. 46-49: annual electronic-records
...
id); and — W19 T3 — the 82_ (D.L. 493-2025, vigencia ~31-dic-2025)
obligations tail: the substituted ZF-law Art. 28 a) prior-MINEC-authorization
gate (five modification kinds) with the e) derogation and its classification
note (FR-199; LBs re-keyed 14_→80_ with the LSI obligations/sanctions
articles verified unchanged thru D.L. 277-2013).
...
Industriales y de Comercialización"; W19 T3: ZF obligations tail = 82_,
D.L. Nº 493-2025, vigencia ~31-dic-2025 — Art. 7 substitutes ZF-law
Art. 28 a) with a prior-MINEC-authorization gate and DEROGATES literal e);
co-cite 12_+82_ for the tail); LSI = **80_** (Ley de Servicios
Internacionales, D.L. Nº 431,
11-oct-2007, as reformed by D.L. Nº 277-2013, D.O. N° 28 T.398 11-feb-2013
— **W19 T3: supersedes 14_ thru D.L. 277-2013**; the obligations/sanctions
articles (46-52, 62) verified UNCHANGED vs 80_; LBs re-keyed 14_→80_)
+ **17b_** (Reglamento D. Nº 131, 4-dic-2008, D.O. N° 235 T.381
...
74_ Arts. 15/17 + 80_ Art. 51; owns the LESIA class taxonomy, multa
...
shares with the declaration surfaces live in `06` FR-177/178 by id); ZF
obligations tail = **82_** (W19 T3: Reformas a la Ley de Zonas Francas,
D.L. Nº 493-2025, D.O. N° 243 T.449 23-dic-2025, vigencia ~31-dic-2025 —
Art. 7 substitutes ZF-law Art. 28 a) with a PRIOR-MINEC-authorization gate
and DEROGATES literal e); the Art. 28-final classification and the b)
register ride unchanged; co-cite 12_+82_ for the tail).

**SOQ-30 verification note (rides EVERY regime LB in this file):** the
regime consolidations ended 2012-2013 (12_ → D.L. 318-2013; 13_ → D.L.
121-2012; 74_ → D.L. 23-2012; 79_ → D.L. 588-2008) — **W19 T3: the LSI
half RESOLVED (14_ superseded by 80_ thru D.L. 277-2013; obligations and
sanctions articles verified unchanged; LBs re-keyed 14_→80_) and the 12_
parity ended by 82_ (D.L. 493-2025, vigencia ~31-dic-2025 — Art. 28 a)
substituted + e) DEROGATED, folded as LB-029/FR-199)**; remaining
unverified: post-2013 LSI traffic, post-2025 ZF traffic beyond 82_,
13_/74_/17b_/79_ beyond their ends
...
(the LSI text of record; the superseded 14_ txt remains the pre-277
provenance record),
...
the SMM "de mayor cuantía" unit (12_/80_ ladders, FR-141) resolves
...
| LB-029 | Reformas a la Ley de Zonas Francas (82_), Art. 7: "Sustitúyase en el artículo 28 el literal a) y deróguese [el] literal e), de la manera siguiente: 'a) Previo a realizar modificaciones en los planes y proyectos, tales como: ampliaciones, disminuciones, cambio de domicilio, cambio de tipo de beneficiario o cierre de operaciones, los Usuarios de Zonas Francas y Depósitos de Perfeccionamiento Activo deberán solicitar autorización al Ministerio de Economía. En el caso de los Usuarios de Zona Franca, también tendrán que comunicarlo a los Administradores de la Zona Franca.'" | From ~31-dic-2025: ZF-law Art. 28 a) is SUBSTITUTED — BEFORE making modifications to plans and projects (ampliaciones, disminuciones, cambio de domicilio, cambio de tipo de beneficiario, cierre de operaciones) ZF usuarios and DPAs must REQUEST AUTHORIZATION FROM MINEC; ZF usuarios additionally communicate it to the zona-franca administradores — the post-hoc 10-días-hábiles notice (LB-001 a) as printed) becomes a PRIOR gate covering five modification kinds; literal e) (30-day cambio/cierre notice) is DEROGATED, its subject absorbed into the gate | `sv/sources/82_Reforma_Ley_ZF_DL493_DO_2025-12-23.pdf` | 82_ Art. 7 p.5 (EVID-385/389; 82_ txt PAGE 5; vigencia ~31-dic-2025 — co-cite 12_+82_; OCR PSM 4 — "€)"→"el" normalized) |
...
- **SV-SPE-FR-130:** The system shall carry the 12_ Art. 28 obligation
  ...
  sanction family of FR-140..142 prices; **W19 T3 (82_ Art. 7, vigencia
  ~31-dic-2025): literal a) is SUBSTITUTED (the prior-authorization gate
  of FR-199 replaces the post-hoc notice for post-vigencia facts —
  dated rows both sides) and literal e) is DEROGATED (its rows end at
  ~31-dic-2025; the as-printed classification still lists e) among the
  graves — encode the derogation as a dated row, OQ-9)**; literals whose
  automation
  ...
  (LB-001; LB-003; LB-004; LB-005; LB-006; LB-029; EVID-258; EVID-389
  W19 T3)
- **SV-SPE-FR-131:** The system shall record the plan/project
  ...
  a)-literal compliance row of FR-130 (tier: leve) — **W19 T3 scope
  note: this 12_ notice regime governs modifications before the 82_
  vigencia (~31-dic-2025); from that date the substituted
  prior-authorization gate of FR-199 applies (dated rows, both
  retained)**.
  (LB-001; EVID-258; EVID-389 W19 T3)
...
- **SV-SPE-FR-134:** The system shall record the cambio/cierre notice
  ...
  Art. 40-A checklist by id (never restated there) — **W19 T3 scope
  note: literal e) is DEROGATED from ~31-dic-2025 (82_ Art. 7); its
  subject matter (cambio de domicilio / cierre de operaciones) folds
  into the FR-199 prior-authorization gate as two of its five
  modification kinds; this 30-day notice governs pre-vigencia facts as
  its own dated row (FR-148's closure checklist itself is an Art. 40-A
  surface NOT touched by 82_)**.
  (LB-002; LB-029; EVID-258; EVID-389 W19 T3)
...
- **SV-SPE-FR-142:** The system shall classify every recorded ZF/DPA
  ...
  suspensión definitiva) — **W19 T3: the classification map resolves
  AS PRINTED for facts before ~31-dic-2025; from the 82_ vigencia the
  e)-literal row is DEROGATED (no new e)-basis infracciones record; the
  as-printed map still enumerating e) among graves is an OQ-9 dated-row
  note) and a)-basis breaches record against the FR-199 gate**; the same record family receives the Art. 37-A
  ...
  restated here).
  (LB-006; LB-010; LB-029; EVID-258; EVID-389 W19 T3)
...
### 3.3 LSI obligations — Arts. 46-49 catalogs (80_ Arts. 46-49)
...
### 3.5 LSI sanctions (80_ Arts. 50-52/62 — W19 T3: verified UNCHANGED
by D.L. 277-2013 (no reform markers on Arts. 46-52/62 in the 80_ print);
LBs re-keyed 14_→80_)
...
- **SV-SPE-FR-182:** The system shall implement the LESIA consequence
  ...
  consequence family kept DISTINCT from the 12_/80_ Art. 36/52
...
### 3.8 W19 T3 fold-in — the 82_ prior-authorization gate (ZF-law Art. 28 a) substituted; e) derogated)

- **SV-SPE-FR-199:** The system shall implement the substituted ZF-law
  Art. 28 a) (82_ Art. 7, valid_from = ~31-dic-2025) as a
  PRIOR-AUTHORIZATION gate on five modification kinds — ampliaciones ·
  disminuciones · cambio de domicilio · cambio de tipo de beneficiario ·
  cierre de operaciones: BEFORE effecting any such modification, ZF
  usuarios and DPAs must SOLICIT and obtain MINEC authorization (the
  solicitud kind catalog mirrors the five kinds; the cambio-de-tipo
  branch links `01`'s FR-191 gate by id), and ZF usuarios ADDITIONALLY
  communicate the modification to the zona-franca administradores (a
  parallel communication record with its presented state); the gate
  blocks the modification event on the beneficiary profile (workflow
  state: requested → granted/denied with resolution reference — the
  Art. 48 procedure of FR-142 wraps denials); pre-vigencia modifications
  keep the FR-131 10-días-hábiles post-hoc notice rows (dated rows both
  sides, never merged); the DEROGATED literal e) rows end at
  ~31-dic-2025 with cambio/cierre riding this gate's kinds (FR-134
  scope note).
  (LB-029; EVID-389 W19 T3)
...
| l10n_sv_special_regime.obligation | tier | select | zf: leve (a,c,f,g,h,i,q) · grave (b,d,e,j,k,l,m,n,o,p,s) · muy_grave (r) — e) rows end ~31-dic-2025 (82_ derogation, W19 T3; OQ-9); lsi: menos_grave (46, 48) · grave (47, 49) · muy_grave (49 reincidencia) | FR-130, FR-161, FR-199 |
...
| l10n_sv_special_regime.obligation | valid_from · valid_to · provenance | date · date · char | instrument = 12_/80_ article as printed (SOQ-30; W19 T3 14_→80_); dated rows per D15 | FR-130..153 |
...
| FR-199 | odoo | l10n_sv_special_regime.authorization_request | kind(5)/state/parallel-comunication | 82_ Art. 7 (ZF-law Art. 28 a) substituted): PRIOR MINEC gate on ampliación/disminución/cambio-domicilio/cambio-tipo/cierre + ZF-user notice to administradores; e) rows end ~31-dic-2025; cambio-tipo links `01` FR-191 by id |
...
- **AC-016:** Given a ZF usuario planning an ampliación in March
  2026, when the modification event is created before any MINEC
  authorization exists, then the FR-199 gate blocks it (state
  requested), the parallel communication to the administrador records
  alongside the granted authorization, and no FR-131 10-días-hábiles
  post-hoc notice row resolves for the post-vigencia fact (FR-199;
  FR-131 scope note).
...
| OQ-4 | SOQ-31 kin — **RESOLVED NEGATIVE W25**: the Reglamento General de la Ley de Zonas Francas (12_ Art. 51 mandates it) was never printed (65-issue D.O. window scan 23-sep→23-dic-1998; MINEC practice ran on the superseded 1990 reglamento + resoluciones + DACG structures) — the semestral MINEC informe format, the descargo cuadro structure and the MINEC dependency designations ride that practice layer; FR-133/FR-134 expose the printed clocks and data groups with the formats as config slots, NO defaults. | no | Takumi S7 (sources watch) | **resolved** (W25 negative-confirmed; gloss de-staled W26) |
...
| OQ-9 | 82_ Art. 7 (W19 T3): literal e) of ZF-law Art. 28 is DEROGATED from ~31-dic-2025, but the Art. 28-final classification (12_ as printed, not amended by 82_) still enumerates e) among the graves — FR-130/FR-142 encode the derogation as a dated row (no new e)-basis infracciones post-vigencia; the as-printed list is an inconsistency note, not an interpretation); a future consolidating print may restate the classification — re-verify. | no | Takumi S7 (config watch) | open |
