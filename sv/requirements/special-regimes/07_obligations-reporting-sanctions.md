...
| l10n_sv_special_regime.closure_checklist | open_dm_ids · cancellation_state · unpaid_duties_state · lesia_pointer | o2m · select · select · flag | Art. 40-A; DMs from `04`/`06` by id; defraudación crime = POINTER ONLY (SOQ-32) | FR-148 |
...
- **AC-010:** Given a ZF usuario recording its definitive closure, when
  ...
  crime consequence appears as a LESIA pointer flag only (zero crime
  mechanics, SOQ-32).
