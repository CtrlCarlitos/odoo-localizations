...
prior DGA authorization** (80_ Art. 33), the 20-días-hábiles *destinación*
(customs-destination election) window post-discharge whose expiry ⇒
*abandono* (abandonment), the regímenes-optables menu (80_ Art. 34), the
...
— incl. 12_ Art. 27 materia-prima TAN consumption and 80_ Art. 26 TAN→
...
Industriales y de Comercialización"; W19 T3: ZF tail = 82_, D.L. Nº 493-2025,
vigencia ~31-dic-2025 — the 82_ reform map (Arts. 2/10/11/17/18/19/28/44/
46-A/54-B/54-I + transitory) does NOT touch the clock articles; 12_ Art. 22
stands as printed); LSI clocks = **80_** (Ley de Servicios Internacionales,
D.L. Nº 431, 11-oct-2007, as reformed by D.L. Nº 277-2013, D.O. N° 28 T.398
11-feb-2013 — **W19 T3: supersedes 14_ thru D.L. 277-2013**; Arts. 26/33/34
carry no 277 marker = text-identical; LBs re-keyed 14_→80_); DUCA field anchors = **43_** (Anexo II de la Resolución No. 409-2018
...
consolidation ends at D.L. 318-2013 (tail = 82_, D.L. 493-2025 — the clock
articles are OUTSIDE the 82_ reform map, verified W19 T3) — post-tail
traffic unverified (SOQ-22 kin; D.L. 598-2020-era watch); **W19 T3: the LSI
half RESOLVED — 14_ superseded by 80_ (thru D.L. 277-2013; Arts. 26/33/34
verified unchanged — the 12m-ZF (12_ Art. 22) vs 24m-LSI (80_ Art. 33)
clock-exclusivity invariant HOLDS unmodified; LBs re-keyed 14_→80_)**;
article text is cited **as printed** (12_ prints Arts. 22 onward
in UPPERCASE; 80_/43_ prints sentence case — casing preserved). Verbatim
text below is copied from the W13 evidence files (EVID-257/263/272), the W19
T3 verification (EVID-391 of `80_82_LSI_ZF.evidence.md`) and, where the
...
### 3.1 The clock chassis + the regime-distinctness invariant (12_ Arts. 21/22; 80_ Arts. 26/33)
...
- **SV-SPE-FR-065:** The system shall encode the ZF/DPA and LSI
  ...
  — 24 MESES CALENDARIO (veinticuatro meses calendario, 80_ Art. 33)
...
- **SV-SPE-FR-070:** The system shall require, on every traslado that does
  ...
  de remisión (80_ Art. 38, prior-DGA-authorization flag). A non-dominion
...
### 3.4 LSI clock family — parque/centros, destinación, regímenes optables (80_ Arts. 26/33/34)
...
### 3.5 Expedición, customs-value edge, Certificados de Control Aduanero (80_ Arts. 41/43/44)
...
- **SV-SPE-FR-078:** The system shall record Certificados de Control
  ...
  (LB-013; EVID-263)
### 3.6 Residuales disposition paths (80_ Art. 45)
...
| l10n_sv_special_regime.customs_clock | expiry_effect · lesia_pointer | select · flag | tribute_obligation (12_/80_ expiry) — sanction consequences NOT modeled (SOQ-32/OQ-1) | FR-066, FR-068 |
...
| l10n_sv_special_regime.clock_kind | valid_from · valid_to · provenance | date · date · char | 12_/80_/43_ article as printed (SOQ-30; W19 T3 14_→80_); duca_f_fauca_30dh = 43_ field 56 (2018 print assumed current — SOQ-36) | FR-064..081 |
...
|----|----------|-----------|-------|--------|
| OQ-1 | SOQ-32 carried — **RESOLVED at sources level W18/W19**: LESIA = 79_ (D.L. 551-2001, consolidated thru D.L. 588-2008 per its INDICE print; post-2008 traffic = watch), acquired after this row's original wording; 12_ Art. 26 (Art. 5 literal q) traslado-term breaches and the Arts. 26/40-A expiry consequences now anchor to the owned instrument — FR-066/FR-068/FR-072 keep tribute-obligation states and pointers ONLY, zero sanction mechanics invented here; the sanction ladders and the defraudación crime elements live in `07_obligations-reporting-sanctions.md` (anchored to 79_). | no | Takumi S7 (sources watch) | **resolved** (W18 acquisition; W26 gloss de-stale) |
