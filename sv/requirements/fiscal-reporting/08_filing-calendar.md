...
| LB-005 | Normativa de Cumplimiento DTE v2.0, Anexo V + §13.4 (por referencia, vía `e-invoicing/03_events.md` LB-007/LB-005 — los consumidores de eventos): plazos diferenciados de invalidación (CLE/DCLE = primeros 10 días hábiles del mes siguiente al período; NRE/CDE/retorno/OpEsp = 4 días calendario, etc.) y OpEsp dentro de los primeros 10 días hábiles del mes siguiente | DTE Regulation v2.0, Annex V + §13.4 (by pointer via the e-invoicing file's LBs — the event consumers): the differentiated invalidation deadlines and the OpEsp transmission deadline — the consumer FRs SV-EINV-FR-103/SV-EINV-FR-126 own the deadline values, cited by id and not restated here; their hábil-window arithmetic runs on THIS file's engine; the deadline tables are owned by the e-invoicing file | `sv/sources/45_Normativa_Cumplimiento_DTE_v2.0_2026-05-25.pdf` | Anexo V pp.123-135 + §13.4 (via e-invoicing/03 LB-007/LB-005; EVID-084/085) |
| LB-006 | Reglamento de Aplicación del Código Tributario (D.E. N° 117-2001), Art. 100 (co-cited with LB-004 — Ley ISR Art. 62 via `taxation/01_isr-framework.md` LB-027/LB-036) | "Las cantidades retenidas deberán ser enteradas al colector respectivo, dentro de los diez días hábiles que inmediatamente sigan al vencimiento del mes calendario en que se efectúa la retención"; y para remuneraciones pagadas "por día, por período especial, semana o quincena", el agente "deberá consolidar en períodos mensuales, las respectivas retenciones" | 75_ Reglamento CT Art. 100: retained sums enter within the ten días hábiles immediately following the close of the calendar month of retention, with sub-monthly pay cycles (day/special-period/week/quincena) consolidated monthly — the STATUTORY 10-hábiles entero layer, INDEPENDENT of NIT digits, anchoring the remittance deadline (SV-TAX-FR-032; LB-004) whose hábil arithmetic runs on this file's engine (corroborated: taxation/01 LB-027 + LB-036, OQ-001 there resolved) | `sv/sources/75_Reglamento_Codigo_Tributario_DE117.pdf` | Art. 100 p.62 (EVID-351; verified 75_ txt lines 3200-3212) |
...
|----|----------|-----------|-------|--------|
| OQ-001 | SOQ-08 (OWNS the 06-file OQ-005 pointer): due-day windows unpinned — the 2026 calendar's windows are a visual highlighted-cell layer (EVID-186) and the by-NIT-digit day-assignment rule for F-07/F-14 has no normative anchor in the corpus. Extract the visual layer (pdfplumber rects / manual read) or acquire the schedule instrument (calendario resolution / reglamento) before deadline FRs get AC-grade dates; until then FR-199/200 ship the config mechanism with placeholder-only ACs (AC-002). **UPDATE (W17, 2026-08-20, 75_ Art. 100 — LB-006/EVID-351): the statutory 10-hábiles layer is now ANCHORED — retention remittance enters within the ten días hábiles after month-end, INDEPENDENT of NIT digits (taxation/01 LB-027/LB-036 corroborated; that file's OQ-001 resolved) — SOQ-08's statutory-anchor hunt is CONSUMED for that layer; the by-NIT-digit day-windows for F-07/F-14 presentation REMAIN dated config with no normative anchor, so this OQ stays open for them and SOQ-08 itself stays open in the master index (register note updated at T5).** | no | Takumi S3 (sources registry) | open |
