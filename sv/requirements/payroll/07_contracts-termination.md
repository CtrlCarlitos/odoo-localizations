...
| LB-018 | Código de Trabajo, Art. 311 — VOID: the six-month prior-employment requirement "QUEDÓ DEROGADA TÁCITAMENTE ... NO PUEDE PRODUCIR EFECTO JURÍDICO ALGUNO" per sent. 105-2014, D.O. No. 225, Tomo 417, 1-dic-2017 (chamber attribution: Sala de lo Constitucional per the 11_ notes-block header — EVID-209; the sentence print itself names no chamber); the benefit has NO tenure gate — the licencia is always owed | Dead text: any prior-employment minimum for the maternity benefit is unconstitutional-by-derogation; the system may never condition Art. 309 on tenure | `sv/sources/11_Codigo_Trabajo.pdf` | Art. 311 + notes block pp.140-141 (EVID-209) |
| LB-019 | Código de Trabajo, Art. 312: post-licencia medical continuation (suspension with the illness benefits and the job kept); lactancia: "INTERRUPCION DEL TRABAJO DE HASTA UNA HOUR DIARIA [sic: HORA] ... SE PODRÁ FRACCIONAR EN DOS PAUSAS DE TREINTA MINUTOS ... CONTADAS COMO HORAS DE TRABAJO Y REMUNERADAS COMO TALES" (stamp (8); OCR prints "HOUR" — normalized as HORA) | A worker still medically unfit at licencia end continues under suspension with illness benefits and job retention; lactancia = up to one hour's daily work interruption, fractionable into two 30-minute pauses, counted and remunerated as work time | `sv/sources/11_Codigo_Trabajo.pdf` | Art. 312, Arts. 307-313 pp.67-69 (EVID-209) |
...
- **SV-PAY-FR-107:** The system shall compute the fixed-term (plazo)
  ...
  remaining-term pay (the cap only lowers it — corpus-silent
  inference: Art. 59 names only the indefinite-equivalent cap, never
  a floor for the plazo variant). (LB-007; LB-006;
  EVID-207)
...
- **AC-002:** Given an interino whose titular returns on 1-March and
  ...
  responsibility and no indemnización — boundary convention: the
  return date itself does not count (day 1 = the day after return)
  and the effect date is the day following the fifteenth, per
  FR-103's reading of Art. 27's ">15 days" (the CT prints no
  explicit boundary rule — corpus-silent convention) (FR-103).
