...
W19 T5 fold-in (aguinaldo-cap transitories): the four single-year
instruments behind LB-023's vintage limb are in-corpus as PRIMARY
prints — 91_ D.L. 229-2021 (D.O. N° 233 T.433 7-dic-2021; cap $1,100,
year 2021), 92_ D.L. 596-2022 (D.O. N° 231 T.437 7-dic-2022; $1,500,
ejercicio 2022), 93_ D.L. 900-2023 (D.O. N° 225 T.441 30-nov-2023;
$1,500, 2023), 94_ D.L. 159-2024 (D.O. N° 227 T.445 27-nov-2024;
$1,500, 2024) — each declares the CT/CAE aguinaldo renta no gravable
up to its printed cap for its OWN fiscal year, excess retained
DEDUCTING the cap (the D.L. 458-2019 floor-deduction mechanic
unchanged — the cap replaces the floor amount for the year); each is
SPENT with its year and 2025+ reverts to the standing Art. 4.16 2-SMM
rule (OQ-005). LB-023's vintage limb re-anchors to these primary
instruments — VALUES UNCHANGED ($1,100/$1,500 as printed in words;
[sic] fidelity kept); 54_ stays the standing-rule text and the
consolidation-tail navigation co-cite (EVID-167), 53_ the
aggregation/recálculo interface. Evidence: EVID-398..403
(`90-94_Transitorias.evidence.md`, W19 T5 — 90_ D.L. 598-2020 is the
spent COVID deferral, spe/01's historical note; not payroll-relevant
beyond the tail pointer).
...
in `taxation/04_isr-withholding.md` (SV-TAX-FR-120; their $-cap data
now instrument-anchored to the 91_-94_ primary prints — W19 T5,
EVID-398..401). The 15/19/21
...
| OQ-005 | SOQ-05 carried (via taxation/04 OQ-003): does a 2025/2026 aguinaldo transitory exist capping the Art. 4.16 2-SMM exemption at a fixed $-figure? The 54_ related-laws tail lists none after D.L. 159-2024 → SV-TAX-FR-120's 2025+ standing-2-SMM row stands; this file re-verifies at encoding time and owns only the SMM feed provenance (the 02 sidecar row — never the split, which is taxation-owned). **W19 T5 verification (2026-08-22):** the 2021-2024 caps verified against the primary instruments 91_-94_ (EVID-398..401) — each single-fiscal-year spent, none extends beyond its year; no 2025 instrument exists (the 54_ tail's content runs through Jan-2026 and lists none) → the 2025 leg of this watch CLOSES with the standing 2-SMM row; the 2026+ leg stays open (a December-2026 transitory would re-key the vintage row at encoding time). | no | Takumi S4 (sources watch) | open |
