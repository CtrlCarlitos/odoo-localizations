...
- 2026-08-16 (W4 complete) — **Código Tributario READ** (EVID-059..068 in `05_Codigo_Tributario.evidence.md`): document-type system legal roots found (Art. 107-115: CCF/Factura/NR/CL/CR + **thresholds $200 / $11,428.57 / ≤$12 simplificada**; NR→CCF 3-day rule; online-transmission obligation = e-invoicing root); retention matrix (Art. 162: 1% grandes ≥$100, 13% unregistered agro/finance, 162-A 2% cards = DCLE root, 162-B courts; ISR: 155-160 incl. 20%/25% non-resident/tax-haven); books (Art. 141 Compras/Ventas ledger = F-07 feed); sanctions table (238-247: 50%/30% documents, 40% declarations, 75% retentions, FOVIAL 100%); 10-year conservation; 199-A market-price estimation. 3 OQs: colones conversion, simplificada electronic status (check 18_ in W5), electronic correlative assignment (check 26_ in W5). **Next: W5 DTE stack (06, 19, 22, 18-OCR, 26, 27).**
