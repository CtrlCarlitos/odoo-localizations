...
- S3/fiscal-reporting delivered: 8 files + index + CSV sidecar (SV-FREP-FR-001..212; 209-212 appended by the S6 Quincena-25 fold-in) — see `sv/requirements/fiscal-reporting/00_index.md`.
...
- S4/payroll delivered: 8 files + index + 2 CSV sidecars (SV-PAY-FR-001..143; 138-143 appended by the S6 Quincena-25 fold-in) — see `sv/requirements/payroll/00_index.md`.
...
- Resolved contradictions: 28 (R1-R16 S1, R16 flagged [?]; R17-R22 ISR/S2; R23-R24 payroll/S4; R25-R26 commercial-legal/W10 (R26 with W12 addendum); R27 Quincena-25 in-file rulings/S6; R28 AML regime replacement/W12).
- Open questions: S1 = 8 (MOQ-01/03/04/05/06/07/10/11; 19 struck/resolved incl. the 2026-08-17 schema pass); S2 = 7 opened, 4 open (SOQ-02/05/06/07), 3 resolved (SOQ-01/04 in-wave via 03 §7; SOQ-03 2026-08-18 via EVID-171/60_); S3 = 7 opened (SOQ-08..14), 2 resolved (SOQ-09 W11; SOQ-10 carries an applied ruling); S4 = 7 opened (SOQ-15..21); S5 = 8 opened, 3 resolved/delivered (SOQ-22 W12 resolved-with-residual; SOQ-27 W12 resolved-by-restructure; SOQ-28 delivered in-wave (commercial-legal/02 §3.7 retention matrix)), 5 open (SOQ-23/24/25/26 + 29-flags); EV53 OQ-1/OQ-3, EV54 OQ-1/OQ-3 and EV56 set already resolved.
- Evidence corpus indexed: EVID-001..250 (240 reserved-unused; S1 = 001..087 across 7 evidence files + DG45 + ARCH; S2 = ISR files 088..170; S3 = 172..190 + 171 = D.E. 10 gazette verification; S4/payroll = 191..210; S5/commercial-legal = 211..235 + W12 AML re-base 241..250).
