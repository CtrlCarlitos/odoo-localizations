...
| OQ-003 | Exonerations-reglamento leads (origin `26_ OQ-2`, W3 kin — LEAD only here): Acuerdo 462-2014 (exonerations reglamento; its Art. 20 derogated by Acuerdo 817-2018 Art. 2) and Acuerdo 424-2018 (ITA ISV Art. 15.a) are unacquired — ZOLADES/zonas y parques libres detail and any surviving 462-2014 procedure for THIS file's registry (L-Arts 40-44 execution) stay unpinned; never encode from the 817-2018 derogation alone. | no | acquisition queue (W3 kin) | open (LEAD) |
| OQ-004 | RIT D. 2-2026 extension + tourism family (LEAD): master index notes D. 2-2026 extends RIT five more years and the tourism instruments (D. 314-98; D. 17-2010 L-Arts 53-55/R-Arts 63-68) as later-corpus additions — unacquired; FR-271 window rows and FR-274's Turismo catalog entry ship as statute-text rows pending those instruments (regime cutover = dated config rows per D-H2.6). | no | acquisition queue | open (LEAD) |
