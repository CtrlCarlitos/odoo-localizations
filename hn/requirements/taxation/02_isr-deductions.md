...
- **HN-TAX-FR-067:** The system shall apply the additional senior deduction
  ...
  publication in G 31,361 of 21-jul-2007, EVID-337); the row is now
  ACTIVE on the plantilla computation contract (SAR operates the tier;
  stacking is plantilla practice — the statute itself contains no stacking
  bridge, OQ-009). Carried caveats: the beneficiary class is the law's
  "beneficiarios" (60+ OR any-age jubilado per Art. 3, EVID-347 — broader
  than the plantilla's 60-turn gate; encoded per the plantilla, flag
  OQ-009) and an intermediate reform **D. 59-2023 (G 14-feb-2024,
  unacquired)** may touch the credit (top acquisition lead, OQ-009).
  (LB-010; LB-015; EV07:EVID-056; EV95:EVID-337/338/347)
...
| OQ-009 | NEW (V-HN1b, from the `95_` read): (a) intermediate reform **D. 59-2023 (G 14-feb-2024)** — scope unknown, may touch Art. 30.14 (top acquisition lead; until acquired the row rides the 2007 text + plantilla contract); (b) beneficiary-class mismatch — statute = "beneficiarios de la presente Ley" (60+ OR any-age jubilado, Art. 3) vs plantilla/FR-067 "fiscal year turns 60" (encoded per the operative plantilla; a jubilado-under-60 retention case would flag, not compute); (c) STACKING CONFLICT — the L30k "adicional" has NO statutory bridge to the L40k/L80k Art. 13 stack in 95_, 79_ or 01_ (plantilla-only practice; never resolve silently); (d) "crédito" vs "deducción" mechanics + the OCR-damaged expense-tail (flat vs expense-limited — plantilla implements flat). | no (row active on plantilla contract) | acquisition queue (D. 59-2023) + controller ruling (b/c/d) | open |
