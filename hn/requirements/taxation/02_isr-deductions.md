...
unacquired D. 199-2006; the 65+ ≤ L350,000 *de pleno derecho* exemption
...
HN-TAX-FR-154..210, revaluación FRs 184..186); ISV (`06_isv.md`,
...
| LB-010 | Plantilla de Retención sobre Renta 2026 (`11_`), Instrucciones: citan D. 199-2006 (deducción adicional L30,000 ≥60 años — texto legal no adquirido), D. 194-2002 Art. 14 (exención 65+ ≤L350,000, texto reformado en 79_), D. 59-2020 (L80,000) y el "Art. 51 del Reglamento de la Ley de ISR" (deducción de aportes de pensión — reglamento no adquirido) | SAR's official withholding workbook instructions citing the senior-tier instruments: D. 199-2006 (extra L30,000 deduction at age 60+ — statute unacquired), D. 194-2002 Art. 14 (65+ ≤L350,000 exemption, reformed text in 79_), D. 59-2020 (L80,000) and ISR-Reglamento Art. 51 (pension-contribution deduction — regulation unacquired) | `hn/sources/11_Plantilla_Retencion_Fuente_2026.xlsx` | Instrucciones cols C/D (EV07:EVID-056) |
...
- **HN-TAX-FR-067:** The system shall apply the additional senior deduction
  ...
  FR-066 — statutory basis D. 199-2006 UNACQUIRED (plantilla-cited only):
  the tier ships as a dated-config row with UNPINNED valid_from, blocked
  from activation until acquired (OQ-008, kin of `04_isr-withholding.md`
...
| FR-067 | odoo | l10n_hn.isr.parameter | unpinned valid_from row | D. 199-2006 LEAD (OQ-008; kin 04 OQ-002); row inactive until pinned — never guessed |
...
| OQ-008 | Senior L30,000 @60+ statutory basis (kin of 04-file OQ-002, NOT re-carried therefrom): cited only by the plantilla to D. 199-2006 (EV07:EVID-056) — statute unacquired; FR-067 ships the row with UNPINNED valid_from and blocked activation until the instrument lands (D-H2 never-guess). | no | acquisition queue | open (kin) |
