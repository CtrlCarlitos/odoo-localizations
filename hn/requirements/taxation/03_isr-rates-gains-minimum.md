...
| LB-019 | D. 278-2013 (130_), Art. 9 — THE ORIGINAL ART. 22-A TEXT (G 33,316 30-dic-2013; Dado 21-dic-2013, Ejecútese 26-dic-2013, vigencia 01-ene-2014 per Art. 51): "ARTÍCULO 22-A. Las personas naturales o jurídicas domiciliadas en Honduras pagarán el uno punto cinco por ciento (1.5%) sobre los ingresos brutos iguales o superiores a DIEZ MILLONES DE LEMPIRAS (L10,000,000.00) del período impositivo cuando la aplicación de las tarifas señaladas en los literales a) y b) del Artículo 22 de la presente Ley, resultaren menores al uno punto cinco por ciento (1.5%) de los ingresos brutos declarados. La tasa se reducirá al cero punto setenta y cinco por ciento (0.75%) en el caso de los ingresos obtenidos por las personas naturales o jurídicas que produzcan o comercialicen los siguientes productos y servicios: a) Producción y distribución de Cemento; b) Servicios públicos prestados por las empresas estatales; c) Los productos y medicamentos farmacéuticos para uso humano, a nivel de productor o importador; d) Ingresos por producción, venta y distribución de Petróleo y sus derivados; y, e) El sector o industria de panadería." + exclusions (asalariados; <L10M but still Art. 22 + ATN declaration duties; first-2-years/pre-operativo; fuerza-mayor losses 2 exercises w/ auditor certification) + "El impuesto que resulte de la aplicación del uno punto cinco por ciento (1.5%) será la base para determinar las Cuotas de Pagos a Cuenta del periodo fiscal 2014" + losses → D. 96-2012 (**acquired W14 as `168_`: G 32,877 20-jul-2012, vigente 21-jul-2012, EV168:EVID-681..687**) | The 22-A statutory original — regime 0 (FY2014-FY2017) now text-anchored; the five 0.75% sectors here (cement/state-public-services/pharma/petroleum/bakery) are the ORIGINAL list, later re-cast by D. 31-2018's six-sector set (FR-083; the pre/post sector-list split is a dated-row boundary); exclusion b) keeps <L10M taxpayers inside the ATN (D. 51-2003) duties — the ATN survived 2013 (R-H84 corollary); ingresos brutos = totales − descuentos/rebajas/devoluciones | `hn/sources/130_Gaceta_33316_Decreto_278-2013_Ley_Ordenamiento_Finanzas_Publicas.pdf` | D278-Art. 9 (p.5; OCR sidecar de-interleaved; EV130:EVID-485) |
...
- **HN-TAX-FR-082:** The system shall gate 22-A applicability on the
  ...
  0 (FY2014-FY2017), W9-extended from the `93_`+`130_` reads:** FY2017 is
  ...
  **W9 (EV130:EVID-485, the ORIGINAL Art. 9 text acquired): regime 0 runs
  FY2014→FY2017** — the law's own vigencia is 01-ene-2014 (Art. 51) and
  Art. 9's text itself anchors FY2014 ("El impuesto que resulte de la
  aplicación del uno punto cinco por ciento (1.5%) será la base para
  determinar las Cuotas de Pagos a Cuenta del periodo fiscal 2014"); the
  FY2014-2016 quinquennium ran the same original rules (no intervening
  instrument in corpus; LB-019). Fiscal years before 2014 have no 22-A
  regime row (see FR-092 for the L-Art 19 flag). (LB-002; LB-005;
  LB-013; LB-019; EV05:EVID-070; EV29:68_ EVID-109; EV93:EVID-350/351;
  EV130:EVID-485; R-H32)
...
| OQ-006 | GC non-resident retention rate conflict (origin `46_ OQ-1`, register C2 — CONFLICT, R-H26 PARTIAL): `46_` Ayuda prints 2% for the non-resident inmueble/derechos retention vs the 4% of **D. 278-2013 Art. 13** (W9 correction: corpus prints read "D. 273-2013" — a digit misprint; the acquired gazette `130_` carries the 4%-acquirediente retention as Art. 13 of D. 278-2013, EV130:EVID-489) → Eficiencia E-Art 14 (05_/38_ prints). 4% is operative (R-H26); 2% is never encoded and stays flagged until SAR corrects/reconfirms the Ayuda print. | no | controller + S-HN3 (F8 re-print watch) | open |
