...
| LB-025 | **THE CT-131 DESCARGO EXECUTING PAIR ACQUIRED W10** — SAR-125-2024 (`160_`, dado 29-feb-2024, published G 36,499 3-abr-2024) + SAR-43-2026 (`159_`, G 37,077 23-feb-2026): the annual February cuenta-corriente depuración acuerdos — firm State-favor credits whose accumulated monto ≤ 1 salario mínimo promedio vigente at emission are discharged oficio (2024 execution: **L12,377.73** = the 2023 promedio, the 2024-2025 bienio not yet published; 2026 execution: **L13,985.16** = the 2025 promedio, the 2026-2027 bienio not yet published — emission-time umbral resolution twice-demonstrated, D-H2); both recite the promedio in words AND figures; SAR-43-2026's roster line "CÁLCULO EN BASE AL SALARIO MÍNIMO 2025, SUJETO A CAMBIO CON NUEVO SALARIO MÍNIMO 2026" = the future-inception switch made express | FR-037's discharge engine gains both statute anchors + the umbral dated rows (2024: 12,377.73 / 2026: 13,985.16; the 2025 execution = watch, no instrument in corpus); also the promedio-family's official-anchor semantics for payroll/01 LB-023 | `hn/sources/159_Gaceta_37077_Acuerdo_SAR-43-2026_descargo_cta_cte.pdf` + `hn/sources/160_Gaceta_36499_Acuerdo_SAR-125-2024_descargo_cta_cte.pdf` | EV159:EVID-634..638; EV160:EVID-639..643 |
...
- **HN-TAX-FR-037:** The system shall mark, each February, firm credit
  ...
  **W10 statute anchors (LB-025): BOTH executing instruments now in corpus
  — SAR-125-2024 (`160_`, dado 29-feb-2024, G 36,499 3-abr-2024: firm
  credits to 31-dic-2023 ≤ L12,377.73 = the then-vigente 2023 promedio)
  and SAR-43-2026 (`159_`, G 37,077 23-feb-2026: credits accrued to
  31-dic-2025 ≤ L13,985.16) — the "vigente a la fecha de emisión"
  resolution demonstrated twice (each February execution used the
  promedio in force THEN: the bienio incepting later in March does not
  retro-move the umbral); accrual cut-off semantics = 31-dic of the year
  before emission (159_ prints it; 160_'s cut-off leg inferred from its
  Anexo-A population, OQ-flagged in `159-160_` evidence).**
  (LB-014; LB-025; EV03:EVID-034; EV159:EVID-634..638; EV160:EVID-639..643;
  R-H12)
