...
HN-PAYR-FR-051..090; this file supplies only the SMM rows it consumes); IHSS
cotizaciones and incapacidad (files 03/04, HN-PAYR-FR-101..135/141..170);
RAP/fondo (file 05, HN-PAYR-FR-181..215); jornada (file 06,
HN-PAYR-FR-221..250); vacaciones (file 07, HN-PAYR-FR-261..280);
cesantía/preaviso (file 08, HN-PAYR-FR-291..325); suspension/maternity (file
09, HN-PAYR-FR-331..360); the Código del Trabajo chassis and salary/records
...
- **HN-PAYR-FR-035:** The system shall supply — by id, no re-derivation —
  ...
  HN-PAYR-FR-051..090): the *aguinaldo* (13th-month bonus) / *décimo cuarto
...
| FR-035..FR-037 | odoo | lookup API consumed by sibling files | interfaces | File 02 (HN-PAYR-FR-051..090) incl. the 02/95-Art. 6 SMM-average variant; T11 multa unit via EV81:EVID-261 pointer; files 03-05/07/08/10 by FR range — id consumption only |
...
| OQ-003 | 90_ OQ-3: 2027 gazette table OCR gaps — agricultura 11-50 (full row), financieros 11-50 (full row), ~13 jornada/hora cells and the restaurantes 1-10 digit uncertainty are reconstruction_blocked; reconstruction candidates exist arithmetically (EVID-224) but load only after visual confirmation of the gazette or a clean DGS 2027 print. | no | Takumi S-HN4 (P1) | open |
