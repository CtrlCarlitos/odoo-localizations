...
| FR-248, FR-249 | odoo | hr.salary.rule SEPTIMO_DIA variants + hr.contract séptimo-día class flags | statutory valuation + deemed-inclusion/forfeiture/stacking | W5 (D. 112-1982, valid_from 1982-11-01; D. 36-90 row from 1990-05-11 — G 26,131 pinned W7, R-H82); additive dated rows; OQ-006 carries the Art.-1 reform reversibility caveat from file 02 |
...
| OQ-002 | `EV85:86_ OQ-9` carried — feriado-list currency: Art. 339's 10-holiday list is 1960-vintage text (D. 275-1960 per fn.31); no post-2013 in-print amendment was found, but the spot-check for any post-2013 holiday change (additions/replacements) must complete before the seeded calendar rows are treated as exhaustive beyond their valid_from window (FR-236 carries the flag as row metadata). **W12 refinement (`EV167:EVID-679`): the 1959 ORIGINAL print shows the 8+3 list VERBATIM IDENTICAL to the current text — the D.L. 116/275-1960 pair reformed the MECHANICS (÷6 average interp + collision rule + implicit-inclusion), NOT the dates; list vintage = 1959-07-15 (whole-life), mechanics vintage = 1960 (dated rows); the 1960 texts remain unacquired (Anexo class — the instruments were already identified by fn.31; their texts add precision only).** | no | Takumi S-HN4 + controller | open |
