...
- **HN-PAYR-FR-302:** The system shall cap the cesantía at 25 months'
  ...
  (W12, LB-015): the ORIGINAL 1959 cap = 8 months — the 25-month row is
  valid from 2008-11-05 (D. 150-2008); terminations dated before that use
  the pre-2008 chain (8 meses from 1959-07-15; the 1990-2008 window after
  D. 247-89's "ampliación" = OQ-008, cap value unpinned — practically
  muted by the 2-month prescription of Art. 864).
  (LB-007; LB-015; EV85:EVID-305; EV167:EVID-676)
...
| OQ-008 | NEW (W12, `EV167:167_ OQ-2`): the cesantía cap's 1990-2008 window — the 1959 original caps at 8 meses (LB-015/EVID-676) and D. 150-2008 sets 25/15 (LB-007 fn.19, valid 2008-11-05+), but D. 247-89 (G 26,028 6-ene-1990, subject "AMPLIACIÓN DE AUXILIO DE CESANTÍA" per `119_` EVID-430) sits between with its text quote-nowhere — whether it moved the cap between 8 and 25 is UNPINNED. Terminations dated 1990-01-06→2008-11-04 encode cap = config-gap (practically muted by Art. 864's 2-month prescription — no live computation reaches the window); acquire D. 247-89 to close (already the W7 live residual, watch class). | no | acquisition queue (D. 247-89 watch) | open |