...
| LB-015 | **CT ORIGINAL 1959 print (W12)** — the D. 189-1959 promulgation pin + the ORIGINAL Art. 120/116-119 baseline | **Promulgation (book p.183):** Art. 875: "Este Código empezará a regir desde el día de su publicación en el Diario Oficial 'La Gaceta'"; footnote: "Publicado en La Gaceta números 16.827, 16.828, 16.829, 16.830, 16.831, 16.832, 16.833, 16.834, de 15, 16, 17, 18, 20, 21, 22 y 23 de julio de 1959" → **vigencia 15-jul-1959**; Dado 19-may-1959; Ejecútese 10-jun-1959. **Original Art. 120:** ladder a)-c) ≡ current (10d/20d/1mo+fraction); **d) "En ningún caso podrá exceder dicho auxilio del salario de ocho (8) meses"** (≠ current 25 — the 25/15 caps + lit. g) arrive with D. 150-2008 per fn.19/LB-007); e) ≡ current; **f) original three exclusions with "valor actual"** (vs current "valor actuarial"; NO lit. g) in the original). **Original Arts. 116-119 preaviso:** ladder ≡ current (24h/1w/2w/1m/2m — unchanged since 1959); + the 1-day/week paid job-search licencia during notice; Art. 118 omission asymmetry: worker-fault = ½ notice salary, patrono-fault = full; Art. 119 term runs from the day after notification. **Original Art. 95.13:** coop/cajas deductions = "trabajadores sindicalizados" only (60-A/1973 and the current 95.12 cross-ref are later inserts) | `hn/sources/167_Codigo_Trabajo_D189-1959_original.pdf` | Promulgation + Art. 875 + derogations book p.183 (EV167:EVID-673); Arts. 116-120 pp.38-39 (EV167:EVID-675/676); Art. 95 numerals 12-13/16 pp.26-27 (EV167:EVID-674) |
| LB-016 | **D. 247-89 FULL TEXT (W14, `175_` the ≈1993-94 CT edition's ANEXO — the quote-nowhere residual CLOSED)** — the Art. 120 REPLACEMENT | **Head:** "DECRETO NÚMERO 247-89 … CONSIDERANDO: Que es necesario ampliar el auxilio de cesantía de que gozan los trabajadores… Articulo 1º.- Modificar el Articulo 120 del Código de Trabajo, contenido en el Decreto No. 189, del 19 de mayo de 1959, el que se leerá así:" → replacement ladder a)-c) ≡ 1959 originals; **d) "En ningún caso podrá exceder dicho auxilio del salario de quince (15) meses"**; **f) the SIX-CAUSE negative list with "valor actuarial"** ("…cuyo valor actuarial sea equivalente o mayor a la expresada indemnización por tiempo servido; ni cuando el trabajador quede por el mismo hecho del despido acogido a los beneficios del Seguro contra el desempleo involuntario de esta última institución; o cuando en caso de fallecimiento del trabajador por un riesgo profesional el patrono demuestre que tenía asegurado a éste contra dicho riesgo; o cuando el deceso del trabajador ocurra por otra causa y el fallecido estuviere amparado contra el riesgo de muerte en el mencionado instituto"). **Art. 2º:** "entrará en vigencia a partir de la fecha de su publicación en el Diario Oficial 'La Gaceta'" (G 26,028 6-ene-1990 per W7/EVID-430 → **vigente 6-ene-1990**). **Dado 15-dic-1989** (Montoya/Melara/Rosales); **Ejecútese 21-dic-1989** (Azcona Hoyo; Trabajo secretary Rosales Abella — the fuller signature block supersedes the W7-era Discua attribution, cosmetic) | `hn/sources/175_Codigo_Trabajo_189-59_reformas_hasta_1993.pdf` | D247 full text (EV175:EVID-712..714); the ≈1993-94 edition identity + the ~24 appendix decrees inventory (EV175:EVID-710/711/715..718) |
...
- **HN-PAYR-FR-302:** The system shall cap the cesantía at 25 months'
  ...
  veinticinco (25) meses"), applied after proration. Dated-row baseline
  (COMPLETE W14): **cap lineage = 8 meses (1959-07-15, original print
  LB-015) → 15 meses (1990-01-06, D. 247-89's replacement Art. 120 lit. d
  "quince (15) meses" — LB-016) → 25 general / 15 micro (2008-11-05,
  D. 150-2008, whose micro-tier 15 = the direct continuation of 247-89's
  number)**; terminations dated 1990-01-06→2008-11-04 use the 15-month cap
  (practically muted by the 2-month prescription of Art. 864 — historical
  rows only).
  (LB-007; LB-015; LB-016; EV85:EVID-305; EV167:EVID-676; EV175:EVID-712)
...
- **HN-PAYR-FR-305:** The system shall compute the ≥15-year voluntary-quit
  ...
  when none of the three carve-out predicates of the D. 150-2008 final ¶
  exists: no Art. 112 circumstances, not under lit. f) benefits, and not
  under equal-or-superior benefits of ANOTHER employer-contributing system
  (the CT-side twin of the RAP/fondo interplay — the statutory bridge for
  why the CT 35%/75% and the fondo complements of file 05 never double-pay;
  predicate anchored to the instrument original at W5).
  (LB-007; EV85:EVID-305; EV106:EVID-381)
...
| OQ-008 | ~~NEW (W12, `EV167:167_ OQ-2`): the cesantía cap's 1990-2008 window…~~ **RESOLVED W14 (R-H93): D. 247-89's full text acquired in `175_` — the replacement Art. 120 lit. d caps cesantía at QUINCE (15) MESES, vigente 6-ene-1990 (publication day per Art. 2º); the "valor actual"→"valor actuarial" drift pins to 247-89's own replacement lit. f); cap lineage complete 8→15→25/15 (LB-016; FR-302; EV175:EVID-712..714).** | no | resolved (W14) | resolved |