...
| LB-025 | **W16: `184_` = the FORMATO FA-01 amnistía application form** (the LIVE chain's operational front-end — motives convenio/depuración; Control-Patronal verification; **the three-item scope banner on a 2024/05 upload = the 44-2025 two-item print was a drafting DROP, the operational scope three-item throughout** — annotates LB-022's scope-chain; the form's "D.L. 7-2024" header citation = OQ-flagged, likely the pre-enactment bill number of 44-2025, never a statute row) + **the reformed Ley-RAP Art. 61 RESOLVED in-corpus W16** (169_ p. A.9 @600dpi: "ARTICULO 61.- DE LA DEROGATORIA: Queda derogada toda disposición que se oponga a lo dispuesto en la presente Ley" — the blanket replaces the original's D. 167-91 exception, confirming R-H85/EV120) | The amnistía procedure's form layer + the RAP-reform tail closure | `hn/sources/184_Formato_FA-01_Amnistia_IHSS.pdf` | EV184:EVID-743 |
