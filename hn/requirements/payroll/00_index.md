...
economics] + the LIVE chain `163_` D.L. 44-2025 Art. 2 → `164_` D.L. 78-2026
Art. 2 [scope recargos/multas/intereses; window 12-jun-2026→12-oct-2026] →
`165_` Res. SOJD-IHSS-016-2026-XIII the reformed reglamento [L15,000 gate;
0%/12% interest tracks; prima 10-35%; 120/96-month exceptions; 6-month
processing tail; judicial + MP default enforcement] — located via the W11 ENAG
full-text scan, which also adjudicated the 2026-ceiling watch NEGATIVE
[no JD techo act dic-2025→ago-2026; AC-006's blocking state = live]).
