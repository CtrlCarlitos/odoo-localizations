...
| LB-026 | **D. 74-95 — TEXT ACQUIRED W8 as `129_`** (G 27,655, May-1995; masthead digits OCR-damaged — prints "27,685", 27,655 kept per R-H81 monotonicity, 129_ OQ-5; Dado abril-1995 600dpi-converged; Ejecútese 15-may-1995 Reina): Art. 1 — "Interpretar el Articulo 34 del Decreto nimero 135-94 del 12 de octubre de 1994, en el sentido de que el pago del Décimo Cuarto Mes de Salorio, en concepto de Compensación Social a partir de 1995, deberd hacerse efectivo en el mes de junio de cada año y será del cien por ciento (100%) del salario si al 30 de junio se ha cumplido el año de trabajo continuo con el mismo empleador o la proporción del mismo de conformidad al tiempo trabajado, si a dicha fecha no se cumplen los doce (12) meses de servicios continuos" | The FR-057 gate's statutory text (was inventory+footnote-pinned; now statute). W7's "routes A-D exhausted" claim corrected — the file was in the W6 leyesdehonduras CDX batch all along (119_ OQ-3 W8 update) | `hn/sources/129_Gaceta_27655_May1995_Decreto_74-95_interp_Art34_135-94.pdf` | whole file (1 p) (EV129:EVID-476) |
...
- **HN-PAYR-FR-057:** The system shall evaluate the 100%-vs-proportional gate
  ...
  D. 74-95 G 27,655 18-may-1995, NOT D. 54-95. W8: the decree TEXT is now
  ACQUIRED as `129_` — the interp reads verbatim "deberá hacerse efectivo en
  el mes de junio de cada año y será del cien por ciento (100%) del salario
  si al 30 de junio se ha cumplido el año de trabajo continuo con el mismo
  empleador o la proporción…"; statute-anchored, gazette pin corroborated).
  (LB-002; LB-025; EV82:EVID-238; EV119:EVID-429; EV129:EVID-476)
