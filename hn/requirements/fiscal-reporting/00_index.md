...
June-2024 prorroga HISTORICAL rows); file 04 OQ-003 RESOLVED + LB-014
(D. 7-2017 = the OTCD 50%→10%/15% middle instrument — FR-147's toggle
statute-dated); file 10 OQ-005/OQ-006 RESOLVED + LB-014/015 (DEI-SG-004-2016
the USD-1M TP gate — FR-327 statute-anchored; SAR-653-2023 the CbCR regime —
threshold EUR-750M-o-L19,000M, TRANSITORIO-suspended local filing, 31-dic
notification; new OQ-024/025); file 11 LB-013 (D. 92-2015 — the 509 reform:
reservas-tail = reform text, sanctions chassis, promedio-at-infringement
sanction measure) + OQ-009 instruments-complete (the 506-vs-509 boundary now
...
| [04_otcd-tarjetas-215-523.md](04_otcd-tarjetas-215-523.md) | OTCD card-family declarations: 215 determinativa (10%-of-ISV − devolución 8%, pago-parcial) + 523 SW-only per-transaction informativa + SAR-240-2024 IX-XIII per-merchant detail; both OUTSIDE the DJIMR catalog (R-H16) (F4) | HN-FREP-FR-121..148 | 28 | 14 | 15 | 9 |
