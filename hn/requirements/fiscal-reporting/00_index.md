...
| Status  | draft (S-HN3 synthesis wave, in review) |
...
[../COVERAGE.md](../COVERAGE.md) (to be generated at S-wave validation,
with S-HN4).
...
|------|------------------|----------|-----|-----|-----|-----|
| [01_filing-chassis-due-days.md](01_filing-chassis-due-days.md) | OVI/SW chassis, declaration lifecycle (alta→borrador→juramento→acuse/CSV+QR→estado→Pagar/Boletín), dual-channel sticky modality, rectificativa frame, D-H3.2 go-live reconciliation + the SHARED due-day/hábil-calendario engine (F1) | HN-FREP-FR-001..032 | 32 | 21 | 15 | 14 |
| [02_djimr-retention-declarations.md](02_djimr-retention-declarations.md) | DJIMR/DMR per-código monthly informativa → SER determinativa, 25-code catalog (`djimr_retention_codes.csv` sidecar), de-oficio rectificativa propagation, per-código casilla surfaces 111-138/217 (F2) | HN-FREP-FR-041..075 | 35 | 21 | 18 | 24 |
...
| [07_isr-annual-102-103.md](07_isr-annual-102-103.md) | The 30-abril package: 102 PN (vinculación auto-flow, credit panel) + 103 PJ (ISV-split revenue, 50% loss gate, 535 prerequisite) + AS 5% RNG>L1M PJ-only + ATN 1% w/ L3M exemption + 75_ minimum-exempt suspension (F7) | HN-FREP-FR-221..264 | 44 | 14 | 18 | 16 |
...
| [09_selectivo-declarations.md](09_selectivo-declarations.md) | Selectivo declarations 203 (D. 58-1982 separate statute) / 211 cigarettes per-millar / 210 gaseosas / 205 alcoholes / 204 cerveza / 259 turística 4% + the IPC value chain 172-2022→014-2023→218-2024 as DIRECT-cited dated rows (F9) | HN-FREP-FR-296..325 | 30 | 12 | 20 | 14 |
| [10_tp-545-informativas.md](10_tp-545-informativas.md) | TP 545 DJIAPT (USD 1M pequeño gate, 56 op types → 10 annexes, interquartile range, Ajuste-PT write-back) + informativas 541 socios / 542 alquiler / 543 municipalidades (F10) | HN-FREP-FR-326..360 | 35 | 11 | 16 | 24 |
...
| **Total** | | HN-FREP-FR-001..393 | **362** | **154** | **188** | **169** |

Numbering note: FR ranges pre-allocated per file (subagent dispatch
pattern); unused tails (033-040, 076-085, 116-120, 149-150, 188-190,
219-220, 265, 294-295... reserved) stay reserved for later additions — no
renumbering. The `djimr_retention_codes.csv` sidecar carries the 25-code
...
- **Open conflicts of record (never resolved silently):** GC non-resident
  ...
  D. 117-2021 identity (`63_ OQ-4`); 116 base-legal moving budget-law
  target (`36_ OQ-1`).
- **Blocking OQs:** only file 11's 506-vs-509 boundary (`60_ OQ-1`,
  statute texts unacquired) is marked yes-blocking within the wave; SEE
  remains the cross-wave blocker (S-HN2, lead 1).
- **Cross-wave dependencies:** S-HN4 payroll consumes file 02's 111
  columns + file 01's chassis; validation wave (COVERAGE.md + adversarial
  review) runs when S-HN4 lands (per-template Stage 5); `01_ OQ-6`
  FY2026 composite gate re-pins from file 07's window rows when SAR
  prints the value.

## Open-questions summary

169 open OQs (wave total), highest-leverage LEADs: Reglamento Ley ISR
