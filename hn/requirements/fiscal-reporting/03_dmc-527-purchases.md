...
as-published, W9: likely never effectively current) → 20 días
transitional (SAR-256-2024, may/jun/jul-2024 periods) → **8 días
calendario from the august-2024 period (SAR-256-2024 SEGUNDO/TERCERO,
CURRENT — W9/EV134:EVID-506; R-H18 superseded: the manuals' 8d was
never stale)** — and the DMC-before-ISV/DJIMR sequencing (R-H36); the field-level **line
...
| LB-008 | SAR Ayuda DMC-527 §I.5 + Generalidades DMC §2 vs SAR-237-2024 dispositive text — **W9 ADJUDICATION: the manuals were RIGHT** | Manuals print: "debe presentarse dentro de los primeros ocho (8) días calendario del mes siguiente a[l] que [...] se efectuaron las compras internas o las importaciones, de conformidad con el Acuerdo N.º SAR-237-2024" — while SAR-237-2024's own gazette text said "cinco (05) días calendarios" (LB-005). **W9 (SAR-256-2024 acquired as `134_`, EV134:EVID-506): the manuals cite the plazo AS REWRITTEN** — SAR-256 SEGUNDO rewrites SAR-237 ordinal 2.3 to "dentro de los primeros ocho (08) días calendarios" and TERCERO phases it in from the AUGUST-2024 period (2-month adaptation window for the may/jun/jul-2024 transitional 20-day rows). The manuals' SAR-237 attribution stays imprecise (the 8d = SAR-256's rewrite) but the VALUE is the current law; 72_'s OVI-only print now also matches SAR-256's channel cutover | The W2 stale-print conflict RESOLVED AS NOT-STALE on the 8-day value: both gazette texts govern (SAR-237's 5d as-published → SAR-256's 8d rewrite); manuals kept | `hn/sources/45_Ayuda_DMC.pdf`, `hn/sources/72_Generalidades_DMC.pdf`, `hn/sources/134_Acuerdo_SAR-256-2024_fecha_aplicacion_236-240.pdf` | 45_ §I.5 p.6; 72_ §2/§4 pp.2-3 (EV43:EVID-144; EV43:EVID-143); SAR256-SEGUNDO/TERCERO pp.A.4-A.5 (EV134:EVID-506) |
...
- **HN-FREP-FR-091:** The system shall encode the DMC presentation deadline
  ...
  calendario, OQ-002)} → {2024-05-20 (SAR-237-2024, G 36,538):
  first **5 días calendario** as published — likely never effectively
  current (see W9 rows)} → {may/jun/jul-2024 periods (SAR-256-2024
  PRIMERO 2nd bullet, transitional): first **20 días**, channels may-2024
  DETLIVE 5.5 / jun-jul-2024 OVI} → {from the AUGUST-2024 period
  (SAR-256-2024 SEGUNDO/TERCERO, G 36,580 8-jul-2024): first **8 días
  calendario** — CURRENT}, with CPAT-SG-073-2016 repealed (CUARTO) and
  the non-modified parts of DEI-SG-276-2015 + SAR-343-2019 expressly
  surviving (QUINTO). W9: the 5d row's effective-life question (whether
  the may-2024 period's ~5-jun deadline ever bit before SAR-256's
  29-may emisión / 8-jul gazette) is enforcement-unpinned — encode the
  dated rows as stated, flag the gap (`134_` OQ-3). (LB-002; LB-003;
  LB-005; LB-008; EV13:EVID-082/083/090; EV134:EVID-505/506; R-H17)
- **HN-FREP-FR-092:** The system shall implement the manual-vs-gazette
  guard as W9-RESOLVED (R-H18 superseded in part): the "ocho (8) días
  calendario" printed by the Agosto-2026 Ayuda (`45_`) and `72_` was
  NEVER stale — it is SAR-256-2024's rewrite of SAR-237's ordinal 2.3
  (LB-008; EV134:EVID-506), in force from the august-2024 period; the
  8-day value loads as the CURRENT dated row (FR-091 chain tail) with
  its TRUE instrument attribution (SAR-256, not SAR-237 — the manuals'
  attribution is corrected in the row's note, never by editing their
  text). Residual guard: any FUTURE plazo change must arrive as a new
  dated row per D-H2. (LB-005; LB-008; EV13:EVID-090; EV43:EVID-144;
  EV134:EVID-506; R-H17; R-H18 partial-supersede)
...
| OQ-004 | `45_ OQ-1` residual (also `72_ OQ-1`): **RESOLVED W9** — the post-May-2024 acuerdo setting 8 días EXISTS: SAR-256-2024 (G 36,580 8-jul-2024) SEGUNDO rewrites SAR-237 ordinal 2.3 to 8 días calendario, phased from the august-2024 period with 20-day transitional rows for may/jun/jul-2024 (`134_`, EV134:EVID-505/506). FR-091 chain re-seeded; FR-092 guard rewritten (R-H18's "manuals stale" reading superseded — they were current). Residual: whether the 5-day rule ever bit for the may-2024 period = enforcement-unpinned (`134_` OQ-3), flag-only. | no | — | resolved (W9) |
