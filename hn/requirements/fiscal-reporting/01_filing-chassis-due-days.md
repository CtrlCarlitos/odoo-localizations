...
| LB-022 | **W10 PAIR** — SAR-239-2024 (`153_`, dado 10-may-2024, G 36,538 20-may-2024 pp. A.41-44 running-header pin): the **CETF retenciones/percepciones informativa system** — financial institutions (agentes de percepción per Reglamento-1775-2011 Art. 11) report the DETAIL of CETF retentions/percepciones on the sujetos pasivos through an automated per-period system riding the SAR-236-2024 chassis; **cadence = QUINCENCAL** ("quincenal" informing of realized retentions AND percepciones — a new cadence class in the due-day engine, distinct from the monthly/annual families); replaces the DEI-SG-110-2012 (13-nov-2012) procedure ("dejando sin valor y efectos"); authority chain D. 194-2002 Art. 45 + LSP D. 105-2011 Arts. 4/5/39. **SAR-283-2024** (`154_`, dado 27-jun-2024, G 36,580 8-jul-2024 edition): PRIMERO — the 30-jun-2024 pagos-a-cuenta cuota prorrogued to **4-jul-2024**; SEGUNDO — generic prorroga of June-2024-dated declaration/payment deadlines (no tax list printed — the SAR-256-2024 OVI-transition context); HISTORICAL one-off dated rows | The due-day engine gains the quincenal CETF informativa cadence (banks-side, feeds FREP/11's CETF family) + the June-2024 prorroga as HISTORICAL rows (never recurring); DEI-SG-110-2012 joins the derogated-procedure ancestry | `hn/sources/153_Acuerdo_SAR-239-2024_CETF_retenciones_informativa.pdf` + `hn/sources/154_Acuerdo_SAR-283-2024_prorroga_pagos_cuenta.pdf` | EV153:EVID-603..608; EV154:EVID-609..611 |
