...
| LB-009 | Ley de Ordenamiento de las Finanzas Públicas (D. 278-2013), Arts. 20 y 21 — **LEAD (unacquired)** | Cited in the 41_/42_ base-legal lists (both articles) and the 71_ row (Art. 21); Art. 20 = the six-month devolución suspension (~30-dic-2013) recorded as suspension history by taxation/06 HN-TAX-FR-255 — consumed by id; when-it-applies instrument of `41_ OQ-3` | `hn/sources/41_Ayuda_ret_ISV_tarjetas_215.pdf` | 41-§I.7 p.6 (EV31:EVID-123); 71-§3 p.3 (EV31:EVID-125) |
...
| OQ-003 | `41_ OQ-3` (carried, C2) [LEAD]: devolución 8% WHEN it applies — D. 113-2011 Art. 3 / LET (D. 51-2003) Art. 18 / D. 278-2013 Arts. 20-21 all cited in the base-legal lists, NONE acquired; narrows `05_ OQ-1` (C1; primary home taxation/06 OQ-005). FR-147 ships the dated-toggle reading; acquire the instruments. | no | acquisition queue | open |
