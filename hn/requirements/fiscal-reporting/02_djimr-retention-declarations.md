...
| LB-019 | **D. 99-93 — ACQUIRED W8 as `128_`** (gazette 9-jul-1993, edition No. invisible — 128_ OQ-1): the FX-repatriation benefits decree — Art. 5-class benefit = interests on repatriated foreign-currency deposits (the código-115 exclusion's mechanism); Art. 3 FY-cap (each decree-year window — whether 71_'s live listing is carryover or extension = 128_ OQ-4); Art. 6 denial where criminal-origin indicia; Art. 7 SEFIN reglamenta; Art. 8 derogation | The 115-exclusion family's D. 99-93 leg statute-pinned (with `117_` = D. 110-93 from W6, all three exclusion origins are now in corpus — FR-073's config-gate flags carry statutory anchors) | `hn/sources/128_Gaceta_9jul1993_Decreto_99-93.pdf` | whole file (1 p) (EV128:EVID-474/475) |
...
| LB-022 | **D. 110-93 ORIGINAL (W6, `117_`)** — Ley de Simplificación de la Administración Tributaria, Dado 20-jul-1993, Ejecútese 30-jul-1993, gazetted 14-ago-1993, **vigencia +1 day → 15-ago-1993** (unusual clause, EVID-425): Arts. 9-12 the intereses block FULL verbatim — Art. 9: enumerated-instrument interest incomes "estarán gravadas con una tarifa del diez por ciento (10%) calculada sobre el total de dichas rentas"; Art. 10 pago-o-crédito retention moment + 10-day entero; Art. 11 no-summation rule; **Art. 12: the L50,000 savings-account exemption with the excess recovered at Ley-ISR Art. 22** (EVID-426) | The código-115 statutory core now in corpus: 10% tarifa + retention moment + the Art. 12 monto exclusion (excess-only — same semantics family as the ISR 10-SMM caps). Still cited LIVE by 35_/71_ (2024-2026 prints name D. 110-93 Art. 9 as base legal); no corpus instrument derogates Arts. 9-12. | `hn/sources/117_Gaceta_1993-08-14_Decreto_110-93_Ley_Simplificacion_Tributaria.pdf` | 110-93-Arts. 9-12 (pp.2-3); identity + date blocks (p.4) (EV115:EVID-425; EV115:EVID-426) |
...
- **HN-FREP-FR-073:** The system shall carry the 115 exclusion set —
  ...
  (config gap, OQ-009). **W8: BOTH instruments now acquired** — D. 110-93
  (`117_`, W6) and **D. 99-93 (`128_`, gazette 9-jul-1993, EV128:EVID-474:
  the FX-repatriation benefits decree; interests on repatriated
  foreign-currency deposits = the exclusion's benefit mechanism, with the
  Art. 6 criminal-origin denial and the Art. 3 FY-window cap — whether
  71_'s live exclusion listing is carryover or a later extension stays a
  read-side flag, 128_ OQ-4)**; the flags' statutory anchors are pinned,
  activation = the adjudicated exclusion semantics at synthesis review.
  (LB-012; LB-018; EV31:EVID-117/125; EV128:EVID-474/475)
...
| OQ-009 | 115 exclusions (origin `35_ OQ-1`): the three exclusions (banks→Art. 22; D. 99-93 FX deposits; D. 110-93 Art. 12 monto) appear only in 71_; no OVI casilla encodes excluded-interest reporting. **W8: D. 110-93 (`117_`) + D. 99-93 (`128_`, EV128:EVID-474/475) BOTH ACQUIRED** — the exclusion mechanisms are now statute-pinned (99-93 = FX-repatriation interest benefits, FY-capped, criminal-origin-denied); residual read-side flag = whether 71_'s listing is carryover or extension (128_ OQ-4). | no | controller W8 | open (mechanism pinned) |
