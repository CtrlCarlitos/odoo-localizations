...
| OQ-005 | Safe Harbour scope (origin `63_ OQ-5`; NARROWED W9): 027-2015 Art. 38 = the OECD-Directrices INCORPORATION clause (technical reference only, not itself a safe-harbour rule — EV141:EVID-533); the safe-harbour content rides OECD §4.93-4.95 as incorporated + whatever DEI-SG-004-2016 says (still unacquired). No FR implemented from it until that instrument lands. | no | acquisition queue (narrowed) | open |
| OQ-006 | TP family acquisition → **LARGELY RESOLVED W9**: D. 232-2011 + Acuerdo 027-2015 + D. 62-2019 ACQUIRED as `140_`/`141_`/`142_` (LB-LB-013; methods, criteria, sanctions, deadlines statute-pinned). REMAINING: DEI-SG-004-2016 (the USD-1M pequeño gate's own instrument + safe-harbour legs) + SAR-653-2023 (CbCR criteria) — both stay acquisition leads. | no | acquisition queue (narrowed) | open |
