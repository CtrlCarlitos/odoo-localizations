...
mechanics (fiscal-reporting file 01, cluster F1 — not yet on disk;
...
- **HN-FREP-FR-326:** The system shall compute the 545 filing-obligation
  ...
  *pequeños contribuyentes* (small taxpayers) — obliged only when
  ...
  benefit holders — the "Decreto No 117-2021" citation carries an identity
  conflict, OQ-004) or with residents of *países catalogados como paraíso
  fiscal* (tax-haven-listed countries — catalog = dated config, source
  instrument unacquired). (LB-001; EV63:EVID-176)
- **HN-FREP-FR-327:** The system shall store the pequeño-segment threshold
  ...
  at or below USD 1,000,000 accumulated ("igual o inferior",
  DEI-SG-004-2016 Acuerda Primero — lead instrument).
...
|----|-------|------------|----------|------------------------------|
| FR-326, FR-327 | odoo | l10n_hn.fiscal.parameter + obligation generator | trigger matrix + threshold row | D-H2: threshold lempira value snapshot at 31-dic BCH rate per declared FY; D. 117-2021 identity + paraíso catalog = config-gapped (OQ-004) |
...
| OQ-004 | "Decreto No 117-2021" benefits regime (origin `63_ OQ-4`, CONFLICT): corpus `89_` D. 117-2021 = CT Art. 113.1 interpretive decree, NOT a benefits-regime law — same number different instrument, or Ayuda citation error? Blocks the FR-326 special-regime trigger's catalog identity. | no | acquisition queue | open |
| OQ-005 | Safe Harbour scope (origin `63_ OQ-5`, LEAD): the 63_ p.4 section is a bare citation (DEI-SG-004-2016; 027-2015 Art. 38; OECD 4.93-4.95) with no operational content — no FR implemented from it until the instruments land. | no | acquisition queue | open |
| OQ-006 | TP family acquisition (origin `63_ OQ-6`, LEAD): D. 232-2011 (Ley PT), Acuerdo 027-2015 (Reglamento), DEI-SG-004-2016 (thresholds), SAR-653-2023 (CbCR criteria "Numeral I y II del Acuerda Segundo") + the D. 117-2021-benefits identity — none in corpus; every law-side semantic (method selection rules, Safe Harbour, CbCR thresholds, sanction procedure) stands on the Ayuda contract until acquired. | no | acquisition queue | open |
| OQ-007 | Vinculación criteria table image-only (origin `74_ OQ-2`, shared with file 07 OQ-009; LEAD): participation percentages live in Reglamento Arts. 11-13 and were not extractable — FR-334 consumes the catalog codes only; criteria stay unencoded. | no | acquisition queue | open |
