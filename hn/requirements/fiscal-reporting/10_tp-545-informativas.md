...
| OQ-006 | TP family acquisition (origin `63_ OQ-6`, LEAD): D. 232-2011 (Ley PT), Acuerdo 027-2015 (Reglamento), DEI-SG-004-2016 (thresholds), SAR-653-2023 (CbCR criteria "Numeral I y II del Acuerda Segundo") — none in corpus (the D. 117-2021 identity leg is RESOLVED, OQ-004; `89_` read at V-HN1); every law-side semantic (method selection rules, Safe Harbour, CbCR thresholds, sanction procedure) stands on the Ayuda contract until acquired. | no | acquisition queue | open |
