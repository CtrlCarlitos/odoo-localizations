...
| LB-012 | **D. 131-98 — ACQUIRED W6 as `116_`** (La Gaceta 20-may-1998, No. ≈28,566 OCR-tentative; full statute = **Ley de Estímulo a la Producción, a la Competitividad y Apoyo al Desarrollo Humano**): **Art. 43 FULL original** — "…créase la TASA DE SERVICIOS TURISTICOS. La tasa será de cuatro por ciento (4%) sobre el precio de alojamiento diario en hoteles; del precio por el arrendamiento de vehículos para fines turísticos; y, sobre el precio de los servicios prestados por las agencias operadoras de turismo receptivo. Las empresas hoteleras, las arrendadoras de vehículos para fines turísticos y las operadoras de turismo receptivo serán las responsables de retener y depositar este tributo… La obligación deberá cumplirse dentro de los diez (10) días del mes siguiente en que se causó el tributo. En el caso de las operadoras de turismo receptivo… se excluirán los valores de los servicios de alojamiento diario en hoteles y arrendamiento de vehículos… que hayan prestado y sobre los cuales ya se hubiere pagado la tasa. Quedan exceptuados… las pensiones, hospodajes, [y] hoteles de uso popular… calificados así por el Instituto Hondureño de Turismo." + Art. 44: administration = "Secretaría de Estado en el Despacho de Finanzas por medio de la Dirección Ejecutiva de Ingresos" + Art. 51 (L8M budget line funded from this tasa) | The código-259 statutory ORIGINAL: 4%/three-bases/retention-agents/exemption all now gazette-pinned (55_/71_ manual quotes CONFIRMED, EV115:EVID-424). TWO drift notes (gazette = record): (i) manual prints "diez (10) días calendario" where the original reads "diez (10) días del mes siguiente" (unqualified días); (ii) manual drops the Tesorería-General deposit clause. **NEW statutory rule the manuals omit — the OPERADORA ANTI-CASCADING EXCLUSION**: the inbound-operator base EXCLUDES lodging/rental values already taxed (never tax the same value twice across retainer families). Still unpinned: base composition incl./excl. ISV (OQ-011 stands — statute silent). **W8 CLOSED WATCH**: D. 314-98 acquired (`124_`) and DEROGATED 17-ago-2017 by D. 68-2017 (`126_`, EVID-467) — which does NOT restate or touch the tasa (grep-verified negative) but ADDS the current procedure layer (LB-013); manuals 55_/71_ (2024-2026) citing D. 131-98 Art. 43 live = CORRECT (the tasa survives its 1998 parent statute). | `hn/sources/116_Gaceta_1998-05-20_Decreto_131-98_tasas.pdf` | 131-98-Arts. 43-44 (p.7); Art. 51 (p.8) (EV115:EVID-424; EV115:EVID-420) |
| LB-013 | **D. 68-2017 (Ley de Fomento al Turismo) — ACQUIRED W8 as `126_`** (G 34,419 17-ago-2017; Dado 15-ago, Ejecútese 17-ago JOH; EVID-464..467): Art. 6.5 — beneficiaries "están obligados al cobro de la Tasa por Servicios Turísticos y del Impuesto Sobre Ventas, sobre la venta de bienes y servicios que realicen, y su entero al Fisco"; Art. 6.7 — contracts "deben incluir dentro de sus cobros por servicio y contratos de administración, el cobro del Impuesto Sobre Ventas y de la Tasa Turística aplicable", excluding complementary in-hotel services already taxed on the lodging base; **Art. 21 — "RETENCION Y ENTERO TASA TURISTICA… deben cobrar, retener y enterar la Tasa Turística referida en ésta, dentro del plazo de los diez (10) primeros días del mes siguiente de su recaudación"** | The código-259 CURRENT procedure anchor (valid 17-ago-2017): creation/rate/base stay D. 131-98 Art. 43 (LB-012); D. 68-2017 supplies the cobrar-retener-entero duty and re-confirms the 10-first-days window (adjudicating LB-012's drift note (i): the original's unqualified "días del mes siguiente" now carries a CURRENT statute printing "diez (10) primeros días" — treat as días del mes, NOT días hábiles, NOT calendario-explicit); the Art. 6.7 complementary-services exclusion = an anti-cascading kin of the operadora rule. Also Art. 5.1: tourism beneficiaries exonerated ISR/ATN/AS 15 years (the AS/ATN carve-out cross-ref taxation/07) | `hn/sources/126_Gaceta_34419_Decreto_68-2017_Ley_Fomento_Turismo.pdf` | 68-17-Arts. 5-6 pp.3-4; Art. 21 pp.8-9 (EV126:EVID-465/466/467) |
| LB-014 | **Acuerdo 005-2017 — ACQUIRED W8 as `127_`** (G 34,282 6-mar-2017; TEXT-NATIVE; EVID-468..473): the SEFIN Reglamento for the Impuesto de Producción y Consumo + ISV on cigarrillos/gaseosas/bebidas alcohólicas/preparadas/alcohol etílico — definitions, per-product procedure (stages, base, hecho generador: national = retiro de fábrica or factura whichever first; imports at DUA liquidation), declaración mechanics anchored to ISV-Art. 11 (monthly, first-10-días), **Art. 19 import formula: ISV = (CIF + DAI + ISC + IPC) × t** with 14 worked examples | The CURRENT-STATE operational layer for códigos 204/205/210/211 (procedure side of OQ-001): the import-price composition formula pins HOW the specific impuestos enter the ISV base — a base-definition datum taxation/05 consumes; CAVEATS: Art. 10's rates cuadro is an image absent from the text layer (values recoverable only from the worked examples; cross-read 98_/99_/100_ needed — 127_ OQ-1) and an internal contradiction Arts. 18/20 ("no sujeta al ISC") vs Art. 19 (ISC 10% on destilados examples) blocks CR encoding pending synthesis (127_ OQ-4); vigencia read 7-may-2017 (Art. 28 two-month clause) with a Código-Tributario tension flagged (127_ OQ-5) | `hn/sources/127_Acuerdo_005-2017_G34282_Regl_produccion_consumo.pdf` | 005-17-Arts. 10/18-20/26-28 (EV127:EVID-468..473) |
...
|----|----------|-----------|-------|--------|
| OQ-001 | `50_ OQ-1` (carried, C2 — LEAD): what merchandise canasta remains under D. 58-1982 / SER-203? **W6 NARROWED: the statutory chain is in corpus** (`115_` 1982 + `114_` 1995 — LB-002). **W8: the PROCEDURE side is now statute-anchored** — Acuerdo 005-2017 (`127_`, LB-014) = the current operational reglamento for the production-and-consumption family (204/205/210/211) incl. the import ISV-base formula; the 203-canasta CURRENT-state question itself remains (no instrument post-1995 restates or expressly kills the 203 canasta — the Ayuda 50_ still administers SER-203 live, which is itself evidence of survival); FR-304 keeps the live-period config gap. | no (current-state only; historical states + procedure pinned) | acquisition queue (203-canasta current state) | open (narrowed) |
...
| OQ-015 | **127_ internal contradiction (W8, `127_ OQ-4`)**: Arts. 18/20 print "no sujeta al ISC" for their transactions while Art. 19's own formula and BOTH destilado worked examples apply ISC 10% — no CR encodes the ISC-in-base treatment until adjudicated (candidate readings: Arts. 18/20 govern different product classes; or a drafting error); the Art. 10 rates cuadro is image-only (values only via examples — cross-read 98_/99_/100_). | no | controller | open |
