...
| LB-002 | **D. 58-1982 (Ley de Impuesto Selectivo al Consumo) — UNACQUIRED (LEAD)**, quoted by the 203 manual only: "Decreto No 58-1982 contentivo de Ley de Impuesto Selectivo al Consumo y sus reformas" (base legal, p.6) | Decree 58-1982, Selective Consumption Tax Law — the statute text (canasta of goods, tariff values, exemptions) is not in the corpus; the manual is its only carrier (50_ OQ-1) | `hn/sources/50_Ayuda_selectivo_203.pdf` | pp.4/6 (quotes); statute = acquisition lead (EV50:EVID-152/158) |
...
| LB-012 | **D. 131-98 — UNACQUIRED (LEAD)**, Art. 43 quoted by the 259 manual (LB-007 quotes: 4% rate, three bases, retenedores, IHT uso-popular exemption, 10 días calendario); short title as printed: "Ley de Estímulo a Producción, a la Competitividad y Apoyo al Desarrollo Humano" | Decree 131-1998 — the tourist-rate statute; only its Art. 43 reaches the corpus through the manual (55_ OQ-1); the 4%/scope/deadline are manual-print vintage until the statute is acquired | `hn/sources/55_Ayuda_turistico_259.pdf` | p.4 quotes; statute = acquisition lead (EV50:EVID-157) |
...
- **HN-FREP-FR-304:** The system shall render SER-203 in the ad-valorem
  ...
  resolved from DATED config rows; NO canasta, tarifa value or exemption is
  in the corpus — until D. 58-1982 is acquired the determination shall be
  BLOCKED with an explicit config-gap flag (never-guess; OQ-001) while the
  obligation, calendar and form shape ship complete.
  (LB-001; LB-002; EV50:EVID-152/158)
...
- **HN-FREP-FR-321:** The system shall implement the 259 retention engine:
  4% on (a) the daily lodging price in hotels, (b) the price of vehicle
  rentals for tourist purposes and (c) the price of services of *agencias
  operadoras de turismos receptivo* (inbound tour operators); the taxable
  person is the client; the retention agents are the hotel companies,
  tourist vehicle-rental companies and inbound operators, who retain and
  deposit the tax; rate/bases stand on the manual print until D. 131-98 is
  acquired (OQ-010). (LB-007; LB-012; EV50:EVID-157)
...
- **HN-FREP-FR-323:** The system shall render SER-259 in the ad-valorem
  ...
  10 días calendario (D. 131-98 Art. 43 as printed), and shall carry the
  base composition (ISV included or excluded; service charges in or out) as
  UNPINNED config on every FR-321 line (OQ-011). (LB-007;
  EV50:EVID-157/158)
...
|----|----------|-----------|-------|--------|
| OQ-001 | `50_ OQ-1` (carried, C2 — LEAD): what merchandise canasta remains under D. 58-1982 / SER-203? The manual prints no product list, no tarifa values, no exemptions. FR-304 blocks computation until the statute + reforms are acquired. | yes (203 computation only) | acquisition queue | open |
...
| OQ-010 | `55_ OQ-1` (carried, C2 — LEAD): D. 131-98 not in corpus — full Art. 43 text + reforms needed to confirm the 4%, the three bases and the official short title ("Ley de Estímulo a Producción, a la Competitividad y Apoyo al Desarrollo Humano" as printed). FR-321 stands on the manual print until acquired. | no (config-gated) | acquisition queue | open |
