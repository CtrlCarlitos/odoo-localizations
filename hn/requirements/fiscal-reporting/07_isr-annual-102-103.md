...
- **HN-FREP-FR-235:** The system shall implement the 102 no-gravados
  ...
  interests (D. 110-93 Art. 9, sujetos al 10% — unacquired LEAD),
  seguros, herencias/legados/donaciones, rentas de títulos valores
...
- **HN-FREP-FR-244:** The system shall unlock the "Crédito por
  ...
  disabled. The D. 54-96 credit AMOUNT is printed nowhere in EV29 and
  stays a config gap (never guessed; D. 54-96 unacquired LEAD).
  (LB-007; EV29:EVID-098; OQ-014)
...
| OQ-014 | Unacquired-decree pack (NEW, EV29 synthesis): D. 96-2012 (anticipo legs, FR-243), D. 54-96 (job credit, FR-244), D. 110-93 Art. 9 (bank-interest 10%, FR-235), D. 199-2006 / D. 194-2002 (senior hooks, FR-233), LET D. 51-2003 (ATN instrument, OQ-010) — all cited as evidenced in EV29 prints only; amounts/gates stand on the prints, never on asserted statute text, until acquired. | no | acquisition queue | open |
