...
| LB-019 | **D. 96-2012 ACQUIRED W14 (`168_`) — the anticipo statute** (LEY DE MEDIDA ANTIEVASIÓN EN EL ISR; G 32,877 viernes 20-jul-2012; Dado 20-jun-2012 JOH/Chang Castillo; vigencia 21-jul-2012 per Art. 5 day-after-publication): Art. 1 — "…durante los periodos fiscales no prescritos que establece el Artículo 136, numeral 2) del Código Tributario, que en dos (2) de ellos hayan tenido pérdidas operacionales consecutivas o alternas y que en el último periodo fiscal hayan obtenido ingresos brutos igual o superior a Cien Millones de Lempiras (L.100,000,000.00) anuales, estarán sujetas al pago de un anticipo del uno por ciento (1%)… calculado sobre los ingresos brutos declarados" + the six subject classes (arrastre-loss ISR-Art.-20; pagos-a-cuenta ISR-Art.-34; audited-real-loss DEI-verified; ISR-Art.-7 inscritos; **special-law exonerees INSIDE the anticipo**); Art. 2 — "El pago del anticipo del uno por ciento (1%)… se hará en forma trimestral en los meses de junio, septiembre y diciembre a partir del año dos mil trece (2013)"; Art. 3 — the 3%-CIF imports anticipo (unregistered/omiss/mora importers; "en el momento de la liquidación de la 'Declaración Única Aduanera'"; credit vs "Impuesto Sobre la Renta, Activo Neto o Aportación Solidaria Temporal hasta agotarlo"; excludes registered non-profit educational institutions); Art. 4 — "Queda derogado el Artículo 13 del Decreto No.113-2011" (the Ley-Eficiencia predecessor) | FR-243's statute: gates confirmed instrument-side; the cadence NEW (trimestral Jun/Sep/Dec from FY2013, credit at the annual declaration); the 05_-Art.-13 rows repealed 21-jul-2012; the 22-A regime (D. 278-2013 Art. 9) and this anticipo regime = PARALLEL anti-evasion instruments, never merged (EV168:EVID-686) | `hn/sources/168_Decreto_96-2012_G32877_anticipo_ISR.pdf` | EV168:EVID-681..687 |
...
- **HN-FREP-FR-243:** The system shall implement the D. 96-2012 anticipo
  ...
  3% of ISR applied on the referential CIF base of goods imports;
  **W14: D. 96-2012 ACQUIRED as `168_` (G 32,877 20-jul-2012, vigente
  21-jul-2012; EV168:EVID-681..687) — the gates confirmed instrument-side
  ("consecutivas o alternas"; the six subject classes incl. special-law
  exonerees; the registered non-profit-educational exclusion on the
  imports leg) + the payment cadence pinned: TRIMESTRAL (June/September/
  December, from FY2013), credit at the annual declaration; D. 96-2012
  Art. 4 DEROGATES D. 113-2011 Art. 13 (the 05_ predecessor); the
  loss-pattern flag is consumed from taxation/03 FR-086 by id.**
  (LB-007; LB-019; EV29:EVID-098; EV168:EVID-682..685; OQ-014)
...
- **HN-FREP-FR-257:** The system shall compute ATN on 103 as: rate 1%
  applied over the Activo Total Neto (Balance-General assets net of the
  statutory base adjustments) minus the L3,000,000 exemption — the
  exemption applied EXCESS-ONLY ("cuando exceda de este valor el impuesto
  cedular se aplicará a la diferencia", LET-Art. 14.1). **W8: the
  instrument conflict is RESOLVED (R-H84; `121_` acquired, G 30,059
  10-abr-2003)**: the ATN = D. 51-2003 **Capítulo II** (Arts. 5-16), rate
  = **Art. 7** — the 74_ chapter-citation and the corpus Art.-7 lead point
  at the SAME law; both were right. Parameters now statute-anchored:
  1% (Art. 7); PJ-comerciantes scope (Art. 5); base netting (Art. 6);
  L3M excess-only (Art. 14.1); ZOLI/ZIP/ZOLT/RIT + ISR-exempt +
  pre-operativa + certified-fuerza-mayor exclusions (Art. 14.2-5);
  declaration rides the ISR-annual date, special-FY +3m (Art. 7).
  (LB-009; LB-011; LB-016-W8 [see LB table]; EV29:EVID-100/110;
  EV121:EVID-444/445; R-H84; formerly OQ-010)
...
| FR-241..245 | odoo | l10n_hn.annual.credit.line | line_key, source | Retention feeds consume taxation/04 FR-153 record shape + file 02 DJIMR links by id; D. 96-2012 (168_, W14) / D. 54-96 (118_, W6) both statute-backed — the 96-2012 cadence = trimestral Jun/Sep/Dec (FY2013+), credit at annual declaration |
...
| OQ-010 | ~~ATN instrument conflict~~ **RESOLVED W8** (R-H84; `121_` acquired G 30,059 10-abr-2003, EV121:EVID-444/445): ATN = D. 51-2003 Capítulo II (Arts. 5-16); the 74_ "Capítulo II" citation is EXACT and the corpus "Art. 7" lead = the same law's rate article — no conflict ever existed. 1%/L3M-excess-only/credit mechanics all statute-pinned; FR-257 upgraded. Reglamento side: Acuerdo 0948-2003 acquired as `122_` (EV122:EVID-453..459). | no | controller W8 | resolved |
...
| OQ-014 | Unacquired-decree pack (NEW, EV29 synthesis; **W6 update: D. 54-96 acquired as `118_` + D. 110-93 acquired as `117_` — FR-235/FR-244 anchors upgraded to statute, LB-015; D. 199-2006/D. 194-2002 were already evidenced V-HN1b as `95_`/`97_`**; **W14 update: D. 96-2012 ACQUIRED as `168_` (G 32,877, vigente 21-jul-2012; EV168:EVID-681..687) — FR-243 upgraded to statute, gates+c cadence pinned**): remaining unacquired = ~~D. 96-2012~~ **none of the original pack** (~~LET D. 51-2003~~ **ACQUIRED W8 as `121_`** — ATN instrument, OQ-010 resolved R-H84; reglamento 0948-2003 acquired as `122_`, interp 52-2004 as `123_`). Amounts/gates stand on the prints or statute, never on asserted text, until acquired. | no | ~~acquisition queue~~ CLOSED W14 | resolved (W14) |
