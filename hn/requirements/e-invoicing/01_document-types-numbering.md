...
| LB-011 | 481-2017, R-Arts. 78-79 | Art. 78: "Se derogan ... 1. Acuerdos No. 189-2014 ... y su reforma establecida en el Acuerdo No. 058-2014. 2. Toda norma reglamentaria que se oponga a las presentes disposiciones." Art. 79 (reformed 609-2017 — **instrument acquired W15 as `180_`: the vigencia MOVE from the original '+2 months' formula to the fixed 31-dic-2017 is A609-Art. 1's fourteenth reformed article, EVID-733**): "entrar en vigencia el 31 de diciembre de 2017." | Repeal of 189-2014 (+058-2014) and the regime-crossover date 31-dic-2017; the blanket "toda norma que se oponga" clause leaves DEI-279-2015 unexpressed (R-H38) | `hn/sources/24_Reglamento_Facturacion_Ac481-2017_consolidado.pdf` | R-Arts. 78-79 pp.66-67 (EV24:EVID-207) |
| LB-012 | 481-2017, R-Arts. 76 y 76-A | Art. 76: 189-2014-authorized documents usable "hasta la Fecha Límite de Emisión o que finalice el Rango Autorizado ... lo que suceda primero"; "En los casos en que los Instructivos Tributarios Aduaneros, Reglamentos o Actos Administrativos indiquen el uso de la Boleta de Venta se deben entender que el Documento Fiscal a emitir es la Factura." Art. 76-A (**added 725-2018 — instrument acquired W15 as `181_`: the ORIGINAL grace boundary was 30-NOV-2018 [the requisito-8 print field], pushed to 28-feb-2019 only by 817-2018 published 26-nov-2018, two weeks before the original deadline — EVID-736**; reformed 817-2018): facturas/boletas de compra/prevaloradas emitted hasta 28-feb-2019 without the exonerado-data + descuentos requirements "serán documentos válidos"; "A partir del 01 de marzo de 2019 ... todos los requisitos." | Transition: legacy stock until its fecha límite/rango end; Boleta-de-Venta→Factura remap; print-requirements grace boundary 01-mar-2019 | `hn/sources/24_Reglamento_Facturacion_Ac481-2017_consolidado.pdf` | R-Arts. 76, 76-A pp.65-66 (EV24:EVID-207; EVID-211) |
...
| LB-017 | **THE REFORM-CHAIN INSTRUMENTS ACQUIRED W15** (EINV statute-tier upgrade; EV179..EV181:EVID-731..741): `179_` = the **481-2017 GAZETTE ORIGINAL** (G 34,413 jue 10-ago-2017, 28 pp — original Art. 79 = '+2 months' formula [≈12-oct-2017, SUPERSEDED pre-effectivity]; signature chain = Coordinador-General delegation 031-2015 + SEFIN Cerrato) · `180_` = **ACUERDO 609-2017, the PRIMERA REFORMA** (dated 27-sep-2017; G 34,457 lun 2-oct-2017; vigente 3-oct-2017 — **14 articles: 4 num. 36 [new definition], 11, EIGHT 'inciso c)' requirement insertions [15.6c/17.4/20.5c/23.7/25.5c/27.5c/29.4c/33.5c], 38, 46, 57, 79**; the inciso-c pattern = the per-document requirement expansions post-3-oct-2017) · `181_` = **ACUERDO 725-2018, the SEGUNDA REFORMA** (dated 21-ago-2018; G 34,792 lun 12-nov-2018; vigente 13-nov-2018 — Arts. 8/10/11/12/13/15/16/37 + **the 76-A ADICIÓN with the ORIGINAL 30-NOV-2018 grace** [requisito-8 print field; 817-2018 then moved it to 28-feb-2019 — the LB-016 boundary's two-step history] + **the reformed Art. 8 OTROS-COMPROBANTES catalog** [six classes; the CNBS banking/insurance boundary with the express non-regulated→Comprobantes-Fiscales remap; IATA boletos in; **NO AT-authorization lane — outside the CAI ledger**] + Arts. 4-5 the ISV-recovery lanes [exonerated-sales compensation→devolución; export-input devolución] + Art. 8 derogates Acuerdo 462-2014 Art. 20) · `182_` = ACUERDO 231-2020 (G 35,215 1-abr-2020 — the COVID-era TRANSITORY print re-authorization for R-Art.-63-limited taxpayers via OVI; HISTORICAL, expired 31-dic-2020; corroborates R-Art.-42's 10-días-hábiles no-utilizados duty verbatim) | The W3 footnote-only knowledge of the chain (LB-011/012/016 annotations via 24_) now instrument-backed; the authority order stands (24_ = cite-first for current text; 179_ = the original-state witness; 180_/181_ = the intermediate reform texts) | `hn/sources/179_Gaceta_34413_Acuerdo_481-2017_original.pdf` + `hn/sources/180_Gaceta_34457_Acuerdo_609-2017_primera_reforma.pdf` + `hn/sources/181_Gaceta_34792_Acuerdo_725-2018_segunda_reforma.pdf` + `hn/sources/182_Gaceta_35215_Acuerdo_231-2020_transitorio.pdf` | EV179..EV182:EVID-731..739; EV chain synthesis EVID-741 |
